      ...
      VideoDetails = MediaDetails.extend(
        /** @lends wp.media.view.MediaFrame.VideoDetails.prototype */ {
          ...
          renderSelectPosterImageToolbar: function() {
            this.setPrimaryButton(l10n.videoSelectPosterImageTitle, function(
              controller,
              state,
            ) {
              var urls = [],
          ...
          renderAddTrackToolbar: function() {
            this.setPrimaryButton(l10n.videoAddTrackTitle, function(
              controller,
              state,
            ) {
              var attachment = state.get('selection').single(),
        ...
        /** @lends wp.media.view.VideoDetails.prototype */ {
          ...
          setMedia: function() {
            ...
            if (video.find('source').length) {
              ...
              if (
                !video.hasClass('youtube-video') &&
                !video.hasClass('vimeo-video')
              ) {
