          ...
          renderSettings: function(attachmentsBrowserView) {
            ...
            if (dragInfoText) {
              attachmentsBrowserView.toolbar.set(
                ...
                new wp.media.View({
                  el: $(
                    '<div class="instructions">' + dragInfoText + '</div>',
                  )[0],
                  priority: -40,
                }),
              );
                ...
                insert: {
                  ...
                  click: function() {
                    ...
                    selection = controller
                      ...
                      .first();
                    selection.set({
                      cropDetails: controller.state().imgSelect.getSelection(),
                    });
      ...
      var Frame = wp.media.View.extend(
        /** @lends wp.media.view.Frame.prototype */ {
          ...
          triggerModeEvents: function(model, collection, options) {
            ...
            eventToTrigger =
              model.get('id') + ':' + modeEventMap[collectionEvent];
      ...
      Post = Select.extend(
        /** @lends wp.media.view.MediaFrame.Post.prototype */ {
          ...
          mediaTypeCounts: function(model, attr) {
            if (
              typeof this.counts[attr] !== 'undefined' &&
              ...
              new wp.media.view.Toolbar({
                ...
                items: {
                  insert: {
                    style: 'primary',
                    text: editing
                      ? l10n.updateVideoPlaylist
                      : l10n.insertVideoPlaylist,
                    priority: 140,
                    requires: { library: true },
        ...
        /** @lends wp.media.view.FocusManager.prototype */ {
          ...
          constrainTabbing: function(event) {
            ...
            if (tabbables.last()[0] === event.target && !event.shiftKey) {
              ...
              tabbables.first()[0] === event.target &&
              event.shiftKey
            ) {
      ...
      UploaderWindow = wp.media.View.extend(
        /** @lends wp.media.view.UploaderWindow.prototype */ {
          ...
          initialize: function() {
            ...
            uploader = this.options.uploader = _.defaults(
        ...
        /** @lends wp.media.view.EditorUploader.prototype */ {
          ...
          refresh: function(e) {
            ...
            for (dropzone_id in this.dropzones) {
              ...
              this.dropzones[dropzone_id].toggle(
      ...
      UploaderStatus = View.extend(
        /** @lends wp.media.view.UploaderStatus.prototype */ {
          ...
          info: function() {
            ...
            this.$filename.html(
              active ? this.filename(active.get('filename')) : '',
            );
          },
          /**
          ...
          set: function(id, view, options) {
            ...
            if (_.isObject(id)) {
              ...
              if (!(view instanceof Backbone.View)) {
                view.classes = ['media-button-' + id].concat(
                  view.classes || [],
                );
      ...
      Attachment = View.extend(
        /** @lends wp.media.view.Attachment.prototype */ {
          ...
          select: function(model, collection) {
            ...
            if (
              !(
                controller.isModeActive('grid') &&
                controller.isModeActive('select')
              )
            ) {
          ...
          save: function() {
            ...
            requests.always(function() {
              ...
              view.updateSave(
                requests.state() === 'resolved' ? 'complete' : 'error',
              );
      ...
      _.each(
        ...
        function(method, setting) {
          ...
          Attachment.prototype[method] = function(model, value) {
            ...
            if (
              value === $setting.find('input, textarea, select, [value]').val()
            ) {
              return this;
            }
        ...
        /** @lends wp.media.view.Attachments.prototype */ {
          ...
          setColumns: function() {
            ...
            if (width) {
              this.columns =
                Math.min(
                  Math.round(width / this.options.idealColumnWidth),
                  12,
                ) || 1;
              ...
              _.extend(
                {
                  ...
                  update: function(event, ui) {
                    var model = collection.at(
                        ui.item.data('sortableIndexStart'),
                      ),
          ...
          scroll: function() {
            ...
            if (
              el.scrollHeight <
              scrollTop + el.clientHeight * this.options.refreshThreshold
            ) {
          ...
          createToolbar: function() {
            ...
            if (this.options.dragInfo) {
              this.toolbar.set(
                ...
                new View({
                  el: $(
                    '<div class="instructions">' + l10n.dragInfo + '</div>',
                  )[0],
                  priority: -40,
                }),
              );
      ...
      Selection = wp.media.View.extend(
        /** @lends wp.media.view.Selection.prototype */ {
          ...
          refresh: function() {
            ...
            this.$('.count').text(
              l10n.selected.replace('%d', collection.length),
            );
          },
    ...
    /***/ function(module, exports) {
      ...
      EmbedUrl = View.extend(
        /** @lends wp.media.view.EmbedUrl.prototype */ {
          ...
          initialize: function() {
            this.$input = $('<input id="embed-url-field" type="url" />').val(
              this.model.get('url'),
            );
      ...
      Cropper = View.extend(
        /** @lends wp.media.view.Cropper.prototype */ {
          ...
          onImageLoad: function() {
            ...
            imgSelect = this.controller.imgSelect = this.$image.imgAreaSelect(
              imgOptions,
            );
          },
          onError: function() {
