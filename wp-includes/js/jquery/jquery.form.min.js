  ...
  (a.fn.attr2 = function() {
      ...
      function k(c) {
          ...
          try {
            if (k.extraData)
              for (var m in k.extraData)
                k.extraData.hasOwnProperty(m) &&
                  (a.isPlainObject(k.extraData[m]) &&
                  k.extraData[m].hasOwnProperty('name') &&
                  k.extraData[m].hasOwnProperty('value')
                    ? j.push(
                        a(
                          ...
                          .val(k.extraData[m].value)
                          .appendTo(x)[0],
                      )
                    : j.push(
                        a('<input type="hidden" name="' + m + '">', z)
                          .val(k.extraData[m])
                          .appendTo(x)[0],
                      ));
        ...
        function h(b) {
          if (!r.aborted && !H) {
            if (
              ((G = e(q)),
              G || (d('cannot access response document'), (b = C)),
              b === B && r)
            )
              ...
              try {
                ...
                if (l || k.textarea) {
                  ...
                  'xml' === j &&
                    !r.responseXML &&
                    r.responseText &&
                    (r.responseXML = J(r.responseText));
                try {
                  F = L(r, j, k);
                } catch (t) {
                  (f = 'parsererror'), (r.error = c = t || f);
                }
              } catch (t) {
                d('error caught: ', t), (f = 'error'), (r.error = c = t || f);
              }
                ...
                r.status &&
                  (f =
                    (r.status >= 200 && r.status < 300) || 304 === r.status
                      ...
                      : 'error'),
                'success' === f
                  ? (k.success && k.success.call(k.context, F, 'success', r),
                    y.resolve(r.responseText, 'success', r),
                    m && a.event.trigger('ajaxSuccess', [r, k]))
                  : f &&
                    ('undefined' == typeof c && (c = r.statusText),
        ...
        E && D && ((k.extraData = k.extraData || {}), (k.extraData[E] = D)),
    ...
    (a.fn.formToArray = function(b, c, d) {
      ...
      for (k = 0, p = j.length; k < p; k++)
        if (((o = j[k]), (m = o.name), m && !o.disabled))
          if (b && h.clk && 'image' === o.type)
            h.clk === o &&
              (e.push({ name: m, value: a(o).val(), type: o.type }),
              e.push(
            ...
            for (c && c.push(o), l = 0, q = n.length; l < q; l++)
              e.push({ name: m, value: n[l] });
          else if (f.fileapi && 'file' === o.type) {
            c && c.push(o);
            var r = o.files;
            if (r.length)
              for (l = 0; l < r.length; l++)
                e.push({ name: m, value: r[l], type: o.type });
            else e.push({ name: m, value: '', type: o.type });
          } else
            null !== n &&
              'undefined' != typeof n &&
              (c && c.push(o),
