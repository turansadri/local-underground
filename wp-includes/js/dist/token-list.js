          ...
          function TokenList() {
            ...
            ['entries', 'forEach', 'keys', 'values'].forEach(function(fn) {
              _this[fn] = function() {
                ...
                return (_this$_valueAsArray = this._valueAsArray)[fn].apply(
                  _this$_valueAsArray,
                  arguments,
                );
              }.bind(_this);
          ...
          Object(
            ...
            },
            {
              ...
              value: function remove() {
                ...
                this.value = lodash__WEBPACK_IMPORTED_MODULE_2__['without']
                  .apply(void 0, [this._valueAsArray].concat(items))
                  .join(' ');
              },
              /**
            ...
            },
            {
              ...
              set: function set(value) {
                value = String(value);
                this._valueAsArray = Object(
                  lodash__WEBPACK_IMPORTED_MODULE_2__['uniq'],
                )(
                  Object(lodash__WEBPACK_IMPORTED_MODULE_2__['compact'])(
                    value.split(/\s+/g),
                  ),
                );
