this['wp'] = this['wp'] || {};
this['wp']['viewport'] = /******/ (function(modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ {
    ...
    /***/ 372: /***/ function(
      ...
      /* harmony default export */ var store = Object(
        external_this_wp_data_['registerStore'],
      )('core/viewport', {
      ...
      var with_viewport_match_withViewportMatch = function withViewportMatch(
        queries,
      ) {
      ...
      var if_viewport_matches_ifViewportMatches = function ifViewportMatches(
        query,
      ) {
        return Object(external_this_wp_compose_['createHigherOrderComponent'])(
          Object(external_this_wp_compose_['compose'])([
            with_viewport_match({
      ...
      /* concated harmony reexport ifViewportMatches */ __webpack_require__.d(
        __webpack_exports__,
        'ifViewportMatches',
        function() {
          return if_viewport_matches;
        },
      );
      /* concated harmony reexport withViewportMatch */ __webpack_require__.d(
        __webpack_exports__,
        'withViewportMatch',
        function() {
          return with_viewport_match;
        },
      );
      /**
       * External dependencies
      ...
      var build_module_setIsMatching = Object(external_lodash_['debounce'])(
        function() {
          var values = Object(external_lodash_['mapValues'])(
      ...
      var build_module_queries = Object(external_lodash_['reduce'])(
        BREAKPOINTS,
        function(result, width, name) {
          Object(external_lodash_['forEach'])(OPERATORS, function(
            condition,
            operator,
          ) {
            var list = window.matchMedia(
              '('.concat(condition, ': ').concat(width, 'px)'),
            );
