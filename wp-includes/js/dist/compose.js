    ...
    /***/ 368: /***/ function(
      ...
      function createHigherOrderComponent(
        ...
        return function(OriginalComponent) {
          var EnhancedComponent = mapComponentToEnhancedComponent(
            OriginalComponent,
          );
          var _OriginalComponent$di = OriginalComponent.displayName,
            displayName =
              _OriginalComponent$di === void 0
                ? OriginalComponent.name || 'Component'
                : _OriginalComponent$di;
      ...
      var pure = create_higher_order_component(function(Wrapped) {
        if (
          Wrapped.prototype instanceof external_this_wp_element_['Component']
        ) {
          return (
            /*#__PURE__*/
            (function(_Wrapped) {
              ...
              function _class() {
                ...
                return Object(possibleConstructorReturn['a' /* default */])(
                  this,
                  Object(getPrototypeOf['a' /* default */])(_class).apply(
                    this,
                    arguments,
                  ),
                );
        ...
        return (
          ...
          (function(_Component) {
            ...
            function _class2() {
              ...
              return Object(
                possibleConstructorReturn['a' /* default */],
              )(this, Object(getPrototypeOf['a' /* default */])(_class2).apply(this, arguments));
            }
            ...
            Object(createClass['a' /* default */])(_class2, [
              {
                ...
                value: function shouldComponentUpdate(nextProps) {
                  return !external_this_wp_isShallowEqual_default()(
                    nextProps,
                    this.props,
                  );
                },
          ...
          Object(createClass['a' /* default */])(Listener, [
            ...
            },
            {
              ...
              value: function handleEvent(event) {
                Object(external_lodash_['forEach'])(
      ...
      function withGlobalEvents(eventTypesToHandlers) {
        return create_higher_order_component(function(WrappedComponent) {
            ...
            (function(_Component) {
              ...
              function Wrapper() {
                ...
                _this = Object(possibleConstructorReturn['a' /* default */])(
                  this,
                  Object(getPrototypeOf['a' /* default */])(Wrapper).apply(
                    this,
                    arguments,
                  ),
                );
                _this.handleEvent = _this.handleEvent.bind(
          ...
          return Object(
            external_this_wp_element_['forwardRef'],
          )(function(props, ref) {
      ...
      /* harmony default export */ var with_instance_id = create_higher_order_component(
              ...
              Object(createClass['a' /* default */])(_class, [
                {
                  ...
                  value: function render() {
                    return Object(external_this_wp_element_['createElement'])(
                      WrappedComponent,
                      Object(esm_extends['a' /* default */])({}, this.props, {
      ...
      var withSafeTimeout = create_higher_order_component(function(
        OriginalComponent,
      ) {
        return (
          /*#__PURE__*/
          (function(_Component) {
            ...
            function WrappedComponent() {
              ...
              _this.timeouts = [];
              _this.setTimeout = _this.setTimeout.bind(
                Object(assertThisInitialized['a' /* default */])(
                  Object(assertThisInitialized['a' /* default */])(_this),
                ),
              );
              _this.clearTimeout = _this.clearTimeout.bind(
                Object(assertThisInitialized['a' /* default */])(
                  Object(assertThisInitialized['a' /* default */])(_this),
                ),
              );
            ...
            Object(createClass['a' /* default */])(WrappedComponent, [
              ...
              },
              {
                ...
                value: (function(_clearTimeout) {
                  ...
                  clearTimeout(id);
                  this.timeouts = Object(external_lodash_['without'])(
                    this.timeouts,
                    id,
                  );
                }),
          ...
          return (
            ...
            (function(_Component) {
              ...
              function WrappedComponent() {
                ...
                _this.setState = _this.setState.bind(
                  Object(assertThisInitialized['a' /* default */])(
                    Object(assertThisInitialized['a' /* default */])(_this),
                  ),
                );
      ...
      /* concated harmony reexport createHigherOrderComponent */ __webpack_require__.d(
        __webpack_exports__,
        'createHigherOrderComponent',
        function() {
          return create_higher_order_component;
        },
      );
      /* concated harmony reexport ifCondition */ __webpack_require__.d(
        __webpack_exports__,
        'ifCondition',
        function() {
          return if_condition;
      ...
      /* concated harmony reexport pure */ __webpack_require__.d(
        __webpack_exports__,
        'pure',
        function() {
          return build_module_pure;
        },
      );
      /* concated harmony reexport withGlobalEvents */ __webpack_require__.d(
        __webpack_exports__,
        'withGlobalEvents',
        function() {
          return with_global_events;
        },
      );
      /* concated harmony reexport withInstanceId */ __webpack_require__.d(
        __webpack_exports__,
        'withInstanceId',
        function() {
          return with_instance_id;
        },
      );
      /* concated harmony reexport withSafeTimeout */ __webpack_require__.d(
        __webpack_exports__,
        'withSafeTimeout',
        function() {
          return with_safe_timeout;
        },
      );
      /* concated harmony reexport withState */ __webpack_require__.d(
        __webpack_exports__,
        'withState',
        function() {
          return withState;
      ...
      /* concated harmony reexport compose */ __webpack_require__.d(
        __webpack_exports__,
        'compose',
        function() {
          return external_lodash_['flowRight'];
        },
      );
      /**
       * External dependencies
