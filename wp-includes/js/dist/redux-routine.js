this['wp'] = this['wp'] || {};
this['wp']['reduxRoutine'] = /******/ (function(modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ {
    ...
    /***/ 199: /***/ function(module, exports, __webpack_require__) {
      ...
      var createChannel = (exports.createChannel = function createChannel(
        callback,
      ) {
        var listeners = [];
    ...
    /***/ 347: /***/ function(module, exports, __webpack_require__) {
      ...
      var create = function create() {
        ...
        var controls = [].concat(
          _toConsumableArray(userControls),
          _toConsumableArray(_builtin2.default),
        );
        ...
        var runtime = function runtime(input) {
          ...
          var iterator = _is2.default.iterator(input)
            ? input
    ...
    /***/ 348: /***/ function(module, exports, __webpack_require__) {
      ...
      var iterator = (exports.iterator = function iterator(
        value,
        next,
        rungen,
        yieldNext,
    ...
    /***/ 351: /***/ function(module, exports, __webpack_require__) {
      ...
      var cps = (exports.cps = function cps(
        value,
        next,
        rungen,
        yieldNext,
        ...
        (_value$func = value.func).call.apply(
          _value$func,
          [null].concat(_toConsumableArray(value.args), [
            function(err, result) {
    ...
    /***/ 378: /***/ function(
      ...
      function isAction(object) {
        return (
          Object(external_lodash_['isPlainObject'])(object) &&
          Object(external_lodash_['isString'])(object.type)
        );
      }
      /**
      ...
      function createRuntime() {
        ...
        var rungenControls = Object(external_lodash_['map'])(controls, function(
          control,
          actionType,
        ) {
        ...
        var unhandledActionControl = function unhandledActionControl(
          value,
          next,
        ) {
          if (!isAction(value)) {
