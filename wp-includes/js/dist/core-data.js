this['wp'] = this['wp'] || {};
this['wp']['coreData'] = /******/ (function(modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ {
    ...
    /***/ 364: /***/ function(
      ...
      __webpack_require__.d(
        ...
        function() {
          return receiveUploadPermissions;
        },
      );
      __webpack_require__.d(
        build_module_actions_namespaceObject,
      ...
      __webpack_require__.d(
        ...
        function() {
          return isRequestingEmbedPreview;
        },
      );
      __webpack_require__.d(
        build_module_selectors_namespaceObject,
      ...
      __webpack_require__.d(
        ...
        'getEntityRecords',
        function() {
          return resolvers_getEntityRecords;
        },
      );
      __webpack_require__.d(
        resolvers_namespaceObject,
        'getThemeSupports',
        function() {
          return resolvers_getThemeSupports;
        },
      );
      __webpack_require__.d(
        resolvers_namespaceObject,
        'getEmbedPreview',
        function() {
          return resolvers_getEmbedPreview;
        },
      );
      __webpack_require__.d(
        resolvers_namespaceObject,
        'hasUploadPermissions',
        function() {
          return resolvers_hasUploadPermissions;
        },
      );
      __webpack_require__.d(resolvers_namespaceObject, 'canUser', function() {
        return resolvers_canUser;
      });
        ...
        for (var i = 0; i < keys.length; i++) {
          ...
          switch (key) {
            ...
            default:
              ...
              parts.stableKey +=
                (parts.stableKey ? '&' : '') +
                Object(external_this_wp_url_['addQueryArgs'])(
                  '',
      ...
      /* harmony default export */ var get_query_parts = with_weak_map_cache(
        getQueryParts,
      );
          ...
          function(registry) {
            return function(_ref2) {
              ...
              var selectorName = _ref2.selectorName,
                args = _ref2.args;
              return (_registry$select = registry.select('core'))[
                selectorName
              ].apply(
                _registry$select,
      ...
      function saveEntityRecord(kind, name, record) {
        ...
        return regenerator_default.a.wrap(
          function saveEntityRecord$(_context) {
            while (1) {
              switch ((_context.prev = _context.next)) {
                ...
                case 6:
                  ...
                  return apiFetch({
                    path: ''
                      .concat(entity.baseURL)
                      .concat(recordId ? '/' + recordId : ''),
      ...
      function loadPostTypeEntities() {
        var postTypes;
        return regenerator_default.a.wrap(
          function loadPostTypeEntities$(_context) {
            while (1) {
              switch ((_context.prev = _context.next)) {
                case 0:
                  _context.next = 2;
                ...
                case 2:
                  ...
                  return _context.abrupt(
                    'return',
                    Object(external_lodash_['map'])(postTypes, function(
                      postType,
                      name,
                    ) {
                      return {
      ...
      function loadTaxonomyEntities() {
        var taxonomies;
        return regenerator_default.a.wrap(
          function loadTaxonomyEntities$(_context2) {
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                ...
                case 2:
                  ...
                  return _context2.abrupt(
                    'return',
                    Object(external_lodash_['map'])(taxonomies, function(
                      taxonomy,
                      name,
                    ) {
                      return {
      ...
      var entities_getMethodName = function getMethodName(kind, name) {
        ...
        var kindPrefix =
          kind === 'root'
            ? ''
            : Object(external_lodash_['upperFirst'])(
                Object(external_lodash_['camelCase'])(kind),
              );
        var nameSuffix =
          Object(external_lodash_['upperFirst'])(
            Object(external_lodash_['camelCase'])(name),
          ) + (usePlural ? 's' : '');
        var suffix =
          usePlural && entity.plural
            ? Object(external_lodash_['upperFirst'])(
                Object(external_lodash_['camelCase'])(entity.plural),
              )
            : nameSuffix;
        return ''
          .concat(prefix)
      ...
      function getKindEntities(kind) {
        ...
        return regenerator_default.a.wrap(
          function getKindEntities$(_context3) {
            while (1) {
      ...
      var queries = Object(external_lodash_['flowRight'])([
        ...
        return getMergedItemIds(
          state || [],
          Object(external_lodash_['map'])(action.items, key),
          page,
          perPage,
        );
      });
      /* harmony default export */ var queried_data_reducer = Object(
        redux['b' /* combineReducers */],
      )({
        items: reducer_items,
        queries: queries,
      });
      ...
      function reducer_users() {
        ...
        switch (action.type) {
          case 'RECEIVE_USER_QUERY':
            return {
              byId: Object(objectSpread['a' /* default */])(
                {},
                state.byId,
                Object(external_lodash_['keyBy'])(action.users, 'id'),
              ),
              queries: Object(objectSpread['a' /* default */])(
                {},
                state.queries,
                Object(defineProperty['a' /* default */])(
                  {},
                  action.queryID,
                  Object(external_lodash_['map'])(action.users, function(user) {
                    return user.id;
                  }),
                ),
              ),
      ...
      function reducer_entity(entityConfig) {
        return Object(external_lodash_['flowRight'])([
          // Limit to matching action type so we don't attempt to replace action on
          // an unhandled action.
          if_matching_action(function(action) {
            return (
        ...
        switch (action.type) {
          case 'ADD_ENTITIES':
            return [].concat(
              ...
              Object(toConsumableArray['a' /* default */])(action.entities),
            );
        }
      ...
      var reducer_entities = function entities() {
        ...
        if (!entitiesDataReducer || newConfig !== state.config) {
          var entitiesByKind = Object(external_lodash_['groupBy'])(
            newConfig,
            'kind',
          );
          entitiesDataReducer = Object(
            external_this_wp_data_['combineReducers'],
          )(
            Object.entries(entitiesByKind).reduce(function(memo, _ref) {
              var _ref2 = Object(slicedToArray['a' /* default */])(_ref, 2),
                kind = _ref2[0],
                subEntities = _ref2[1];

              var kindReducer = Object(
                external_this_wp_data_['combineReducers'],
              )(
                subEntities.reduce(function(kindMemo, entityConfig) {
                  return Object(
                    objectSpread['a' /* default */],
                  )({}, kindMemo, Object(defineProperty['a' /* default */])({}, entityConfig.name, reducer_entity(entityConfig)));
                }, {}),
              );
        ...
        switch (action.type) {
          case 'RECEIVE_EMBED_PREVIEW':
            ...
            return Object(objectSpread['a' /* default */])(
              {},
              state,
              Object(defineProperty['a' /* default */])({}, url, preview),
            );
        }
      ...
      /* harmony default export */ var build_module_reducer = Object(
        external_this_wp_data_['combineReducers'],
      )({
        terms: terms,
        users: reducer_users,
      ...
      var isRequestingEmbedPreview = Object(
        external_this_wp_data_['createRegistrySelector'],
      )(function(select) {
      ...
      var getUserQueryResults = Object(rememo['a' /* default */])(
      ...
      function getEntityRecord(state, kind, name, key) {
        return Object(external_lodash_['get'])(state.entities.data, [
          kind,
          name,
          'items',
          key,
      ...
      function getEntityRecords(state, kind, name, query) {
        var queriedState = Object(external_lodash_['get'])(
          state.entities.data,
          [kind, name],
        );
      ...
      function hasUploadPermissions(state) {
        ...
        return Object(external_lodash_['defaultTo'])(
          canUser(state, 'create', 'media'),
          true,
        );
      }
      /**
      ...
      function canUser(state, action, resource, id) {
        var key = Object(external_lodash_['compact'])([
          action,
          resource,
          id,
        ]).join('/');
      ...
      function resolvers_getEntityRecord(kind, name, key) {
        ...
        return regenerator_default.a.wrap(
          function getEntityRecord$(_context2) {
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                case 0:
                  _context2.next = 2;
      ...
      function resolvers_getEntityRecords(kind, name) {
        var query,
          ...
          _args3 = arguments;
        return regenerator_default.a.wrap(
          function getEntityRecords$(_context3) {
            while (1) {
              switch ((_context3.prev = _context3.next)) {
                case 0:
                  query =
                ...
                case 7:
                  path = Object(external_this_wp_url_['addQueryArgs'])(
                    entity.baseURL,
                    Object(objectSpread['a' /* default */])({}, query, {
                      context: 'edit',
                    }),
                  );
                  _context3.next = 10;
      ...
      resolvers_getEntityRecords.shouldInvalidate = function(
        action,
        kind,
        name,
      ) {
      ...
      function resolvers_getThemeSupports() {
        var activeThemes;
        return regenerator_default.a.wrap(
          function getThemeSupports$(_context4) {
            while (1) {
      ...
      function resolvers_getEmbedPreview(url) {
        ...
        return regenerator_default.a.wrap(
          function getEmbedPreview$(_context5) {
            while (1) {
      ...
      function resolvers_hasUploadPermissions() {
        return regenerator_default.a.wrap(
          function hasUploadPermissions$(_context6) {
            while (1) {
              switch ((_context6.prev = _context6.next)) {
                case 0:
                  ...
                  return _context6.delegateYield(
                    resolvers_canUser('create', 'media'),
                    't0',
                    2,
                  );
            ...
            while (1) {
              switch ((_context7.prev = _context7.next)) {
                case 0:
                  ...
                  throw new Error(
                    "'".concat(action, "' is not a valid action."),
                  );

                case 4:
                  path = id
                    ? '/wp/v2/'.concat(resource, '/').concat(id)
                    : '/wp/v2/'.concat(resource);
                  _context7.prev = 5;
                  _context7.next = 8;
                  return apiFetch({
                    path: path,
                ...
                case 14:
                  if (
                    Object(external_lodash_['hasIn'])(response, [
                      'headers',
                      'get',
                    ])
                  ) {
                    ...
                    allowHeader = Object(external_lodash_['get'])(
                      response,
                      ['headers', 'Allow'],
                      '',
                    );
                  ...
                  key = Object(external_lodash_['compact'])([
                    action,
                    resource,
                    id,
                  ]).join('/');
                  isAllowed = Object(external_lodash_['includes'])(
                    allowHeader,
                    method,
                  );
                  _context7.next = 19;
      ...
      var entitySelectors = defaultEntities.reduce(function(result, entity) {
        ...
        result[entities_getMethodName(kind, name, 'get', true)] = function(
          state,
        ) {
          for (
            var _len = arguments.length,
          ...
          return getEntityRecords.apply(
            build_module_selectors_namespaceObject,
            [state, kind, name].concat(args),
          );
        };
      ...
      var entityResolvers = defaultEntities.reduce(function(result, entity) {
        ...
        result[pluralMethodName] = function() {
          ...
          return resolvers_getEntityRecords.apply(
            resolvers_namespaceObject,
            [kind, name].concat(args),
          );
        };
        ...
        result[pluralMethodName].shouldInvalidate = function(action) {
          ...
          return (_resolvers$getEntityR = resolvers_getEntityRecords).shouldInvalidate.apply(
            _resolvers$getEntityR,
            [action, kind, name].concat(args),
          );
        };
      ...
      Object(external_this_wp_data_['registerStore'])(REDUCER_KEY, {
        ...
        actions: Object(objectSpread['a' /* default */])(
          {},
          build_module_actions_namespaceObject,
          entityActions,
        ),
        selectors: Object(objectSpread['a' /* default */])(
          {},
          build_module_selectors_namespaceObject,
          entitySelectors,
        ),
        resolvers: Object(objectSpread['a' /* default */])(
          {},
          resolvers_namespaceObject,
          entityResolvers,
        ),
