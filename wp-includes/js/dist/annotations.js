this['wp'] = this['wp'] || {};
this['wp']['annotations'] = /******/ (function(modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ {
    ...
    /***/ 370: /***/ function(
      ...
      __webpack_require__.d(
        ...
        function() {
          return __experimentalGetAnnotationsForBlock;
        },
      );
      __webpack_require__.d(
        selectors_namespaceObject,
        ...
        function() {
          return selectors_experimentalGetAllAnnotationsForBlock;
        },
      );
      __webpack_require__.d(
        selectors_namespaceObject,
        ...
        function() {
          return __experimentalGetAnnotationsForRichText;
        },
      );
      __webpack_require__.d(
        selectors_namespaceObject,
        ...
        function() {
          return __experimentalGetAnnotations;
        },
      );
      ...
      __webpack_require__.d(
        ...
        function() {
          return __experimentalAddAnnotation;
        },
      );
      __webpack_require__.d(
        actions_namespaceObject,
        ...
        function() {
          return __experimentalRemoveAnnotation;
        },
      );
      __webpack_require__.d(
        actions_namespaceObject,
        ...
        function() {
          return __experimentalUpdateAnnotationRange;
        },
      );
      __webpack_require__.d(
        actions_namespaceObject,
        ...
        function() {
          return __experimentalRemoveAnnotationsBySource;
        },
      );
      ...
      function isValidAnnotationRange(annotation) {
        return (
          Object(external_lodash_['isNumber'])(annotation.start) &&
          Object(external_lodash_['isNumber'])(annotation.end) &&
      ...
      function reducer_annotations() {
        ...
        switch (action.type) {
          case 'ANNOTATION_ADD':
            ...
            var previousAnnotationsForBlock = Object(external_lodash_['get'])(
              state,
              blockClientId,
              [],
            );
          ...
          case 'ANNOTATION_REMOVE':
            return Object(external_lodash_['mapValues'])(state, function(
              annotationsForBlock,
            ) {
              return filterWithReference(annotationsForBlock, function(
                annotation,
              ) {
          ...
          case 'ANNOTATION_UPDATE_RANGE':
            return Object(external_lodash_['mapValues'])(state, function(
              ...
              var newAnnotations = annotationsForBlock.map(function(
                annotation,
              ) {
      ...
      var __experimentalGetAnnotationsForBlock = Object(
        rememo['a' /* default */],
      )(
        ...
        function(state, blockClientId) {
          return [
            Object(external_lodash_['get'])(state, blockClientId, EMPTY_ARRAY),
          ];
        },
      );
      var selectors_experimentalGetAllAnnotationsForBlock = function __experimentalGetAllAnnotationsForBlock(
        state,
        blockClientId,
      ) {
        return Object(external_lodash_['get'])(
      ...
      var __experimentalGetAnnotationsForRichText = Object(
        rememo['a' /* default */],
      )(
        function(state, blockClientId, richTextIdentifier) {
          return Object(external_lodash_['get'])(state, blockClientId, [])
            .filter(function(annotation) {
              return (
      ...
      function __experimentalGetAnnotations(state) {
        return Object(external_lodash_['flatMap'])(state, function(
          annotations,
        ) {
          return annotations;
        });
      ...
      function __experimentalAddAnnotation(_ref) {
        var blockClientId = _ref.blockClientId,
          ...
          richTextIdentifier =
            _ref$richTextIdentifi === void 0 ? null : _ref$richTextIdentifi,
      ...
      function applyAnnotations(record) {
        ...
        annotations.forEach(function(annotation) {
          ...
          record = Object(external_this_wp_richText_['applyFormat'])(
            record,
            {
              type: FORMAT_NAME,
              attributes: {
      ...
      function removeAnnotations(record) {
        return Object(external_this_wp_richText_['removeFormat'])(
          record,
          'core/annotation',
          0,
          record.text.length,
      ...
      var annotation_annotation = {
        ...
        __experimentalGetPropsForEditableTreePreparation: function __experimentalGetPropsForEditableTreePreparation(
          select,
          _ref2,
        ) {
          var richTextIdentifier = _ref2.richTextIdentifier,
            blockClientId = _ref2.blockClientId;
          return getAnnotationObject(
            select(STORE_KEY).__experimentalGetAnnotationsForRichText(
              blockClientId,
              richTextIdentifier,
            ),
          );
        ...
        __experimentalGetPropsForEditableTreeChangeHandler: function __experimentalGetPropsForEditableTreeChangeHandler(
          dispatch,
        ) {
          return {
        ...
        __experimentalCreateOnChangeEditableValue: function __experimentalCreateOnChangeEditableValue(
          props,
        ) {
      ...
      var format_name = annotation_annotation.name,
        settings = Object(objectWithoutProperties['a' /* default */])(
          annotation_annotation,
          ['name'],
        );

      Object(external_this_wp_richText_['registerFormatType'])(
        format_name,
        settings,
      );
      ...
      var block_addAnnotationClassName = function addAnnotationClassName(
        OriginalComponent,
      ) {
        return Object(external_this_wp_data_['withSelect'])(function(
          select,
          _ref,
        ) {
          var clientId = _ref.clientId;

          var annotations = select(
            'core/annotations',
