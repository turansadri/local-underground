        ...
        if (-1 !== (e += '\n').indexOf('<pre')) {
          ...
          for (var i = 0; i < p.length; i++) {
            var o = p[i],
              l = o.indexOf('<pre');
            if (-1 !== l) {
              var s = '<pre wp-pre-tag-' + i + '></pre>';
              n.push([s, o.substr(l) + '</pre>']), (e += o.substr(0, l) + s);
            } else e += o;
          }
          e += a;
        }
      ...
      function i(e) {
        ...
        return e
          ? ((-1 === e.indexOf('<script') && -1 === e.indexOf('<style')) ||
              (e = e.replace(/<(script|style)[^>]*>[\s\S]*?<\/\1>/g, function(
                e,
              ) {
