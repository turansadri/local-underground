this['wp'] = this['wp'] || {};
this['wp']['apiFetch'] = /******/ (function(modules) {
  // webpackBootstrap
  /******/ // The module cache
    ...
    /***/ 369: /***/ function(
      ...
      function createNonceMiddleware(nonce) {
        function middleware(options, next) {
          ...
          return next(
            Object(objectSpread['a' /* default */])({}, options, {
      ...
      var namespace_endpoint_namespaceAndEndpointMiddleware = function namespaceAndEndpointMiddleware(
        options,
        next,
      ) {
      ...
      var root_url_createRootURLMiddleware = function createRootURLMiddleware(
        rootURL,
      ) {
        return function(options, next) {
          return namespace_endpoint(options, function(optionsWithPath) {
            ...
            return next(
              Object(objectSpread['a' /* default */])({}, optionsWithPath, {
                url: url,
              }),
            );
          });
      ...
      var createPreloadingMiddleware = function createPreloadingMiddleware(
        preloadedData,
      ) {
        return function(options, next) {
      ...
      var fetch_all_middleware_modifyQuery = function modifyQuery(
        _ref,
        queryArgs,
      ) {
        var path = _ref.path,
          url = _ref.url,
          options = Object(objectWithoutProperties['a' /* default */])(_ref, [
            'path',
            'url',
          ]);
        ...
        return Object(objectSpread['a' /* default */])({}, options, {
          url:
            url &&
            Object(external_this_wp_url_['addQueryArgs'])(url, queryArgs),
          path:
            path &&
            Object(external_this_wp_url_['addQueryArgs'])(path, queryArgs),
        });
      }; // Duplicates parsing functionality from apiFetch.

      var fetch_all_middleware_parseResponse = function parseResponse(
        response,
      ) {
      ...
      var requestContainsUnboundedQuery = function requestContainsUnboundedQuery(
        options,
      ) {
        var pathIsUnbounded =
                      ...
                      case 4:
                        ...
                        return next(
                          Object(objectSpread['a' /* default */])(
                            {},
                            fetch_all_middleware_modifyQuery(options, {
                              per_page: 100,
                            }),
                            {
      ...
      function httpV1Middleware(options, next) {
        var _options = options,
          ...
          method =
            _options$method === void 0 ? DEFAULT_METHOD : _options$method;

        if (OVERRIDE_METHODS.has(method.toUpperCase())) {
          options = Object(objectSpread['a' /* default */])({}, options, {
            headers: Object(objectSpread['a' /* default */])(
              {},
              options.headers,
              {
      ...
      function userLocaleMiddleware(options, next) {
        if (
          ...
          !Object(external_this_wp_url_['hasQueryArg'])(options.url, '_locale')
        ) {
          options.url = Object(external_this_wp_url_['addQueryArgs'])(
            options.url,
            {
              _locale: 'user',
            },
        ...
        if (
          ...
          !Object(external_this_wp_url_['hasQueryArg'])(options.path, '_locale')
        ) {
          options.path = Object(external_this_wp_url_['addQueryArgs'])(
            options.path,
            {
              _locale: 'user',
            },
      ...
      var build_module_defaultFetchHandler = function defaultFetchHandler(
        nextOptions,
      ) {
        var url = nextOptions.url,
          ...
          remainingOptions = Object(objectWithoutProperties['a' /* default */])(
            nextOptions,
            ['url', 'path', 'data', 'parse'],
          );
      ...
      /* harmony default export */ var build_module = (__webpack_exports__[
        'default'
      ] = apiFetch);
