this['wp'] = this['wp'] || {};
this['wp']['richText'] = /******/ (function(modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ {
    ...
    /***/ 361: /***/ function(
      ...
      __webpack_require__.d(
        ...
        function() {
          return getFormatTypeForBareElement;
        },
      );
      __webpack_require__.d(
        selectors_namespaceObject,
        ...
        function() {
          return getFormatTypeForClassName;
        },
      );
      ...
      var getFormatTypes = Object(rememo['a' /* default */])(
        function(state) {
      ...
      function getFormatTypeForBareElement(state, bareElementTagName) {
        return Object(external_lodash_['find'])(getFormatTypes(state), function(
          _ref,
        ) {
      ...
      function applyFormat(value, format) {
        ...
        if (startIndex === endIndex) {
          var startFormat = Object(external_lodash_['find'])(
        ...
        return normaliseFormats(
          Object(objectSpread['a' /* default */])({}, value, {
            formats: newFormats,
            // Always revise active formats. This serves as a placeholder for new
            // inputs with the format so new input appears with the format applied,
            // and ensures a format of the same type uses the latest values.
            activeFormats: [].concat(
              Object(toConsumableArray['a' /* default */])(
                Object(external_lodash_['reject'])(activeFormats, {
                  type: format.type,
                }),
              ),
              [format],
      ...
      function toFormat(_ref) {
        ...
        if (attributes && attributes.class) {
          formatType = Object(external_this_wp_data_['select'])(
            'core/rich-text',
          ).getFormatTypeForClassName(attributes.class);

          if (formatType) {
            // Preserve any additional classes.
            attributes.class = ' '
              .concat(attributes.class, ' ')
              .replace(' '.concat(formatType.className, ' '), ' ')
              .trim();
        ...
        if (!formatType) {
          formatType = Object(external_this_wp_data_['select'])(
            'core/rich-text',
          ).getFormatTypeForBareElement(type);
        }
      ...
      function createFromElement(_ref3) {
        var element = _ref3.element,
          ...
          currentWrapperTags =
            _ref3$currentWrapperT === void 0 ? [] : _ref3$currentWrapperT,
        ...
        var _loop = function _loop(index) {
          ...
          var format = isFormatEqual(newFormat, lastFormat)
            ? lastFormat
            : newFormat;
            ...
            mergePair(
              ...
              Object(objectSpread['a' /* default */])({}, value, {
                formats: Array.from(value.formats, function(formats) {
                  return formats
                    ? [format].concat(
                        Object(toConsumableArray['a' /* default */])(formats),
                      )
                    : [format];
                }),
              }),
      ...
      function createFromMultilineElement(_ref4) {
        var element = _ref4.element,
          ...
          currentWrapperTags =
            _ref4$currentWrapperT === void 0 ? [] : _ref4$currentWrapperT,
      ...
      function isEmptyLine(_ref2) {
        ...
        return (
          ...
          ''.concat(LINE_SEPARATOR).concat(LINE_SEPARATOR)
        );
      }
      ...
      function registerFormatType(name, settings) {
        ...
        if (settings.className === null) {
          var formatTypeForBareElement = Object(
            external_this_wp_data_['select'],
          )('core/rich-text').getFormatTypeForBareElement(settings.tagName);

          if (formatTypeForBareElement) {
            window.console.error(
              'Format "'
                .concat(
                  formatTypeForBareElement.name,
                  '" is already registered to handle bare tag name "',
                )
                .concat(settings.tagName, '".'),
            );
            return;
          }
        } else {
          var formatTypeForClassName = Object(external_this_wp_data_['select'])(
            'core/rich-text',
          ...
          if (formatTypeForClassName) {
            window.console.error(
              'Format "'
                .concat(
                  formatTypeForClassName.name,
                  '" is already registered to handle class name "',
                )
                .concat(settings.className, '".'),
            );
            return;
          }
        }
        ...
        var getFunctionStackMemoized = memize_default()(function() {
          ...
          return [].concat(
            Object(toConsumableArray['a' /* default */])(previousStack),
            [newFunction],
          );
        });
        ...
        if (settings.__experimentalCreatePrepareEditableTree) {
          Object(external_this_wp_hooks_['addFilter'])(
            ...
            function(OriginalComponent) {
              ...
              if (
                ...
                Component = function Component(props) {
                  ...
                  if (settings.__experimentalCreateOnChangeEditableValue) {
                    var dispatchProps = Object.keys(props).reduce(function(
                      accumulator,
                      propKey,
                    ) {
              ...
              if (settings.__experimentalGetPropsForEditableTreeChangeHandler) {
                hocs.push(
                  Object(external_this_wp_data_['withDispatch'])(function(
                    ...
                    var dispatchProps = settings.__experimentalGetPropsForEditableTreeChangeHandler(
                      disp,
                      {
                        richTextIdentifier: identifier,
                        blockClientId: clientId,
                    ...
                    return Object(external_lodash_['mapKeys'])(
                      dispatchProps,
                      function(value, key) {
              ...
              return Object(external_this_wp_compose_['compose'])(hocs)(
                Component,
              );
            },
          );
      ...
      function removeFormat(value, formatType) {
        ...
        if (startIndex === endIndex) {
          var format = Object(external_lodash_['find'])(
            newFormats[startIndex],
            {
              type: formatType,
            },
          ...
          if (format) {
            while (
              Object(external_lodash_['find'])(newFormats[startIndex], format)
            ) {
            ...
            while (
              Object(external_lodash_['find'])(newFormats[endIndex], format)
            ) {
      ...
      function insertLineSeparator(value) {
        ...
        var previousLineSeparatorFormats =
      ...
      function fromFormat(_ref) {
        ...
        if (!formatType) {
          if (attributes) {
            elementAttributes = Object(objectSpread['a' /* default */])(
              {},
              attributes,
              elementAttributes,
            );
        ...
        if (formatType.className) {
          if (elementAttributes.class) {
            elementAttributes.class = ''
              .concat(formatType.className, ' ')
              .concat(elementAttributes.class);
          } else {
      ...
      function toTree(_ref2) {
        ...
        var _loop = function _loop(i) {
          ...
          var shouldInsertPadding =
            isEditableTree && // Pad the line if the line is empty.
            (!lastCharacter ||
            lastCharacter === LINE_SEPARATOR || // Pad the line if the previous character is a line break, otherwise
          ...
          if (characterFormats) {
            characterFormats.forEach(function(format, formatIndex) {
              if (
                ...
                format === lastCharacterFormats[formatIndex] && // Do not reuse the last element if the character is a
                // line separator.
          ...
          if (character === OBJECT_REPLACEMENT_CHARACTER) {
            pointer = append(
              getParent(pointer),
              fromFormat(
                Object(objectSpread['a' /* default */])({}, replacements[i], {
                  object: true,
                }),
              ),
      ...
      function toDom(_ref5) {
        var value = _ref5.value,
          ...
          isEditableTree =
            _ref5$isEditableTree === void 0 ? true : _ref5$isEditableTree;
        var startPath = [];
        var endPath = [];
        var tree = toTree({
        ...
        while ((futureChild = future.firstChild)) {
          ...
          if (!currentChild) {
            ...
            if (
              ...
              (currentChild.nodeType === to_dom_TEXT_NODE &&
      ...
      function createElementHTML(_ref6) {
        ...
        for (var key in attributes) {
          if (
            !Object(external_this_wp_escapeHtml_['isValidAttributeName'])(key)
          ) {
            continue;
          }
          ...
          attributeString += ' '
            .concat(key, '="')
            .concat(
              Object(external_this_wp_escapeHtml_['escapeAttribute'])(
                attributes[key],
              ),
              '"',
            );
        ...
        return '<'
          ...
          .concat(createChildrenHTML(children), '</')
          .concat(type, '>');
      }
        ...
        return children
          .map(function(child) {
            return child.text === undefined
              ...
              : Object(external_this_wp_escapeHtml_['escapeHTML'])(child.text);
          })
          .join('');
      }
      ...
      function unregisterFormatType(name) {
        var oldFormat = Object(external_this_wp_data_['select'])(
          'core/rich-text',
        ).getFormatType(name);
        ...
        if (
          ...
          Object(external_this_wp_hooks_['removeFilter'])(
            'experimentalRichText',
            name,
          );
        }
      ...
      function indentListItems(value, rootFormat) {
        ...
        for (var index = lineIndex; index < end; index++) {
          ...
          if (targetLevelLineIndex) {
            ...
            var lastformat =
              _targetFormats[_targetFormats.length - 1] || rootFormat;
            newFormats[index] = _targetFormats.concat(
              [lastformat],
              (newFormats[index] || []).slice(_targetFormats.length),
            );
          }
        }
      ...
      function changeListType(value, newFormat) {
        ...
        for (var index = startIndex + 1 || 0; index < text.length; index++) {
          ...
          changed = true;
          newReplacements[index] = newReplacements[index].map(function(
            format,
            i,
          ) {
      ...
      /* concated harmony reexport applyFormat */ __webpack_require__.d(
        __webpack_exports__,
        'applyFormat',
        function() {
          return applyFormat;
      ...
      /* concated harmony reexport charAt */ __webpack_require__.d(
        __webpack_exports__,
        'charAt',
        function() {
          return charAt;
      ...
      /* concated harmony reexport concat */ __webpack_require__.d(
        __webpack_exports__,
        'concat',
        function() {
          return concat;
      ...
      /* concated harmony reexport create */ __webpack_require__.d(
        __webpack_exports__,
        'create',
        function() {
          return create;
      ...
      /* concated harmony reexport getActiveFormat */ __webpack_require__.d(
        __webpack_exports__,
        'getActiveFormat',
        function() {
      ...
      /* concated harmony reexport getActiveObject */ __webpack_require__.d(
        __webpack_exports__,
        'getActiveObject',
        function() {
      ...
      /* concated harmony reexport getSelectionEnd */ __webpack_require__.d(
        __webpack_exports__,
        'getSelectionEnd',
        function() {
      ...
      /* concated harmony reexport getSelectionStart */ __webpack_require__.d(
        __webpack_exports__,
        'getSelectionStart',
        function() {
      ...
      /* concated harmony reexport getTextContent */ __webpack_require__.d(
        __webpack_exports__,
        'getTextContent',
        function() {
      ...
      /* concated harmony reexport isCollapsed */ __webpack_require__.d(
        __webpack_exports__,
        'isCollapsed',
        function() {
          return isCollapsed;
      ...
      /* concated harmony reexport isEmpty */ __webpack_require__.d(
        __webpack_exports__,
        'isEmpty',
        function() {
          return isEmpty;
      ...
      /* concated harmony reexport isEmptyLine */ __webpack_require__.d(
        __webpack_exports__,
        'isEmptyLine',
        function() {
          return isEmptyLine;
      ...
      /* concated harmony reexport join */ __webpack_require__.d(
        __webpack_exports__,
        'join',
        function() {
          return join;
      ...
      /* concated harmony reexport registerFormatType */ __webpack_require__.d(
        __webpack_exports__,
        'registerFormatType',
        function() {
      ...
      /* concated harmony reexport removeFormat */ __webpack_require__.d(
        __webpack_exports__,
        'removeFormat',
        function() {
          return removeFormat;
      ...
      /* concated harmony reexport remove */ __webpack_require__.d(
        __webpack_exports__,
        'remove',
        function() {
      ...
      /* concated harmony reexport replace */ __webpack_require__.d(
        __webpack_exports__,
        'replace',
        function() {
          return replace;
      ...
      /* concated harmony reexport insert */ __webpack_require__.d(
        __webpack_exports__,
        'insert',
        function() {
          return insert;
      ...
      /* concated harmony reexport insertLineBreak */ __webpack_require__.d(
        __webpack_exports__,
        'insertLineBreak',
        function() {
      ...
      /* concated harmony reexport insertLineSeparator */ __webpack_require__.d(
        __webpack_exports__,
        'insertLineSeparator',
        function() {
      ...
      /* concated harmony reexport insertObject */ __webpack_require__.d(
        __webpack_exports__,
        'insertObject',
        function() {
          return insertObject;
      ...
      /* concated harmony reexport slice */ __webpack_require__.d(
        __webpack_exports__,
        'slice',
        function() {
          return slice;
      ...
      /* concated harmony reexport split */ __webpack_require__.d(
        __webpack_exports__,
        'split',
        function() {
          return split;
      ...
      /* concated harmony reexport apply */ __webpack_require__.d(
        __webpack_exports__,
        'apply',
        function() {
          return apply;
      ...
      /* concated harmony reexport unstableToDom */ __webpack_require__.d(
        __webpack_exports__,
        'unstableToDom',
        function() {
          return toDom;
      ...
      /* concated harmony reexport toHTMLString */ __webpack_require__.d(
        __webpack_exports__,
        'toHTMLString',
        function() {
          return toHTMLString;
      ...
      /* concated harmony reexport toggleFormat */ __webpack_require__.d(
        __webpack_exports__,
        'toggleFormat',
        function() {
          return toggleFormat;
      ...
      /* concated harmony reexport LINE_SEPARATOR */ __webpack_require__.d(
        __webpack_exports__,
        'LINE_SEPARATOR',
        function() {
      ...
      /* concated harmony reexport unregisterFormatType */ __webpack_require__.d(
        __webpack_exports__,
        'unregisterFormatType',
        function() {
          return unregisterFormatType;
        },
      );
      /* concated harmony reexport indentListItems */ __webpack_require__.d(
        __webpack_exports__,
        'indentListItems',
        function() {
          return indentListItems;
        },
      );
      /* concated harmony reexport outdentListItems */ __webpack_require__.d(
        __webpack_exports__,
        'outdentListItems',
        function() {
          return outdentListItems;
        },
      );
      /* concated harmony reexport changeListType */ __webpack_require__.d(
        __webpack_exports__,
        'changeListType',
        function() {
      ...
      /* concated harmony reexport __unstableUpdateFormats */ __webpack_require__.d(
        __webpack_exports__,
      ...
      /* concated harmony reexport __unstableGetActiveFormats */ __webpack_require__.d(
        __webpack_exports__,
    ...
    /***/ 69: /***/ function(module, exports) {
      (function() {
        module.exports = this['wp']['escapeHtml'];
      })();
