(function() {
  ...
  if ('undefined' === typeof FormData || !FormData.prototype.keys) {
    var N = function(a, b) {
      ...
      U = R.Request && R.fetch;
    p();
    var V = R.Symbol && Symbol.toStringTag,
      W = new WeakMap(),
      X =
        Array.from ||
        function(a) {
    ...
    V &&
      ...
      'File' in R && !File.prototype[V] && (File.prototype[V] = 'File'));
    try {
      new File([], '');
    } catch (a) {
      R.File = function(b, d, c) {
        b = new Blob(b, c);
        c =
        ...
        V && Object.defineProperty(b, V, { value: 'File' });
        return b;
      };
    }
    p();
    ...
    k.get = function(b) {
      var d = W.get(this);
      return d[b] ? Q(d[b][0]) : null;
    };
    k.getAll = function(b) {
      return (W.get(this)[b] || []).map(Q);
    };
    k.has = function(b) {
      return b in W.get(this);
    };
    k.keys = function d() {
      var c = this,
        e,
    ...
    Y.prototype._asNative = function() {
      for (var c = new S(), e = x(this), f = e.next(); !f.done; f = e.next()) {
        var g = x(f.value);
        f = g.next().value;
        g = g.next().value;
        c.append(f, g);
    ...
    [
      ...
      var e = Y.prototype[c[0]];
      Y.prototype[c[0]] = function() {
        return e.apply(this, c[1].apply(this, X(arguments)));
      };
    });
    T &&
    ...
    if (U) {
      var Z = R.fetch;
      R.fetch = function(c, e) {
        e && e.body && e.body instanceof Y && (e.body = e.body._blob());
        return Z(c, e);
      };
    }
    R.FormData = Y;
