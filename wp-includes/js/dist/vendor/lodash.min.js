...
(function() {
  ...
  (Un['[object Float32Array]'] = Un['[object Float64Array]'] = Un[
    ...
    (Un['[object Arguments]'] = Un['[object Array]'] = Un[
      '[object ArrayBuffer]'
    ] = Un['[object Boolean]'] = Un['[object DataView]'] = Un[
      '[object Date]'
    ] = Un['[object Error]'] = Un['[object Function]'] = Un[
      '[object Map]'
    ] = Un['[object Number]'] = Un['[object Object]'] = Un[
      '[object RegExp]'
    ] = Un['[object Set]'] = Un['[object String]'] = Un[
      '[object WeakMap]'
    ] = false);
  var Bn = {};
  (Bn['[object Arguments]'] = Bn['[object Array]'] = Bn[
    '[object ArrayBuffer]'
  ] = Bn['[object DataView]'] = Bn['[object Boolean]'] = Bn[
    '[object Date]'
  ...
  var Ln = {
    ...
    rt = (function x(mn) {
      ...
      function Mt(n, t, r, e, u) {
        ...
        n: {
          ...
          if (c && !a)
            u || (u = new Zn()),
              (t =
                i || _f(n) ? se(n, t, r, e, Mt, u) : he(n, t, f, r, e, Mt, u));
          else {
            if (
              !(1 & r) &&
      ...
      function Jr(n, t, r, e, u, i, o, f, c, a) {
        function l() {
          ...
          if (
            ...
            return (
              (j = B(y, j)), ue(n, t, Jr, l.placeholder, r, y, j, f, c, a - d)
            );
      ...
      var Xo = fr(function(t, r) {
          r =
            1 == r.length && ff(r[0]) ? c(r[0], E(ye())) : c(wt(r, 1), E(ye()));
          var e = r.length;
      ...
      return (
        ...
        (An.update = function(n, t, r) {
          return (
            null != n && ((r = Er(r)), (n = lr(n, t, r(Et(n, t)), void 0))), n
          );
        }),
        ...
        (An.toSafeInteger = function(n) {
          return n
            ? pt(ku(n), -9007199254740991, 9007199254740991)
            : 0 === n
            ? n
            : 0;
        }),
        ...
        (Ln.prototype.slice = function(n, t) {
          ...
          return r.__filtered__ && (0 < n || 0 > t)
            ...
            : (0 > n ? (r = r.takeRight(-n)) : n && (r = r.drop(n)),
              t !== T &&
                ((t = ku(t)), (r = 0 > t ? r.dropRight(-t) : r.take(t - n))),
              r);
        }),
