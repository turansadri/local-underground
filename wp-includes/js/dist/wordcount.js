this['wp'] = this['wp'] || {};
this['wp']['wordcount'] = /******/ (function(modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ {
    ...
    /***/ 365: /***/ function(
       ...
       * @return {string} The manipulated text.
       */
      /* harmony default export */ var transposeAstralsToCountableChar = function(
        settings,
        text,
      ) {
       ...
       * @return {string} The manipulated text.
       */
      /* harmony default export */ var stripHTMLEntities = function(
        settings,
        text,
      ) {
       ...
       * @return {string} The manipulated text.
       */
      /* harmony default export */ var stripConnectors = function(
        settings,
        text,
      ) {
       ...
       * @return {string} The manipulated text.
       */
      /* harmony default export */ var stripRemovables = function(
        settings,
        text,
      ) {
       ...
       * @return {string} The manipulated text.
       */
      /* harmony default export */ var stripHTMLComments = function(
        settings,
        text,
      ) {
       ...
       * @return {string} The manipulated text.
       */
      /* harmony default export */ var stripShortcodes = function(
        settings,
        text,
      ) {
       ...
       * @return {string} The manipulated text.
       */
      /* harmony default export */ var transposeHTMLEntitiesToCountableChars = function(
        settings,
        text,
      ) {
        if (settings.HTMLEntityRegExp) {
      ...
      function loadSettings(type, userSettings) {
        var settings = Object(external_lodash_['extend'])(
          defaultSettings,
          userSettings,
        );
      ...
      function matchWords(text, regex, settings) {
        text = Object(external_lodash_['flow'])(
