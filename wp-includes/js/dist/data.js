...
this['wp']['data'] = /******/ (function(modules) {
  ...
  /******/ {
    ...
    /***/ 224: /***/ function(module, exports) {
      (function() {
        module.exports = this['wp']['reduxRoutine'];
      })();
    ...
    /***/ 225: /***/ function(module, exports) {
      (function() {
        module.exports = this['wp']['priorityQueue'];
      })();
    ...
    /***/ 363: /***/ function(
      ...
      var resolvers_cache_middleware_createResolversCacheMiddleware = function createResolversCacheMiddleware(
        registry,
        reducerKey,
      ) {
        return function() {
          return function(next) {
            return function(action) {
              ...
              Object.entries(resolvers).forEach(function(_ref) {
                ...
                var resolver = Object(external_lodash_['get'])(
                  registry.namespaces,
                  [reducerKey, 'resolvers', selectorName],
                );
      ...
      function createReduxStore(key, options, registry) {
        var enhancers = [
          Object(redux['a' /* applyMiddleware */])(
        ...
        return Object(redux['c' /* createStore */])(
          reducer,
          initialState,
      ...
      function mapSelectors(selectors, store, registry) {
        var createStateSelector = function createStateSelector(
          registeredSelector,
        ) {
          var selector = registeredSelector.isRegistrySelector
      ...
      function mapResolvers(resolvers, selectors, fulfillment, store) {
                      ...
                      while (1) {
                        switch ((_context.prev = _context.next)) {
                          ...
                          case 5:
                            ...
                            _context.next = 8;
                            return fulfillment.fulfill.apply(
                              fulfillment,
                              [selectorName].concat(args),
                            );
        ...
        var mappedResolvers = Object(external_lodash_['mapValues'])(
          resolvers,
          function(resolver) {
            var _resolver$fulfill = resolver.fulfill,
              resolverFulfill =
                _resolver$fulfill === void 0 ? resolver : _resolver$fulfill;
        ...
        return {
          ...
          selectors: Object(external_lodash_['mapValues'])(
            selectors,
            mapSelector,
          ),
        };
      ...
      function getCoreDataFulfillment(registry, key) {
        ...
        return {
          ...
          fulfill: function fulfill() {
            ...
            return fulfillWithRegistry.apply(
              void 0,
              [registry, key].concat(args),
            );
          },
        };
      }
                ...
                while (1) {
                  switch ((_context2.prev = _context2.next)) {
                    case 0:
                      ...
                      resolver = Object(external_lodash_['get'])(namespace, [
                        'resolvers',
                        selectorName,
                      ]);
      ...
      var equivalent_key_map_default = /*#__PURE__*/ __webpack_require__.n(
        equivalent_key_map,
      );
        ...
        return function(reducer) {
          return function() {
            ...
            return Object(objectSpread['a' /* default */])(
              {},
              state,
              Object(defineProperty['a' /* default */])({}, key, nextKeyState),
            );
          };
        };
      };
      ...
      var subKeysIsResolved = Object(external_lodash_['flowRight'])([
        utils_onSubKey('reducerKey'),
        utils_onSubKey('selectorName'),
      ])(function() {
        var state =
          arguments.length > 0 && arguments[0] !== undefined
            ? arguments[0]
      ...
      var reducer_isResolved = function isResolved() {
        ...
        switch (action.type) {
          case 'INVALIDATE_RESOLUTION_FOR_STORE':
            return Object(external_lodash_['has'])(state, action.reducerKey)
              ? Object(external_lodash_['omit'])(state, [action.reducerKey])
              : state;

          case 'INVALIDATE_RESOLUTION_FOR_STORE_SELECTOR':
            return Object(external_lodash_['has'])(state, [
              action.reducerKey,
              action.selectorName,
            ])
      ...
      function getIsResolving(state, reducerKey, selectorName, args) {
        var map = Object(external_lodash_['get'])(state, [
          reducerKey,
          selectorName,
        ]);
      ...
      function hasStartedResolution(state, reducerKey, selectorName) {
        var args =
          arguments.length > 3 && arguments[3] !== undefined
            ...
            : [];
        return (
          getIsResolving(state, reducerKey, selectorName, args) !== undefined
        );
      }
      /**
      ...
      function createRegistry() {
        ...
        var subscribe = function subscribe(listener) {
          ...
          return function() {
            listeners = Object(external_lodash_['without'])(
              listeners,
              listener,
            );
          };
        ...
        function withPlugins(attributes) {
          return Object(external_lodash_['mapValues'])(attributes, function(
            attribute,
            key,
          ) {
        ...
        function use(plugin, options) {
          registry = Object(objectSpread['a' /* default */])(
            {},
            registry,
      ...
      var external_this_wp_reduxRoutine_default = /*#__PURE__*/ __webpack_require__.n(
        external_this_wp_reduxRoutine_,
      );
      ...
      /* harmony default export */ var controls = function(registry) {
        return {
          registerStore: function registerStore(reducerKey, options) {
            ...
            if (options.controls) {
              var normalizedControls = Object(external_lodash_['mapValues'])(
                options.controls,
                function(control) {
                  return control.isRegistryControl
                    ? control(registry)
                    : control;
                },
              );
              var middleware = external_this_wp_reduxRoutine_default()(
                normalizedControls,
              );
              var enhancer = Object(redux['a' /* applyMiddleware */])(
                middleware,
              );
      ...
      function createPersistenceInterface(options) {
        var _options$storage = options.storage,
          storage =
            _options$storage === void 0 ? DEFAULT_STORAGE : _options$storage,
          _options$storageKey = options.storageKey,
          storageKey =
            _options$storageKey === void 0
              ? DEFAULT_STORAGE_KEY
              : _options$storageKey;
        var data;
        /**
        ...
        function set(key, value) {
          data = Object(objectSpread['a' /* default */])(
            {},
            data,
            Object(defineProperty['a' /* default */])({}, key, value),
          );
      ...
      var persistence_persistencePlugin = function persistencePlugin(
        registry,
        pluginOptions,
      ) {
          ...
          if (Array.isArray(keys)) {
            ...
            var reducers = keys.reduce(function(result, key) {
              return Object.assign(
                result,
                Object(defineProperty['a' /* default */])({}, key, function(
                  state,
                  action,
                ) {
            ...
            getPersistedState = withLazySameState(
              turbo_combine_reducers_default()(reducers),
            );
          } else {
        ...
        return {
          registerStore: function registerStore(reducerKey, options) {
            ...
            var store = registry.registerStore(reducerKey, options);
            store.dispatch = Object(external_lodash_['flow'])([
              store.dispatch,
      ...
      persistence_persistencePlugin.__unstableMigrate = function(
        pluginOptions,
      ) {
        ...
        if (
          coreEditorState &&
          coreEditorState.preferences &&
          coreEditorState.preferences.insertUsage
        ) {
          ...
          persistence.set(
            'core/editor',
            Object(objectSpread['a' /* default */])({}, coreEditorState, {
              preferences: Object(external_lodash_['omit'])(
                coreEditorState.preferences,
                ['insertUsage'],
              ),
            }),
      ...
      var async_mode_provider_createContext = Object(
          external_this_wp_element_['createContext'],
        )(false),
        async_mode_provider_Consumer =
          async_mode_provider_createContext.Consumer,
        async_mode_provider_Provider =
          async_mode_provider_createContext.Provider;
      ...
      var renderQueue = Object(
        external_this_wp_priorityQueue_['createQueue'],
      )();
      /**
      ...
      var with_select_withSelect = function withSelect(mapSelectToProps) {
        return Object(external_this_wp_compose_['createHigherOrderComponent'])(
            ...
            var ComponentWithSelect =
              ...
              (function(_Component) {
                ...
                function ComponentWithSelect(props) {
                  ...
                  _this.onStoreChange = _this.onStoreChange.bind(
                ...
                Object(createClass['a' /* default */])(ComponentWithSelect, [
                  ...
                  },
                  {
                    ...
                    value: function shouldComponentUpdate(
                      ...
                      var hasRegistryChanged =
                        nextProps.registry !== this.props.registry;
                      var hasSyncRenderingChanged =
                        nextProps.isAsync !== this.props.isAsync;
                      ...
                      var hasPropsChanged =
                        ...
                        )(this.props.ownProps, nextProps.ownProps); // Only render if props have changed or merge props have been updated
                      // from the store subscriber.

                      if (
                        this.state === nextState &&
                        !hasPropsChanged &&
                        !hasSyncRenderingChanged
                      ) {
                        return false;
                      }
      ...
      var with_dispatch_withDispatch = function withDispatch(
        mapDispatchToProps,
      ) {
        return Object(external_this_wp_compose_['createHigherOrderComponent'])(
          function(WrappedComponent) {
                ...
                Object(createClass['a' /* default */])(ComponentWithDispatch, [
                  {
                    ...
                    value: function proxyDispatch(propName) {
                      ...
                      (_mapDispatchToProps = mapDispatchToProps(
                        this.props.registry.dispatch,
                        this.props.ownProps,
                        this.props.registry,
                      ))[propName].apply(_mapDispatchToProps, args);
                    },
                  },
                  {
                    key: 'setProxyProps',
                    value: function setProxyProps(props) {
                      ...
                      this.proxyProps = Object(external_lodash_['mapValues'])(
                        propsToDispatchers,
                        function(dispatcher, propName) {
                          if (typeof dispatcher !== 'function') {
                            // eslint-disable-next-line no-console
                            console.warn(
                              'Property '.concat(
                                propName,
                                ' returned from mapDispatchToProps in withDispatch must be a function.',
                              ),
                            );
      ...
      /* harmony export (binding) */ __webpack_require__.d(
        ...
        function() {
          return build_module_registerGenericStore;
        },
      );
      /* harmony export (binding) */ __webpack_require__.d(
        __webpack_exports__,
        'registerStore',
        function() {
          return build_module_registerStore;
        },
      );
      /* harmony export (binding) */ __webpack_require__.d(
        __webpack_exports__,
        'use',
        function() {
          return build_module_use;
        },
      );
      /* concated harmony reexport withSelect */ __webpack_require__.d(
        __webpack_exports__,
        'withSelect',
        function() {
          return with_select;
      ...
      /* concated harmony reexport withDispatch */ __webpack_require__.d(
        __webpack_exports__,
        'withDispatch',
        function() {
      ...
      /* concated harmony reexport withRegistry */ __webpack_require__.d(
        __webpack_exports__,
        'withRegistry',
        function() {
      ...
      /* concated harmony reexport RegistryProvider */ __webpack_require__.d(
        __webpack_exports__,
        'RegistryProvider',
        function() {
      ...
      /* concated harmony reexport RegistryConsumer */ __webpack_require__.d(
        __webpack_exports__,
        'RegistryConsumer',
        function() {
      ...
      /* concated harmony reexport __experimentalAsyncModeProvider */ __webpack_require__.d(
        __webpack_exports__,
        '__experimentalAsyncModeProvider',
        function() {
          return async_mode_provider;
        },
      );
      /* concated harmony reexport createRegistry */ __webpack_require__.d(
        __webpack_exports__,
        'createRegistry',
        function() {
      ...
      /* concated harmony reexport plugins */ __webpack_require__.d(
        __webpack_exports__,
        'plugins',
        function() {
          return plugins_namespaceObject;
        },
      );
      /* concated harmony reexport createRegistrySelector */ __webpack_require__.d(
        __webpack_exports__,
        'createRegistrySelector',
        function() {
          return createRegistrySelector;
        },
      );
      /* concated harmony reexport createRegistryControl */ __webpack_require__.d(
        __webpack_exports__,
        'createRegistryControl',
        function() {
          return createRegistryControl;
        },
      );
      /* concated harmony reexport combineReducers */ __webpack_require__.d(
        __webpack_exports__,
        'combineReducers',
        function() {
          return turbo_combine_reducers_default.a;
        },
      );
      /**
       * External dependencies
      ...
      var build_module_registerGenericStore =
      ...
      function createStore(reducer, preloadedState, enhancer) {
        ...
        function observable() {
          ...
          return (
            ...
            (_ref[
              symbol_observable__WEBPACK_IMPORTED_MODULE_0__[/* default */ 'a']
            ] = function() {
              return this;
            }),
            _ref
    ...
    /***/ 77: /***/ function(module, __webpack_exports__, __webpack_require__) {
      ...
      }.call(this, __webpack_require__(59), __webpack_require__(132)(module)));
