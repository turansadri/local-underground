  ...
  (this.wp.keycodes = (function(t) {
    ...
    382: function(t, n, r) {
      ...
      function i() {
        ...
        return (
          -1 !== t.indexOf('Mac') || Object(o.includes)(['iPad', 'iPhone'], t)
        );
      }
      r.d(n, 'BACKSPACE', function() {
        return a;
      }),
        r.d(n, 'TAB', function() {
          return f;
      ...
      var a = 8,
        ...
        w = Object(o.mapValues)(A, function(t) {
          return function(n) {
            var r =
        ...
        C = Object(o.mapValues)(A, function(t) {
          return function(n) {
            var r,
              ...
              a = c(),
              f = ((r = {}),
              Object(e.a)(r, h, a ? '⌥' : 'Alt'),
              Object(e.a)(r, m, a ? '^' : 'Ctrl'),
              Object(e.a)(r, g, '⌘'),
              Object(e.a)(r, S, a ? '⇧' : 'Shift'),
              r),
              l = t(c).reduce(function(t, n) {
                var r = Object(o.get)(f, n, n);
                return [].concat(Object(u.a)(t), a ? [r] : [r, '+']);
              }, []),
              d = Object(o.capitalize)(n);
            return [].concat(Object(u.a)(l), [d]);
          };
        }),
        P = Object(o.mapValues)(C, function(t) {
          return function(n) {
            var r =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
        ...
        E = Object(o.mapValues)(A, function(t) {
          return function(n) {
            var r,
              ...
              f = a(),
              l = ((r = {}),
              Object(e.a)(r, S, 'Shift'),
              Object(e.a)(r, g, f ? 'Command' : 'Control'),
              Object(e.a)(r, m, 'Control'),
              Object(e.a)(r, h, f ? 'Option' : 'Alt'),
              Object(e.a)(r, ',', Object(c.__)('Comma')),
              Object(e.a)(r, '.', Object(c.__)('Period')),
              Object(e.a)(r, '`', Object(c.__)('Backtick')),
              r);
            return []
              .concat(Object(u.a)(t(a)), [n])
              .map(function(t) {
                return Object(o.capitalize)(Object(o.get)(l, t, t));
              })
              .join(f ? ' ' : ' + ');
          };
        }),
        _ = Object(o.mapValues)(A, function(t) {
          return function(n, r) {
            ...
            return (
              !!u.every(function(t) {
                return n[''.concat(t, 'Key')];
              }) &&
              (r ? n.key === r : Object(o.includes)(u, n.key.toLowerCase()))
            );
          };
        });
    },
