this['wp'] = this['wp'] || {};
this['wp']['formatLibrary'] = /******/ (function(modules) {
  // webpackBootstrap
  /******/ // The module cache
    ...
    /***/ 367: /***/ function(
      ...
      var bold = {
        ...
        edit: function edit(_ref) {
          ...
          var onToggle = function onToggle() {
            return onChange(
              Object(external_this_wp_richText_['toggleFormat'])(value, {
                type: bold_name,
              }),
            );
          };
      ...
      var image_image = {
        ...
        keywords: [
          ...
          Object(external_this_wp_i18n_['__'])('media'),
        ],
        object: true,
        tagName: 'img',
        className: null,
          ...
          (function(_Component) {
            ...
            function ImageEdit() {
              ...
              _this = Object(possibleConstructorReturn['a' /* default */])(
                this,
                Object(getPrototypeOf['a' /* default */])(ImageEdit).apply(
                  this,
                  arguments,
                ),
              );
              ...
              [
                ...
                },
                {
                  ...
                  value: function onKeyDown(event) {
                    if (
                      [
                        external_this_wp_keycodes_['LEFT'],
                        external_this_wp_keycodes_['DOWN'],
                        external_this_wp_keycodes_['RIGHT'],
                        external_this_wp_keycodes_['UP'],
                        external_this_wp_keycodes_['BACKSPACE'],
                        external_this_wp_keycodes_['ENTER'],
                    ...
                    return Object(external_this_wp_element_['createElement'])(
                        ...
                        external_this_wp_blockEditor_['RichTextToolbarButton'],
                        {
                          icon: Object(
                            ...
                            Object(external_this_wp_element_['createElement'])(
                              ...
                              {
                                d:
                                  'M4 16h10c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v9c0 1.1.9 2 2 2zM4 5h10v9H4V5zm14 9v2h4v-2h-4zM2 20h20v-2H2v2zm6.4-8.8L7 9.4 5 12h8l-2.6-3.4-2 2.6z',
                              },
                            ),
                          ),
                        ...
                        Object(external_this_wp_element_['createElement'])(
                          external_this_wp_blockEditor_['MediaUpload'],
                          {
                            ...
                            onSelect: function onSelect(_ref) {
                              ...
                              onChange(
                                Object(
                                  external_this_wp_richText_['insertObject'],
                                )(value, {
                                  type: image_name,
                                  attributes: {
                      ...
                      isObjectActive &&
                        Object(external_this_wp_element_['createElement'])(
                          ...
                          Object(external_this_wp_element_['createElement'])(
                            external_this_wp_components_['Popover'],
                            {
                            ...
                            Object(external_this_wp_element_['createElement'])(
                              ...
                              {
                                className:
                                  'editor-format-toolbar__image-container-content block-editor-format-toolbar__image-container-content',
      ...
      function isValidHref(href) {
        ...
        if (/^\S+:/.test(trimmedHref)) {
          var protocol = Object(external_this_wp_url_['getProtocol'])(
            trimmedHref,
          );
          ...
          if (
            Object(external_lodash_['startsWith'])(protocol, 'http') &&
            !/^https?:\/\/[^\/\s]/i.test(trimmedHref)
          ) {
            return false;
          }

          var authority = Object(external_this_wp_url_['getAuthority'])(
            trimmedHref,
          );
          ...
          var queryString = Object(external_this_wp_url_['getQueryString'])(
            trimmedHref,
          );

          if (
            queryString &&
            !Object(external_this_wp_url_['isValidQueryString'])(queryString)
          ) {
            return false;
          }

          var fragment = Object(external_this_wp_url_['getFragment'])(
            trimmedHref,
          );

          if (
            fragment &&
            !Object(external_this_wp_url_['isValidFragment'])(fragment)
          ) {
            return false;
          }
        ...
        if (
          Object(external_lodash_['startsWith'])(trimmedHref, '#') &&
          !Object(external_this_wp_url_['isValidFragment'])(trimmedHref)
        ) {
          return false;
        }
      ...
      function createLinkFormat(_ref) {
        ...
        if (opensInNewWindow) {
          ...
          var label = Object(external_this_wp_i18n_['sprintf'])(
            Object(external_this_wp_i18n_['__'])('%s (opens in a new tab)'),
            text,
          );
      ...
      var inline_LinkEditor = function LinkEditor(_ref) {
        ...
        return (
          ...
          Object(external_this_wp_element_['createElement'])(
            ...
            Object(external_this_wp_element_['createElement'])(
              external_this_wp_blockEditor_['URLInput'],
              {
                value: value,
      ...
      var inline_LinkViewerUrl = function LinkViewerUrl(_ref2) {
        ...
        var linkClassName = classnames_default()(
        ...
        return Object(external_this_wp_element_['createElement'])(
          ...
          Object(external_this_wp_url_['filterURLForDisplay'])(
            Object(external_this_wp_url_['safeDecodeURI'])(url),
          ),
        );
      };
      ...
      var inline_URLPopoverAtLink = function URLPopoverAtLink(_ref3) {
        ...
        var anchorRect = Object(external_this_wp_element_['useMemo'])(
          function() {
            ...
            if (addingLink) {
              return Object(external_this_wp_dom_['getRectangleFromRange'])(
                range,
              );
            }
        ...
        return Object(external_this_wp_element_['createElement'])(
          external_this_wp_blockEditor_['URLPopover'],
      ...
      var inline_InlineLinkUI =
        ...
        (function(_Component) {
          ...
          function InlineLinkUI() {
            ...
            _this = Object(possibleConstructorReturn['a' /* default */])(
              this,
              Object(getPrototypeOf['a' /* default */])(InlineLinkUI).apply(
                this,
                arguments,
              ),
            );
            _this.editLink = _this.editLink.bind(
              Object(assertThisInitialized['a' /* default */])(
                Object(assertThisInitialized['a' /* default */])(_this),
              ),
            );
            _this.submitLink = _this.submitLink.bind(
              Object(assertThisInitialized['a' /* default */])(
                Object(assertThisInitialized['a' /* default */])(_this),
              ),
            );
            ...
            _this.onChangeInputValue = _this.onChangeInputValue.bind(
              Object(assertThisInitialized['a' /* default */])(
                Object(assertThisInitialized['a' /* default */])(_this),
              ),
            );
            _this.setLinkTarget = _this.setLinkTarget.bind(
              Object(assertThisInitialized['a' /* default */])(
                Object(assertThisInitialized['a' /* default */])(_this),
              ),
            );
            _this.onClickOutside = _this.onClickOutside.bind(
              Object(assertThisInitialized['a' /* default */])(
                Object(assertThisInitialized['a' /* default */])(_this),
              ),
            );
            _this.resetState = _this.resetState.bind(
              Object(assertThisInitialized['a' /* default */])(
                Object(assertThisInitialized['a' /* default */])(_this),
              ),
            );
            _this.autocompleteRef = Object(
              external_this_wp_element_['createRef'],
            )();
            _this.state = {
            ...
            [
              ...
              },
              {
                ...
                value: function setLinkTarget(opensInNewWindow) {
                  var _this$props = this.props,
                    ...
                    url =
                      _this$props$activeAtt === void 0
                        ? ''
                        : _this$props$activeAtt,
                    value = _this$props.value,
                    onChange = _this$props.onChange;
                  this.setState({
                  ...
                  if (!isShowingInput(this.props, this.state)) {
                    var selectedText = Object(
                      external_this_wp_richText_['getTextContent'],
                    )(Object(external_this_wp_richText_['slice'])(value));
                    onChange(
                      Object(external_this_wp_richText_['applyFormat'])(
                        value,
                        createLinkFormat({
                          url: url,
                          opensInNewWindow: opensInNewWindow,
              ...
              },
              {
                ...
                value: function submitLink(event) {
                  ...
                  var url = Object(external_this_wp_url_['prependHTTP'])(
                    inputValue,
                  );
                  var selectedText = Object(
                    external_this_wp_richText_['getTextContent'],
                  ...
                  if (
                    Object(external_this_wp_richText_['isCollapsed'])(value) &&
                    !isActive
                  ) {
                    var toInsert = Object(
                      external_this_wp_richText_['applyFormat'],
                    )(
                    ...
                    onChange(
                      Object(external_this_wp_richText_['insert'])(
                        value,
                        toInsert,
                      ),
                    );
                  ...
                  if (!isValidHref(url)) {
                    ...
                    speak(
                      Object(external_this_wp_i18n_['__'])('Link edited.'),
                      'assertive',
                    );
                  } else {
                    speak(
                      Object(external_this_wp_i18n_['__'])('Link inserted.'),
                      'assertive',
                    );
                  }
                },
      ...
      /* harmony default export */ var inline = Object(
        ...
        edit: Object(external_this_wp_components_['withSpokenMessages'])(
          ...
          (function(_Component) {
            ...
            function LinkEdit() {
              ...
              _this = Object(possibleConstructorReturn['a' /* default */])(
                this,
                Object(getPrototypeOf['a' /* default */])(LinkEdit).apply(
                  this,
                  arguments,
                ),
              );
              _this.addLink = _this.addLink.bind(
                Object(assertThisInitialized['a' /* default */])(
                  Object(assertThisInitialized['a' /* default */])(_this),
                ),
              );
              _this.stopAddingLink = _this.stopAddingLink.bind(
                Object(assertThisInitialized['a' /* default */])(
                  Object(assertThisInitialized['a' /* default */])(_this),
                ),
              );
              _this.onRemoveFormat = _this.onRemoveFormat.bind(
                Object(assertThisInitialized['a' /* default */])(
                  Object(assertThisInitialized['a' /* default */])(_this),
                ),
              );
            ...
            Object(createClass['a' /* default */])(LinkEdit, [
              {
                ...
                value: function addLink() {
                  ...
                  if (text && Object(external_this_wp_url_['isURL'])(text)) {
                    onChange(
                      Object(external_this_wp_richText_['applyFormat'])(value, {
                        type: link_name,
                        attributes: {
                          url: text,
                        },
              ...
              },
              {
                ...
                value: function onRemoveFormat() {
                  var _this$props2 = this.props,
                    ...
                    speak = _this$props2.speak;
                  onChange(
                    Object(external_this_wp_richText_['removeFormat'])(
                      value,
                      link_name,
                    ),
                  );
                  speak(
                    Object(external_this_wp_i18n_['__'])('Link removed.'),
                    'assertive',
                  );
                },
              },
      ...
      /* harmony default export */ var default_formats = [
        bold,
        code,
        image_image,
        italic,
      ...
      default_formats.forEach(function(_ref) {
        var name = _ref.name,
          settings = Object(objectWithoutProperties['a' /* default */])(_ref, [
            'name',
          ]);
