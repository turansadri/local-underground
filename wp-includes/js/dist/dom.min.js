(this.wp = this.wp || {}),
  (this.wp.dom = (function(e) {
    ...
    379: function(e, t, n) {
      ...
      var o = {};
      n.r(o),
        n.d(o, 'isTabbableIndex', function() {
          return f;
        }),
        n.d(o, 'find', function() {
          return v;
      ...
      function c(e) {
        ...
        return Object(i.a)(t).filter(function(e) {
          return (
            !!u(e) &&
            ('AREA' !== e.nodeName ||
              (function(e) {
      ...
      var m = window.getComputedStyle,
        ...
        b = h.TEXT_NODE,
        C = h.ELEMENT_NODE,
        N = h.DOCUMENT_POSITION_PRECEDING,
        E = h.DOCUMENT_POSITION_FOLLOWING;
      function y(e, t, n) {
        if (Object(l.includes)(['INPUT', 'TEXTAREA'], e.tagName))
          return (
            e.selectionStart === e.selectionEnd &&
            (t ? 0 === e.selectionStart : e.value.length === e.selectionStart)
          );
        if (!e.isContentEditable) return !0;
        var r = window.getSelection();
        if (!r.rangeCount) return !1;
        var o = r.getRangeAt(0).cloneRange(),
          i = (function(e) {
            var t = e.anchorNode,
              n = e.focusNode,
              r = e.anchorOffset,
              o = e.focusOffset,
              i = t.compareDocumentPosition(n);
            return !(i & N) && (!!(i & E) || 0 !== i || r <= o);
          })(r),
          a = r.isCollapsed;
        a || o.collapse(!i);
        var u = S(o);
        ...
        var c = window.getComputedStyle(e),
          d = parseInt(c.lineHeight, 10) || 0;
        if (!a && u.height > d && i === t) return !1;
        var f = parseInt(c['padding'.concat(t ? 'Top' : 'Bottom')], 10) || 0,
          s = (3 * parseInt(d, 10)) / 4,
          g = e.getBoundingClientRect();
        if (!(t ? g.top + f > u.top - s : g.bottom - f < u.bottom + s))
          return !1;
        if (n) return !0;
        var p = 'rtl' === c.direction ? !t : t,
          v = p ? g.left + 1 : g.right - 1,
          m = t ? g.top + s : g.bottom - s,
          h = A(document, v, m, e);
        if (!h) return !1;
        var b = p ? 'left' : 'right',
          C = S(h);
        return Math.round(C[b]) === Math.round(u[b]);
      }
      function w(e, t) {
        return y(e, t);
      }
      ...
      function A(e, t, n, r) {
        ...
        return (r.style.zIndex = null), o;
      }
      function P(e, t, n) {
        var r =
          !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3];
        if (e)
          if (n && e.isContentEditable) {
            var o = n.height / 2,
              i = e.getBoundingClientRect(),
              a = n.left,
              u = t ? i.bottom - o : i.top + o,
              c = A(document, a, u, e);
            if (!c || !e.contains(c.startContainer))
              return !r ||
                (c && c.startContainer && c.startContainer.contains(e))
                ? void T(e, t)
                : (e.scrollIntoView(t), void P(e, t, n, !1));
            if (c.startContainer.nodeType === b) {
              var l = c.startContainer.parentNode,
                d = l.getBoundingClientRect(),
                f = t ? 'bottom' : 'top',
                s =
                  parseInt(m(l).getPropertyValue('padding-'.concat(f)), 10) ||
                  0,
                g = t ? d.bottom - s - o : d.top + s + o;
              u !== g && (c = A(document, a, g, e));
            }
      ...
      function I(e) {
        try {
          var t = e.nodeName,
            ...
            r = e.contentEditable;
          return (
            ('INPUT' === t && null !== n) || 'TEXTAREA' === t || 'true' === r
          );
        } catch (e) {
          return !1;
        }
      ...
      function j(e) {
        if (Object(l.includes)(['INPUT', 'TEXTAREA'], e.nodeName))
          return 0 === e.selectionStart && e.value.length === e.selectionEnd;
        if (!e.isContentEditable) return !0;
        var t = window.getSelection(),
          n = t.rangeCount ? t.getRangeAt(0) : null;
        if (!n) return !0;
        var r = n.startContainer,
          ...
          i = n.startOffset,
          a = n.endOffset;
        if (r === e && o === e && 0 === i && a === e.childNodes.length)
          return !0;
        var u = e.lastChild,
          c = u.nodeType === b ? u.data.length : u.childNodes.length;
        return r === e.firstChild && o === e.lastChild && 0 === i && a === c;
      }
      function _(e) {
        if (e) {
      ...
      function B(e) {
        for (var t; (t = e.parentNode) && t.nodeType !== C; );
        return t ? ('static' !== m(t).position ? t : t.offsetParent) : null;
      }
      function M(e, t) {
        F(t, e.parentNode), D(e);
      }
      function D(e) {
