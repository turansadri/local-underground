...
(function() {
  ...
  edButtons[100] = new qt.TagButton(
    'li',
    'li',
    '\t<li>',
    '</li>\n',
  ...
  edButtons[110] = new qt.TagButton(
    'code',
    'code',
    '<code>',
    '</code>',
    ...
    '',
    '',
    { ariaLabel: quicktagsL10n.code, ariaLabelClose: quicktagsL10n.codeClose },
  );
  edButtons[120] = new qt.TagButton(
    'more',
    'more',
    '<!--more-->\n\n',
    '',
