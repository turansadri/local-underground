!(function(_) {
  ...
  var e,
    ...
    V = function(e, t, n, i, r, o) {
      return (
        (o = F({ x: t, y: n, w: o.w, h: o.h })),
        e &&
          (o = e({ elementRect: F(i), contentAreaRect: F(r), panelRect: o })),
        o
      );
    },
    Y = function(x) {
        ...
        n = function(e, t) {
          ...
          if (!x.removed) {
            ...
            if (
              ...
              (o.x += b.x),
              (o.y += b.y),
              'inline' !== I.getStyle(e.element, 'display', !0))
            ) {
            ...
            x.inline || (o.w = x.getDoc().documentElement.offsetWidth),
              ...
              (r = E.clamp(r, o)),
              n
                ? ((a = E.relativePosition(i, r, n)),
                  U(s, V(u, a.x, a.y, r, o, i)))
                : ((o.h += i.h),
                  (r = E.intersect(o, r))
                    ? (n = E.findBestRelativePosition(i, r, o, [
                        'bc-tc',
                        'bl-tl',
                        'br-tr',
                      ]))
        ...
        a ||
          w.each(n, function(e, t) {
            ...
            e.context !== i ||
              ...
              e.prependToContext ? s.unshift(ie(t, e)) : s.push(ie(t, e)),
              'after' === e.separator &&
                s.push({ name: '|', item: { text: '|' } }));
          }),
        (r.menu = G(
    ...
    ue = function(e, t, n) {
      ...
      (i = e.getContainer()),
        ...
        null !== t &&
          ...
          ae.setStyle(i, 'width', t + (o.width - s.width)),
          ae.setStyle(r, 'width', t)),
    ...
    ge = function(e) {
      return (
        !((fe.ie && !(11 <= fe.ie)) || !e.sidebars) && 0 < e.sidebars.length
      );
    },
    pe = function(n) {
      return {
    ...
    xe = function(t, e, n) {
      ...
      if (
        (!1 === g(t) && n.skinUiCss
          ? be.styleSheetLoader.load(n.skinUiCss, ve(t))
          : ve(t)(),
        (i = e.panel = b.create({
          type: 'panel',
          role: 'application',
          ...
          items: [
            {
              ...
              items: [
                !1 === d(t)
                  ? null
                  : { type: 'menubar', border: '0 0 1 0', items: se(t) },
                z(t, f(t)),
              ],
            },
            ge(t)
        ...
        'none' !== p(t) &&
          (r = {
            ...
            onResize: function(e) {
              'both' === p(t)
                ? ce(t, o.width + e.deltaX, o.height + e.deltaY)
                : ce(t, null, o.height + e.deltaY);
            },
          }),
      ...
      init: function(e) {
        ...
        function a(e, t) {
          ...
          do {
            if (
              (Ie.exec(''),
              (i = Ie.exec(e)) && ((e = i[3]), o.push(i[1]), i[2]))
            ) {
              n = i[3];
              break;
            }
    ...
    Ke = Me.extend({
      ...
      set: function(t, n) {
        var i,
          ...
          o = this.data[t];
        if (
          (n instanceof qe && (n = n.create(this, t)), 'object' == typeof t)
        ) {
          ...
          Ze[t._id] || (Ze[t._id] = t),
            Je ||
              ...
              u.requestAnimationFrame(function() {
                var e, t;
                for (e in ((Je = !1), Ze))
                  (t = Ze[e]).state.get('rendered') && t.reflow();
                Ze = {};
              }, _.document.body));
        }
      },
    ...
    it = {
      ...
      postRender: function() {
        var e,
          ...
          o = this,
          s = o.settings;
        for (i in ((o.$el = we(o.getEl())), o.state.set('rendered', !0), s))
    ...
    ct = st.extend({
            ...
            e.parent(i),
              e.state.get('rendered') ||
                ...
                t <= n.childNodes.length - 1
                  ? we(n.childNodes[t]).before(e.renderHtml())
                  : we(n).append(e.renderHtml()),
                e.postRender(),
                Qe.add(e));
          }),
      ...
      reflow: function() {
        ...
        if ((Qe.remove(this), this.visible())) {
          for (
            st.repaintControls = [],
              st.repaintControls.map = {},
              this.recalc(),
              e = st.repaintControls.length;
            e--;

          )
            st.repaintControls[e].repaint();
          ...
          function t(e, t, n, i, r, o) {
            ...
            if ((a = p.getEl('scroll' + e))) {
              if (
                ((f = t.toLowerCase()),
                (h = n.toLowerCase()),
                we(p.getEl('absend')).css(f, p.layoutRect()[i] - 1),
                !r)
              )
                return void we(a).css('display', 'none');
  ...
  function Ct(r) {
    ...
    function t(e, t) {
      for (var n, i = 0; i < xt.length; i++)
        if (xt[i] !== r)
          for (n = xt[i].parent(); n && (n = n.parent()); )
            n === r &&
              xt[i]
                .fixed(e)
                .moveBy(0, t)
  ...
  function Et(e, t) {
    ...
    if (wt.length)
      for (n = 0; n < wt.length; n++)
        wt[n].modal && (r++, (i = wt[n])),
          (wt[n].getEl().style.zIndex = r),
          (wt[n].zIndex = r),
          r++;
    var o = we('#' + t.classPrefix + 'modal-block', t.getContainerElm())[0];
    i
      ? we(o).css('z-index', i.zIndex - 1)
      : o && (o.parentNode.removeChild(o), (pt = !1)),
      (kt.currentZIndex = r);
  }
  var kt = bt.extend({
    Mixins: [Te, yt],
      ...
      i._super(e),
            ...
            if (!gt) {
              ...
              (gt = function() {
                (_.document.all &&
                  t === e.clientWidth &&
                  n === e.clientHeight) ||
                  ((t = e.clientWidth), (n = e.clientHeight), kt.hideAll());
              }),
        ...
        i.on('postrender show', function(e) {
          if (e.control === i) {
            ...
            i.modal &&
              !pt &&
              ((t = we('#' + n + 'modal-block', i.getContainerElm()))[0] ||
                (t = we(
                  '<div id="' +
                    n +
                    'modal-block" class="' +
  ...
  var St = function(s, n, e) {
        ...
        a
          ...
          : ((a = n.panel = b.create({
              ...
              items: [
                !1 === d(s)
                  ? null
                  : { type: 'menubar', border: '0 0 1 0', items: se(s) },
                z(s, f(s)),
              ],
            })),
    ...
    return (
      ...
      s.on('focus', function() {
        !1 === g(s) && e.skinUiCss
          ? l.styleSheetLoader.load(e.skinUiCss, c, c)
          : c();
      }),
      s.on('blur hide', u),
      ...
      !1 === g(s) && e.skinUiCss
        ? l.styleSheetLoader.load(e.skinUiCss, ve(s))
        : ve(s)(),
      {}
    );
  };
  ...
  var Mt = function(e, t) {
    ...
    Nt = function(e, t, n) {
      ...
      return (
        ...
        Mt(e, t),
        e.getParam('inline', !1, 'boolean') ? St(e, t, n) : xe(e, t, n)
      );
    },
    Pt = st.extend({
      Mixins: [Te],
    ...
    Wt = st.extend({
      ...
      tooltip: function() {
        return (
          this._tooltip ||
            ((this._tooltip = new Pt({ type: 'tooltip' })),
  ...
  function Ft(e, t) {
    (function() {
      ...
      !1 === t &&
      we([_.document.documentElement, _.document.body]).removeClass(
        e + 'fullscreen',
      );
  }
  var Ut = kt.extend({
    ...
    init: function(e) {
      ...
      n._super(e),
        ...
        n.on('click', function(e) {
          ...
          (Re.hasClass(e.target, t) || Re.hasClass(e.target.parentNode, t)) &&
            n.close();
        }),
  ...
  !(function() {
    if (!fe.desktop) {
      ...
      u.setInterval(function() {
        ...
        (n.w === e && n.h === t) ||
          ((n = { w: e, h: t }), we(_.window).trigger('resize'));
      }, 100);
    }
    we(_.window).on('resize', function() {
      var e,
  ...
  var Vt,
        ...
        msgBox: function(e) {
          ...
          switch (e.buttons) {
            ...
            case qt.YES_NO_CANCEL:
              (t = [n('Yes', 1, !0), n('No', 0)]),
                e.buttons === qt.YES_NO_CANCEL && t.push(n('Cancel', -1));
              break;
            default:
              t = [n('Ok', !0, !0)];
          }
    ...
    tn = Wt.extend({
      ...
      repaint: function() {
        ...
        n.statusLevel() &&
          'none' !== n.statusLevel() &&
          (s =
            parseInt(Re.getRuntimeStyle(a, 'padding-right'), 10) -
            parseInt(Re.getRuntimeStyle(a, 'padding-left'), 10)),
          (e = r ? o.w - Re.getSize(r).width - 10 : o.w - 10);
        var l = _.document;
        return (
          l.all &&
            (!l.documentMode || l.documentMode <= 8) &&
            (t = n.layoutRect().h - 2 + 'px'),
          we(a).css({ width: e - s, lineHeight: t }),
          n._super(),
          n
        );
      },
          ...
          r.on('keydown', function(e) {
            ...
            'INPUT' === e.target.nodeName &&
              (t === en.DOWN
                ...
                : t === en.UP && (e.preventDefault(), n(-1, r.menu)));
          }),
          r._super()
        );
      },
        ...
        return (
          t.on('click', function(e) {
            (e.aria && 'down' === e.aria.key) ||
              e.control !== t ||
              on.getParent(e.target, '.' + t.classPrefix + 'open') ||
    ...
    ln = Wt.extend({
      ...
      postRender: function() {
        ...
        function c(e, t) {
          var n = (360 - e.h) / 360;
          Re.css(r, { top: 100 * n + '%' }),
            t || Re.css(s, { left: e.s + '%', top: 100 - e.v + '%' }),
            (o.style.background = an({ s: 100, v: 100, h: e.h }).toHex()),
    ...
    bn = (_.Node.ATTRIBUTE_NODE,
    _.Node.CDATA_SECTION_NODE,
    _.Node.COMMENT_NODE,
    _.Node.DOCUMENT_NODE),
    yn = (_.Node.DOCUMENT_TYPE_NODE,
    ...
    kn = function(e) {
      ...
      return {
        ...
        version: e.version,
        isEdge: En('Edge', t),
        isChrome: En('Chrome', t),
        isIE: En('IE', t),
        isOpera: En('Opera', t),
        isFirefox: En(Cn, t),
        isSafari: En('Safari', t),
      };
    },
    Hn = {
      unknown: function() {
    ...
    jn = function(e) {
      return (
        (e.nodeType !== qn && e.nodeType !== Xn) || 0 === e.childElementCount
      );
    },
    Jn = ($n().browser.isIE(),
    (function() {
    ...
    ti = function(e) {
      return e.id
        ...
        : ((t = 'h'),
          (n = new Date().getTime()),
          t + '_' + Math.floor(1e9 * Math.random()) + ++gn + String(n));
      var t, n;
    },
    ni = function(e) {
    ...
    si = function(e) {
      ...
      return Qn(
        ...
        ei(e),
        '#' + n,
        ii((t = e)) ? parseInt(t.nodeName.substr(1), 10) : 0,
        function() {
          e.id = n;
        },
      );
      ...
      return !1 === t.typeahead_urls
        ...
        ? ((n = [
            ...
            vi(
              e,
              ((a = f('anchor')),
              (l = mi(t, 'anchor_top', '#top')),
              (u = mi(t, 'anchor_bottom', '#bottom')),
              null !== l && a.unshift(hi('<top>', l)),
              null !== u && a.push(hi('<bottom>', u)),
              a),
            ),
          ]),
          (o = function(e, t) {
      ...
      /^https?/.test(e) &&
        (o
          ? ((n = o),
            (i = e),
            (r = j(n, i)),
            -1 === r ? D.none() : D.some(r)).isNone() &&
            (di[t] = o.slice(0, 5).concat(e))
          : (di[t] = [e]));
    },
    vi = function(e, t) {
      var n = e.toLowerCase(),
            ...
            b = d / c,
              ...
              0 === c &&
                ('end' === l
                  ? (x = d + o[k])
                  : 'center' === l
                  ? (x = Math.round(r[H] / 2 - (r[H] - d) / 2) + o[k]) < 0 &&
                    (x = o[k])
                  : 'justify' === l &&
                    ((x = o[k]), (u = Math.floor(d / (i.length - 1))))),
              y[M] = o[D],
              t = 0,
              n = i.length;
            t < n;
    ...
    Ri = function(e, t) {
      return (
        ...
        jn(r) ? D.none() : D.from(r.querySelector(n)).map(vn.fromDom)
      );
      var n, i, r;
    },
    Ci = function(e, t) {
        ...
        a.state.set('value', null),
          l.on('init nodeChange', function(e) {
            var t,
              ...
              w.each(t, function(e) {
                i ||
                  Si(e.value).toLowerCase() !== Si(r).toLowerCase() ||
                  (i = e.value);
              }),
              i);
    ...
    Bi = function(n, e) {
      ...
      return (
        e.items().each(function(e) {
          e.menu && e.visible(0 < Bi(n, e.menu)),
            !e.menu && e.settings.menu && e.visible(0 < Ai(n, e.settings.menu));
      ...
      var i,
        ...
        }),
        {
          ...
          itemDefaults: {
            ...
            onclick: function() {
              this.settings.format && Ci(i, this.settings.format)(),
    ...
    Ji = function(e) {
      ...
      (t = e).addMenuItem('undo', {
        ...
        t.addMenuItem('redo', {
          ...
          icon: 'redo',
          shortcut: 'Meta+Y',
          onPostRender: ji(t, 'redo'),
          cmd: 'redo',
        }),
        (n = e).addButton('undo', {
          tooltip: 'Undo',
          onPostRender: ji(n, 'undo'),
          cmd: 'undo',
        }),
        n.addButton('redo', {
          tooltip: 'Redo',
          onPostRender: ji(n, 'redo'),
          cmd: 'redo',
        });
    },
    Gi = function(e) {
      ...
      setup: function(e) {
        ...
        e.rtl && (st.rtl = !0),
          ...
          (t = e).settings.ui_container &&
            (fe.container = Ri(
              vn.fromDom(_.document.body),
              t.settings.ui_container,
            ).fold(H(null), function(e) {
              return e.dom();
            })),
          (Wt.tooltips = !fe.iOS),
    ...
    or = kt.extend({
      ...
      init: function(e) {
        ...
        this._super(e),
          ...
          e.animate && 11 !== fe.ie && this.classes.add('animate');
      },
      repaint: function() {
        return (
  ...
  function mr(e, t) {
    ...
    'v' === e.settings.orientation
      ...
      (s = e.getEl('handle')),
      (o =
        ((e.layoutRect()[n] || 100) - Re.getSize(s)[i]) *
          ...
          (m._dragHelper = new ft(m._id, {
            ...
            start: function(e) {
              (u = e[n]),
                ...
                (d = (m.layoutRect()[o] || 100) - Re.getSize(l)[r]),
    ...
    vr = rr.extend({
      ...
      repaint: function() {
        ...
        return (
          ...
          (e = n.firstChild),
          (t = n.lastChild),
          we(e).css({ width: i.w - Re.getSize(t).width, height: i.h - 2 }),
          we(t).css({ height: i.h - 2 }),
          this
        );
      },
      activeMenu: function(e) {
    ...
    yr = bt.extend({
      ...
      activateTab: function(n) {
        ...
        this.activeTabId &&
          ...
          we(e).removeClass(this.classPrefix + 'active'),
