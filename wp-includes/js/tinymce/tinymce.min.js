...
!(function(H) {
  ...
  var e,
    ...
    oe = 'undefined' != typeof H.window ? H.window : Function('return this;')(),
    ie = function(e, t) {
      return (function(e, t) {
        for (
          var n = t !== undefined && null !== t ? t : oe, r = 0;
    ...
    ue = function() {
      return ae.getOrDie('URL');
    },
    se = {
      createObjectURL: function(e) {
        return ue().createObjectURL(e);
      },
      revokeObjectURL: function(e) {
        ue().revokeObjectURL(e);
      },
    },
    ce = H.navigator,
    le = ce.userAgent,
  ...
  (g = /Android/.test(le)),
    (u =
      (u =
        !(a = /WebKit/.test(le)) &&
        /MSIE/gi.test(le) &&
        /Explorer/gi.test(ce.appName)) && /MSIE (\w+)\./.exec(le)[1]),
    (s =
      -1 !== le.indexOf('Trident/') &&
      (-1 !== le.indexOf('rv:') || -1 !== ce.appName.indexOf('Netscape')) &&
      11),
    (c = -1 !== le.indexOf('Edge/') && !u && !s && 12),
    (u = u || s || c),
    (l = !a && !s && /Gecko/.test(le)),
    (f = -1 !== le.indexOf('Mac')),
    (m = /(iPad|iPhone)/.test(le)),
    (p =
      'FormData' in H.window &&
      'FileReader' in H.window &&
      'URL' in H.window &&
      !!se.createObjectURL),
    (h = fe('only screen and (max-device-width: 480px)') && (g || m)),
    (v = fe('only screen and (min-width: 800px)') && (g || m)),
    (b = -1 !== le.indexOf('Windows Phone')),
    c && (a = !1);
  var de,
    me = {
      opera: !1,
      ...
      android: g,
      contentEditable:
        !m || p || 534 <= parseInt(le.match(/AppleWebKit\/(\d*)/)[1], 10),
      transparentSrc:
    ...
    Se = function(e, t) {
      ...
      return (
        ...
        !(o.stopImmediatePropagation = function() {
          ...
          ((r = o).isDefaultPrevented === we || r.isDefaultPrevented === xe) &&
          ((o.isDefaultPrevented = xe),
          (o.isPropagationStopped = xe),
          (o.isImmediatePropagationStopped = xe)),
            ...
            if (((s = y[r]), t)) {
              for (i = (t = t.split(' ')).length; i--; )
                if ((o = s[(u = t[i])])) {
                  ...
                  (n && 0 !== o.length) ||
                    (delete s[u],
                    Ee(e, o.fakeName || u, o.nativeHandler, o.capture));
                }
            } else {
              for (u in s)
                (o = s[u]), Ee(e, o.fakeName || u, o.nativeHandler, o.capture);
              s = {};
            }
            for (u in s) return b;
            delete y[r];
  ...
  (Te.Event = new Te()), Te.Event.bind(H.window, 'ready', function() {});
  var Ae,
    Re,
    _e,
    De,
    ...
    mt = new RegExp('^' + st + '*,' + st + '*'),
    gt = new RegExp('^' + st + '*([>+~]|' + st + ')' + st + '*'),
    pt = new RegExp('=' + st + '*([^\\]\'"]*?)' + st + '*\\]', 'g'),
    ht = new RegExp(ft),
    vt = new RegExp('^' + ct + '$'),
    bt = {
      ID: new RegExp('^#(' + ct + ')'),
  ...
  try {
    it.apply((nt = at.call(Ke.childNodes)), Ke.childNodes),
      nt[Ke.childNodes.length].nodeType;
  } catch (jN) {
    it = {
      apply: nt.length
        ? function(e, t) {
            ot.apply(e, at.call(t));
          }
        : function(e, t) {
  ...
  var Tt = function(e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : Ke) !== Ue && ze(t),
      (n = n || []),
      !e || 'string' != typeof e)
    )
      return n;
    if (1 !== (u = (t = t || Ue).nodeType) && 9 !== u) return [];
    if (He && !r) {
      if ((o = wt.exec(e)))
        if ((a = o[1])) {
          if (9 === u) {
          ...
          if (o[2]) return it.apply(n, t.getElementsByTagName(e)), n;
          if ((a = o[3]) && Re.getElementsByClassName)
            return it.apply(n, t.getElementsByClassName(a)), n;
        }
      if (Re.qsa && (!je || !je.test(e))) {
        if (
          ((f = l = We),
          (d = t),
          (m = 9 === u && e),
          ...
          for (
            ...
            c[s] = f + It(c[s]);
          (d = (Nt.test(e) && Pt(t.parentNode)) || t), (m = c.join(','));
        }
        if (m)
          try {
            return it.apply(n, d.querySelectorAll(m)), n;
          } catch (g) {
          } finally {
    ...
    return Le(e.replace(dt, '$1'), t, n, r);
  };
  function At() {
    var r = [];
    return function e(t, n) {
      return (
        r.push(t + ' ') > _e.cacheLength && delete e[r.shift()],
        (e[t + ' '] = n)
      );
    };
  }
  ...
  function Pt(e) {
    return e && typeof e.getElementsByTagName !== et && e;
  }
  for (Ae in ((Re = Tt.support = {}),
  (Be = Tt.isXML = function(e) {
    var t = e && (e.ownerDocument || e).documentElement;
    return !!t && 'HTML' !== t.nodeName;
  }),
  (ze = Tt.setDocument = function(e) {
    var t,
      s = e ? e.ownerDocument || e : Ke,
      n = s.defaultView;
    return s !== Ue && 9 === s.nodeType && s.documentElement
      ? ((Ve = (Ue = s).documentElement),
        (He = !Be(s)),
        n &&
          n !==
            (function(e) {
        ...
        (Re.attributes = !0),
        (Re.getElementsByTagName = !0),
        (Re.getElementsByClassName = xt.test(s.getElementsByClassName)),
        (Re.getById = !0),
        (_e.find.ID = function(e, t) {
          if (typeof t.getElementById !== et && He) {
        ...
        (_e.find.TAG = Re.getElementsByTagName
          ? function(e, t) {
        ...
        (qe = []),
        (je = []),
        (Re.disconnectedMatch = !0),
        (je = je.length && new RegExp(je.join('|'))),
        (qe = qe.length && new RegExp(qe.join('|'))),
        (t = xt.test(Ve.compareDocumentPosition)),
        ($e =
          t || xt.test(Ve.contains)
            ? function(e, t) {
                ...
                (1 &
                  (n =
                    (e.ownerDocument || e) === (t.ownerDocument || t)
                      ...
                      : 1) ||
                (!Re.sortDetached && t.compareDocumentPosition(e) === n)
                  ? e === s || (e.ownerDocument === Ke && $e(Ke, e))
                    ? -1
                    : t === s || (t.ownerDocument === Ke && $e(Ke, t))
                    ? 1
                    : Me
                    ? ut.call(Me, e) - ut.call(Me, t)
                    : 0
                  : 4 & n
                  ? -1
                  : 1)
  ...
  (Tt.matchesSelector = function(e, t) {
    if (
      ((e.ownerDocument || e) !== Ue && ze(e),
      (t = t.replace(pt, "='$1']")),
      Re.matchesSelector && He && (!qe || !qe.test(t)) && (!je || !je.test(t)))
    )
      try {
        var n = (void 0).call(e, t);
        if (
          n ||
          Re.disconnectedMatch ||
          (e.document && 11 !== e.document.nodeType)
        )
          return n;
      } catch (jN) {}
    return 0 < Tt(t, Ue, null, [e]).length;
  }),
  (Tt.contains = function(e, t) {
    return (e.ownerDocument || e) !== Ue && ze(e), $e(e, t);
  }),
  (Tt.attr = function(e, t) {
    (e.ownerDocument || e) !== Ue && ze(e);
    var n = _e.attrHandle[t.toLowerCase()],
      r =
        n && tt.call(_e.attrHandle, t.toLowerCase()) ? n(e, t, !He) : undefined;
    return r !== undefined
      ? r
      : Re.attributes || !He
      ? e.getAttribute(t)
  ...
  (Tt.uniqueSort = function(e) {
    var t,
      ...
      o = 0;
    if (
      ((Fe = !Re.detectDuplicates),
      (Me = !Re.sortStable && e.slice(0)),
      e.sort(Ze),
      Fe)
    ) {
  ...
  ((_e = Tt.selectors = {
    ...
    preFilter: {
      ATTR: function(e) {
        return (
          (e[1] = e[1].replace(St, kt)),
          (e[3] = (e[3] || e[4] || e[5] || '').replace(St, kt)),
          '~=' === e[2] && (e[3] = ' ' + e[3] + ' '),
          e.slice(0, 4)
        );
      },
            ...
            Ge(e, function(e) {
              return t.test(
                ('string' == typeof e.className && e.className) ||
                  (typeof e.getAttribute !== et && e.getAttribute('class')) ||
                  '',
              );
            }))
        );
        ...
        return 1 === g && 0 === p
          ...
          : function(e, t, n) {
              ...
              if (l) {
                ...
                } else if (d && (r = (e[We] || (e[We] = {}))[m]) && r[0] === Xe)
                  a = r[1];
                else
                  for (
                    ;
    ...
    pseudos: {
      ...
      lang: Rt(function(n) {
        return (
          vt.test(n || '') || Tt.error('unsupported lang: ' + n),
          (n = n.replace(St, kt).toLowerCase()),
          function(e) {
            var t;
            do {
              if (
  ...
  { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }))
    _e.pseudos[Ae] = Dt(Ae);
  for (Ae in { submit: !0, reset: !0 }) _e.pseudos[Ae] = Bt(Ae);
  function Lt() {}
  function It(e) {
    ...
    return (
      ...
      Rt(function(e, t, n, r) {
        var o,
          ...
          f = !m || (!e && g) ? l : zt(l, u, m, n, r),
          d = p ? (v || (e ? m : c || h) ? [] : t) : f;
        if ((p && p(f, d, n, r), h))
          for (o = zt(d, s), h(o, [], n, r), i = o.length; i--; )
            (a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
        if (e) {
          if (v || m) {
            if (v) {
            ...
            for (i = d.length; i--; )
              (a = d[i]) &&
                -1 < (o = v ? ut.call(e, a) : u[i]) &&
                (e[o] = !(t[o] = a));
          }
        } else (d = zt(d === t ? d.splice(c, d.length) : d)), v ? v(null, t, d, r) : it.apply(t, d);
      })
    );
  }
  function Vt(e) {
    for (
      ...
      if ((t = _e.relative[e[u].type])) l = [Mt(Ft(l), t)];
      else {
        if ((t = _e.filter[e[u].type].apply(null, e[u].matches))[We]) {
  ...
  (Lt.prototype = _e.filters = _e.pseudos),
    (_e.setFilters = new Lt()),
    (Oe = Tt.tokenize = function(e, t) {
      var n,
        r,
        o,
        i,
      ...
      return t ? a.length : a ? Tt.error(e) : Je(e, u).slice(0);
    }),
    (Pe = Tt.compile = function(e, t) {
      var n,
        h,
        v,
        b,
        ...
        (a = Qe(
          ...
          (r = function(e, t, n, r, o) {
            ...
            if (((s += c), b && c !== s)) {
              ...
              if (e) {
                if (0 < s) for (; c--; ) l[c] || f[c] || (f[c] = rt.call(r));
                f = zt(f);
              }
              it.apply(r, f),
                o && !e && 0 < f.length && 1 < s + v.length && Tt.uniqueSort(r);
            }
            return o && ((Xe = g), (Ie = d)), l;
          }),
          b ? Rt(r) : r),
        )).selector = e;
      }
    ...
    (Le = Tt.select = function(e, t, n, r) {
      ...
      if (((n = n || []), 1 === l.length)) {
        if (
          ...
          if (!(t = (_e.find.ID(a.matches[0].replace(St, kt), t) || [])[0]))
            return n;
          c && (t = t.parentNode), (e = e.slice(i.shift().value.length));
        }
        for (
          o = bt.needsContext.test(e) ? 0 : i.length;
          ...
          if (
            (s = _e.find[u]) &&
            (r = s(
              a.matches[0].replace(St, kt),
              (Nt.test(i[0].type) && Pt(t.parentNode)) || t,
            ))
          ) {
            if ((i.splice(o, 1), !(e = r.length && It(i))))
              return it.apply(n, r), n;
            break;
          }
      }
      return (
        (c || Pe(e, l))(r, t, !He, n, (Nt.test(e) && Pt(t.parentNode)) || t), n
      );
    }),
    (Re.sortStable =
      We.split('')
  ...
  var Ht = Array.isArray,
    ...
    $t = {
      ...
      toArray: function(e) {
        var t,
          n,
          r = e;
        if (!Ht(e)) for (r = [], t = 0, n = e.length; t < n; t++) r[t] = e[t];
        return r;
      },
      each: jt,
      map: function(n, r) {
    ...
    Wt = /^\s*|\s*$/g,
    Kt = function(e) {
      return null === e || e === undefined ? '' : ('' + e).replace(Wt, '');
    },
    Xt = function(e, t) {
      return t
        ? !('array' !== t || !$t.isArray(e)) || typeof e === t
        : e !== undefined;
    },
    Yt = function(e, n, r, o) {
      (o = o || this),
    ...
    Gt = {
      ...
      explode: function(e, t) {
        return !e || Xt(e, 'array') ? e : $t.map(e.split(t || ','), Kt);
      },
    ...
    Jt = H.document,
    Qt = Array.prototype.push,
    Zt = Array.prototype.slice,
    en = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/,
    tn = Te.Event,
    nn = Gt.makeMap('children,contents,next,prev'),
    rn = function(e) {
      return void 0 !== e;
    },
    on = function(e) {
    ...
    un = function(e, t, n, r) {
      var o;
      if (on(t)) t = an(t, xn(e[0]));
      else if (t.length && !t.nodeType) {
        if (((t = hn.makeArray(t)), r))
          for (o = t.length - 1; 0 <= o; o--) un(e, t[o], n, r);
        else for (o = 0; o < t.length; o++) un(e, t[o], n, r);
        return e;
      }
    ...
    vn = /^\s*|\s*$/g,
    bn = function(e) {
      return null === e || e === undefined ? '' : ('' + e).replace(vn, '');
    },
    yn = function(e, t) {
      var n, r, o, i;
      if (e)
    ...
    xn = function(e) {
      return e ? (9 === e.nodeType ? e : e.ownerDocument) : Jt;
    };
  (hn.fn = hn.prototype = {
    constructor: hn,
    selector: '',
    ...
    init: function(e, t) {
      ...
      if (on(e)) {
        if (
          ...
          return hn(t).find(e);
        if (n[1])
          for (r = an(e, xn(t)).firstChild; r; )
            Qt.call(o, r), (r = r.nextSibling);
        else {
          if (!(r = xn(t).getElementById(n[2]))) return o;
    ...
    toArray: function() {
      return Gt.toArray(this);
    },
    add: function(e, t) {
      var n,
        r,
        o = this;
      if (on(e)) return o.add(hn(e));
      if (!1 !== t)
        for (
          n = hn.unique(o.toArray().concat(hn.makeArray(e))),
            o.length = n.length,
            r = 0;
          r < n.length;
          r++
          ...
          o[r] = n[r];
      else Qt.apply(o, hn.makeArray(e));
      return o;
    },
    attr: function(t, n) {
      var e,
      ...
      if ('object' == typeof t)
        ...
        if (!rn(n)) {
          if (r[0] && 1 === r[0].nodeType) {
            if ((e = gn[t]) && e.get) return e.get(r[0], t);
            if (fn[t]) return r.prop(t) ? t : undefined;
        ...
        this.each(function() {
          var e;
          if (1 === this.nodeType) {
            if ((e = gn[t]) && e.set) return void e.set(this, n);
            null === n
    ...
    prop: function(e, t) {
      ...
      if ('object' == typeof (e = dn[e] || e))
        ...
        if (!rn(t)) return n[0] && n[0].nodeType && e in n[0] ? n[0][e] : t;
        this.each(function() {
    ...
    css: function(n, r) {
      ...
      if ('object' == typeof n)
        ...
        (n = t(n)),
          'number' != typeof r || ln[n] || (r = r.toString() + 'px'),
          i.each(function() {
            var e = this.style;
            if ((o = pn[n]) && o.set) o.set(this, r);
            else {
              try {
                this.style[mn[n] || n] = r;
              } catch (t) {}
        ...
        if (((e = i[0]), (o = pn[n]) && o.get)) return o.get(e);
    ...
    remove: function() {
      for (var e, t = this.length; t--; )
        (e = this[t]), tn.clean(e), e.parentNode && e.parentNode.removeChild(e);
      return this;
    },
    empty: function() {
      for (var e, t = this.length; t--; )
    ...
    trigger: function(e) {
      return this.each(function() {
        'object' == typeof e ? tn.fire(this, e.type, e) : tn.fire(this, e);
      });
    },
    show: function() {
    ...
    slice: function() {
      return new hn(Zt.apply(this, arguments));
    },
    eq: function(e) {
    ...
    filter: function(n) {
      return hn(
        'function' == typeof n
          ? Cn(this.toArray(), function(e, t) {
              return n(t, e);
            })
          : hn.filter(n, this.toArray()),
      );
    },
    closest: function(n) {
      var r = [];
      return (
        n instanceof hn && (n = n[0]),
        this.each(function(e, t) {
          for (; t; ) {
            if ('string' == typeof n && hn(t).is(n)) {
              r.push(t);
              break;
            }
            if (t === n) {
    ...
    Gt.extend(hn, {
      ...
      makeArray: function(e) {
        return ((t = e) && t === t.window) || e.nodeType ? [e] : Gt.toArray(e);
        var t;
      },
  ...
  var wn = function(e, t, n) {
      var r = [],
        o = e[t];
      for (
        'string' != typeof n && n instanceof hn && (n = n[0]);
        o && 9 !== o.nodeType;
  ...
  yn(
    {
      ...
      next: function(e) {
        return En(e, 'nextSibling', 1);
      },
      prev: function(e) {
        return En(e, 'previousSibling', 1);
      },
      children: function(e) {
        return Nn(e.firstChild, 'nextSibling', 1);
      },
      contents: function(e) {
        return Gt.toArray(
          ('iframe' === e.nodeName
      ...
      hn.fn[e] = function(t) {
        ...
        return (
          this.each(function() {
            ...
            e && (hn.isArray(e) ? n.push.apply(n, e) : n.push(e));
          }),
          1 < this.length &&
            (nn[e] || (n = hn.unique(n)),
    ...
    yn(
      {
        ...
        nextUntil: function(e, t) {
          return Nn(e, 'nextSibling', 1, t).slice(1);
        },
        prevUntil: function(e, t) {
          return Nn(e, 'previousSibling', 1, t).slice(1);
        },
      },
      function(r, o) {
        hn.fn[r] = function(t, e) {
          var n = [];
          return (
            this.each(function() {
    ...
    (hn.overrideDefaults = function(n) {
      var r,
        o = function(e, t) {
          return (
            (r = r || n()),
      ...
      return hn.extend(o, this), o;
    });
  var Sn = function(n, r, e) {
    yn(e, function(e, t) {
      (n[e] = n[e] || {}), (n[e][r] = t);
    });
  };
  ...
  var kn,
    ...
    Ln = function(e) {
      ...
      return {
        ...
        version: e.version,
        isEdge: Pn('Edge', t),
        isChrome: Pn('Chrome', t),
        isIE: Pn('IE', t),
        isOpera: Pn('Opera', t),
        isFirefox: Pn(On, t),
        isSafari: Pn('Safari', t),
      };
    },
    In = {
      unknown: function() {
        return Ln({ current: undefined, version: Bn.unknown() });
      },
      nu: Ln,
      edge: q('Edge'),
      chrome: q('Chrome'),
    ...
    jn = {
      unknown: function() {
        return Hn({ current: undefined, version: Bn.unknown() });
      },
      nu: Hn,
      windows: q(Mn),
      ios: q('iOS'),
    ...
    $n = function(e, n) {
      return qn(e, n).map(function(e) {
        var t = Bn.detect(e.versionRegexes, n);
    ...
    Qn = [
      ...
      {
        name: 'Chrome',
        versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, Gn],
        search: function(e) {
          return Kn(e, 'chrome') && !Kn(e, 'chromeframe');
        },
      },
      {
        name: 'IE',
        ...
        search: function(e) {
          return Kn(e, 'msie') || Kn(e, 'trident');
        },
      },
      {
        name: 'Opera',
        versionRegexes: [Gn, /.*?opera\/([0-9]+)\.([0-9]+).*/],
        search: Jn('opera'),
      },
      {
        name: 'Firefox',
      ...
      {
        name: 'Safari',
        versionRegexes: [Gn, /.*?cpu os ([0-9]+)_([0-9]+).*/],
        search: function(e) {
          return (Kn(e, 'safari') || Kn(e, 'mobile/')) && Kn(e, 'applewebkit');
        },
      },
    ],
    Zn = [
      ...
      { name: 'Linux', search: Jn('linux'), versionRegexes: [] },
      { name: 'Solaris', search: Jn('sunos'), versionRegexes: [] },
      { name: 'FreeBSD', search: Jn('freebsd'), versionRegexes: [] },
    ],
    er = { browsers: q(Qn), oses: q(Zn) },
    tr = function(e) {
      var t,
        n,
        r,
        ...
        d = er.browsers(),
        m = er.oses(),
        g = $n(d, e).fold(In.unknown, In.nu),
        p = Wn(m, e).fold(jn.unknown, jn.nu);
      return {
        browser: g,
        os: p,
        deviceType: ((n = g),
    ...
    nr = {
      ...
      function() {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return An || ((An = !0), (Tn = kn.apply(null, e))), Tn;
      }),
    },
    rr = function(e) {
    ...
    or = {
      fromHtml: function(e, t) {
        ...
        if (((n.innerHTML = e), !n.hasChildNodes() || 1 < n.childNodes.length))
          throw (H.console.error('HTML does not have a single root node', e),
          new Error('HTML must have a single root node'));
        return rr(n.childNodes[0]);
      },
      ...
      fromPoint: function(e, t, n) {
        var r = e.dom();
        return A.from(r.elementFromPoint(t, n)).map(rr);
      },
    },
    ir = (H.Node.ATTRIBUTE_NODE,
    H.Node.CDATA_SECTION_NODE,
    H.Node.COMMENT_NODE,
    H.Node.DOCUMENT_NODE),
    ar = (H.Node.DOCUMENT_TYPE_NODE,
    H.Node.DOCUMENT_FRAGMENT_NODE,
    H.Node.ELEMENT_NODE),
    ur = H.Node.TEXT_NODE,
    sr = (H.Node.PROCESSING_INSTRUCTION_NODE,
    ...
    fr = cr(ur),
    dr = Object.keys,
    mr = Object.hasOwnProperty,
    gr = function(e, t) {
      for (var n = dr(e), r = 0, o = n.length; r < o; r++) {
        var i = n[r];
        t(e[i], i, e);
      }
    },
    ...
    Nr = function(e, t) {
      var n,
        ...
        a =
          '' !== i ||
          ((r = fr((n = e)) ? n.dom().parentNode : n.dom()) !== undefined &&
            null !== r &&
    ...
    Tr = function() {
      return ae.getOrDie('Node');
    },
    Ar = function(e, t, n) {
      return 0 != (e.compareDocumentPosition(t) & n);
    },
    Rr = function(e, t) {
      return Ar(e, t, Tr().DOCUMENT_POSITION_CONTAINED_BY);
    },
    _r = ar,
    Dr = ir,
    Br = function(e, t) {
      var n = e.dom();
      if (n.nodeType !== _r) return !1;
    ...
    Or = function(e) {
      return (
        (e.nodeType !== _r && e.nodeType !== Dr) || 0 === e.childElementCount
      );
    },
    Pr = function(e, t) {
      return e.dom() === t.dom();
    },
    Lr = nr.detect().browser.isIE()
      ? function(e, t) {
          return Rr(e.dom(), t.dom());
        }
      : function(e, t) {
          var n = e.dom(),
            r = t.dom();
    ...
    Ir = function(e) {
      return or.fromDom(e.dom().ownerDocument);
    },
    Mr = function(e) {
      var t = e.dom();
      return A.from(t.parentNode).map(or.fromDom);
    },
    Fr = function(e) {
      var t = e.dom();
      return A.from(t.previousSibling).map(or.fromDom);
    },
    zr = function(e) {
      var t = e.dom();
      return A.from(t.nextSibling).map(or.fromDom);
    },
    Ur = function(e) {
      return (t = kr(e, Fr)), (n = Z.call(t, 0)).reverse(), n;
      var t, n;
    },
    Vr = function(e) {
      return kr(e, zr);
    ...
    Hr = function(e) {
      var t = e.dom();
      return W(t.childNodes, or.fromDom);
    },
    jr = function(e, t) {
      var n = e.dom().childNodes;
      return A.from(n[t]).map(or.fromDom);
    },
    qr = function(e) {
      return jr(e, 0);
    },
    ...
    Wr = (Sr('element', 'offset'), nr.detect().browser),
    Kr = function(e) {
      return V(e, lr);
    },
    Xr = {
      getPos: function(e, t, n) {
        ...
        if (((n = n || e), t)) {
          if (
            n === e &&
            t.getBoundingClientRect &&
            'static' === Nr(or.fromDom(e), 'position')
          )
            return {
              x: (a =
                (o = t.getBoundingClientRect()).left +
          ...
          for (r = t.parentNode; r && r !== n && r.nodeType; )
            (a -= r.scrollLeft || 0),
              ...
              (r = r.parentNode);
          u += ((i = or.fromDom(t)),
          Wr.isFirefox() && 'table' === sr(i)
            ? Kr(Hr(i))
                .filter(function(e) {
                  return 'caption' === sr(e);
                })
                .bind(function(o) {
                  return Kr(Vr(o)).map(function(e) {
      ...
      if (!Bo.isElement(t) || !Oo(t)) {
        ...
        if (!1 === Bo.isDocument(t)) {
          if (Bo.isText(t) && 0 < t.nodeValue.length) {
            var o = Gt.trim(t.nodeValue).length;
  ...
  var jo = function(e, t) {
      return e.replace(t ? Mo : Fo, function(e) {
        return ao[e] || e;
      });
    },
    qo = function(e, t) {
        ...
        return e.replace(Uo, function(e, t) {
          return t
            ...
            : uo[e] ||
                io[e] ||
                ((n = e),
                ((r = or.fromTag('div').dom()).innerHTML = n),
    ...
    ti = function(e) {
      ...
      return Ko[e]
        ...
        : ((u = 'id accesskey class dir lang style tabindex title role'),
          ...
          Go(ei('a form meter progress dfn'), function(e) {
  ...
  function ri(i) {
    var e,
      ...
      v = function(e, t, n) {
        ...
        return (
          r
            ? (r = Yo(r, /[, ]/, Yo(r.toUpperCase(), /[, ]/)))
            : (r = Ko[e]) ||
              ((r = Yo(t, ' ', Yo(t.toUpperCase(), ' '))),
              (r = Jo(r, n)),
              (Ko[e] = r)),
          r
        );
    ...
    var S = function(e) {
      ...
      C = function(e) {
        var a = /^(~)?(.+)$/;
        e &&
          ((Ko.text_block_elements = Ko.block_elements = null),
          Go(ei(e, ','), function(e) {
            var t = a.exec(e),
              n = '~' === t[1],
              r = n ? 'span' : 'div',
            ...
            if (
              ...
              var i = N[r];
              delete (i = Jo({}, i)).removeEmptyAttrs,
                delete i.removeEmpty,
                (N[o] = i);
            }
            Go(g, function(e, t) {
              e[r] && ((g[t] = e = Jo({}, g[t])), (e[o] = e[r]));
            });
          }));
      },
      x = function(e) {
    ...
    return (
      i.valid_elements
        ...
        : (Go(n, function(e, t) {
          ...
          'html5' !== i.schema &&
            Go(ei('strong/b em/i'), function(e) {
              (e = ei(e, '/')), (N[e[1]].outputName = e[0]);
            }),
          Go(
            ei(
          ...
          Go(
            ei('p h1 h2 h3 h4 h5 h6 th td pre div address caption li'),
            function(e) {
              N[e].paddEmpty = !0;
            },
          ),
          Go(ei('span'), function(e) {
      ...
      i.invalid_elements &&
        Go(Qo(i.invalid_elements), function(e) {
          N[e] && delete N[e];
        }),
  ...
  function pi(a, u) {
    ...
    var r = {},
        ...
        var b = function(e) {
          ...
          t = function(t) {
            return Qr.nu(function(e) {
              n(t, j(e, q(ro.value(t))), j(e, q(ro.error(t))));
            });
          },
          o = function(e) {
            return e.fold($, $);
      ...
      m = u.ownEvents ? new Te(u.proxy) : Te.Event,
      n = f.getBlockElements(),
      g = hn.overrideDefaults(function() {
      ...
      T = function(e, n, r) {
        ...
        if (!t) return !1;
        if (Gt.isArray(t) && (t.length || 0 === t.length))
          return (
            (o = []),
            ui(t, function(e, t) {
              e &&
      ...
      I = function(t, e, n) {
        return T(e, function(e) {
          return (
            Gt.is(e, 'array') && (t = t.cloneNode(!0)),
            n &&
              ui(si(e.childNodes), function(e) {
                t.appendChild(e);
              }),
  ...
  ((ai = pi || (pi = {})).DOM = ai(H.document)), (ai.nodeIndex = gi);
  var hi = pi,
    vi = hi.DOM,
    bi = Gt.each,
    yi = Gt.grep,
            ...
            (u = function() {
              ...
              if (
                ...
                (a.length = 0),
                  bi(t, function(e) {
                    0 === s.length
                      ? Ci(e.success) && e.success.call(e.scope)
                      : Ci(e.failure) && e.failure.call(e.scope, s);
                  });
              }
            })();
        });
  ...
  ((wi = Ei || (Ei = {})).PluginManager = wi()), (wi.ThemeManager = wi());
  var Si = function(t, n) {
    ...
    zi = function(e, t) {
      Ii(e) ? e.dom().classList.add(t) : Mi(e, t);
    },
    Ui = function(e) {
      0 === (Ii(e) ? e.dom().classList : Li(e, 'class')).length &&
        xr(e, 'class');
    },
    Vi = function(e, t) {
    ...
    ji = function(e, t) {
      return (
        ...
        Or(o) ? [] : W(o.querySelectorAll(n), or.fromDom)
      );
      var n, r, o;
    };
  ...
  var $i,
    ...
    Yi = function(e, t) {
      return (
        (n = t),
        (o = (r = e) === undefined ? H.document : r.dom()),
        Or(o) ? A.none() : A.from(o.querySelector(n)).map(or.fromDom)
      );
      var n, r, o;
    },
    Gi = function(e, t, n) {
      return qi(Br, Xi, e, t, n);
    },
    Ji = q('mce-annotation'),
    Qi = q('data-mce-annotation'),
    Zi = q('data-mce-annotation-uid'),
    ea = function(r, e) {
      var t = r.selection.getRng(),
        n = or.fromDom(t.startContainer),
        o = or.fromDom(r.getBody()),
        i = e.fold(
          function() {
            return '.' + Ji();
          },
      ...
      return u.bind(function(e) {
        return s(e, '' + Zi()).bind(function(n) {
          return s(e, '' + Qi()).map(function(e) {
            var t = ta(r, n);
      ...
      var n,
        ...
        t = ((n = function() {
          var e,
            ...
            n,
            r = a.get(),
            o = ((e = dr(r)), (n = Z.call(e, 0)).sort(t), n);
          F(o, function(e) {
            u(e, function(u) {
    ...
    ra = function(e, n) {
      e.on('init', function() {
        e.serializer.addNodeFilter('span', function(e) {
          F(e, function(t) {
            var e;
            ((e = t), A.from(e.attributes.map[Qi()]).bind(n.lookup)).each(
              function(e) {
    ...
    oa = 0,
    ia = function(e, t) {
      return or.fromDom(e.dom().cloneNode(t));
    },
    aa = function(e) {
      return ia(e, !1);
    },
    ...
    sa = function(e, t) {
      var n,
        r,
        o = Ir(e).dom(),
        i = or.fromDom(o.createDocumentFragment()),
        a = ((n = t),
    ...
    pa = function(e) {
      return (
        ga(e) && (e = e.parentNode), ma(e) && e.hasAttribute('data-mce-caret')
      );
    },
    ha = function(e) {
      return ga(e) && la(e.data);
    },
    va = function(e) {
      return pa(e) || ha(e);
    },
    ...
    wa = function(e) {
      return ga(e) && e.data[0] === fa;
    },
    Na = function(e) {
      return ga(e) && e.data[e.data.length - 1] === fa;
    },
    Ea = function(e) {
      return e && e.hasAttribute('data-mce-caret')
        ? ((t = e.getElementsByTagName('br')),
          (n = t[t.length - 1]),
          Bo.isBogus(n) && n.parentNode.removeChild(n),
    ...
    Sa = Bo.isContentEditableTrue,
    ka = Bo.isContentEditableFalse,
    Ta = Bo.isBr,
    Aa = Bo.isText,
    Ra = Bo.matchNodeNames('script style textarea'),
    _a = Bo.matchNodeNames('img input textarea hr iframe video audio object'),
    Da = Bo.matchNodeNames('table'),
    Ba = va,
    Oa = function(e) {
      return (
        !Ba(e) && (Aa(e) ? !Ra(e.parentNode) : _a(e) || Ta(e) || Da(e) || Pa(e))
      );
    },
    Pa = function(e) {
      return (
        !1 ===
          ((t = e),
          Bo.isElement(t) && 'true' === t.getAttribute('unselectable')) && ka(e)
      );
      var t;
    },
    La = function(e, t) {
    ...
    Ua = function(e, t) {
      return (
        ...
        (!(e.top > t.bottom) && za(t.top - e.bottom, e, t))
      );
    },
    Va = function(e, t) {
      return (
        e.top > t.bottom || (!(e.bottom < t.top) && za(t.bottom - e.top, e, t))
      );
    },
    Ha = function(e) {
    ...
    $a = function(e) {
      return 'string' == typeof e && 768 <= e.charCodeAt(0) && qa.test(e);
    },
    Wa = function(e, t) {
    ...
    Ga = Bo.isElement,
    Ja = Oa,
    Qa = Bo.matchStyleValues('display', 'block table'),
    Za = Bo.matchStyleValues('float', 'left right'),
    eu = Xa(Ga, Ja, y(Za)),
    tu = y(Bo.matchStyleValues('white-space', 'pre pre-line pre-wrap')),
    nu = Bo.isText,
    ru = Bo.isBr,
    ou = hi.nodeIndex,
    iu = ja,
      ...
      var t,
        ...
        i = function(e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (
              $a(e.data[t - 1]) &&
              (n.setStart(e, t), n.setEnd(e, t + 1), !cu(n))
            )
              return o(du(fu(n), !1)), r;
          }
          0 < t &&
            (n.setStart(e, t - 1), n.setEnd(e, t), cu(n) || o(du(fu(n), !1))),
            t < e.data.length &&
              (n.setStart(e, t), n.setEnd(e, t + 1), cu(n) || o(du(fu(n), !0)));
        };
      ...
      if (Ga(e.container()))
        if (e.isAtEnd())
          ...
          (t = iu(e.container(), e.offset() - 1)),
            eu(t) && !ru(t) && (Qa(t) || Qa(n) || !eu(n)) && o(du(fu(t), !1)),
            eu(n) && o(du(fu(n), !0));
        }
      return r;
    };
  function gu(t, n, e) {
    ...
    return {
      ...
      toRange: function() {
        var e;
        return (e = au(t.ownerDocument)).setStart(t, n), e.setEnd(t, n), e;
      },
      getClientRects: r,
      isVisible: function() {
        return 0 < r().length;
      ...
      isAtEnd: function() {
        return nu(t) ? n >= t.data.length : n >= t.childNodes.length;
      },
      isEqual: function(e) {
  ...
  (($i = gu || (gu = {})).fromRangeStart = function(e) {
    return $i(e.startContainer, e.startOffset);
  }),
    ($i.fromRangeEnd = function(e) {
      return $i(e.endContainer, e.endOffset);
    }),
    ($i.after = function(e) {
      return $i(e.parentNode, ou(e) + 1);
    }),
    ($i.before = function(e) {
      return $i(e.parentNode, ou(e));
    }),
    ($i.isAbove = function(e, t) {
      return Wa([te(t.getClientRects()), ne(e.getClientRects())], Ua).getOr(!1);
    }),
    ($i.isBelow = function(e, t) {
      return Wa([ne(t.getClientRects()), te(e.getClientRects())], Va).getOr(!1);
    }),
    ($i.isAtStart = function(e) {
      return !!e && e.isAtStart();
    }),
    ($i.isAtEnd = function(e) {
      return !!e && e.isAtEnd();
    }),
    ($i.isTextPosition = function(e) {
      return !!e && Bo.isText(e.container());
    }),
    ($i.isElementPosition = function(e) {
      return !1 === $i.isTextPosition(e);
    });
  var pu,
    hu,
    vu = gu,
    ...
    Eu = function(e) {
      var t, r, n, o;
      return (
        (bu(e) ? 'text()' : e.nodeName.toLowerCase()) +
        '[' +
        ((r = wu(xu((t = e)))),
        (n = $t.findIndex(r, Nu(t), t)),
        (r = r.slice(0, n + 1)),
        (o = $t.reduce(
          r,
          function(e, t, n) {
            return bu(t) && bu(r[n - 1]) && e++, e;
          },
          0,
        )),
        (r = $t.filter(r, Bo.matchNodeNames(t.nodeName))),
        (n = $t.findIndex(r, Nu(t), t)) - o) +
        ']'
      );
    },
    Su = function(e, t) {
      ...
      return (
        ...
        bu(n)
          ? (o = (function(e, t) {
              for (; (e = e.previousSibling) && bu(e); ) t += e.data.length;
              return t;
            })(n, r))
          ...
          (r = $t.reduce(
            ...
            function(e, t) {
              return (t = /([\w\-\(\)]+)\[([0-9]+)\]/.exec(t))
                ? ('text()' === t[1] && (t[1] = '#text'),
                  ...
                  (o = parseInt(t[2], 10)),
                  (i = wu(n)),
                  (i = $t.filter(i, function(e, t) {
                    return !bu(e) || !bu(i[t - 1]);
                  })),
                  (i = $t.filter(i, Bo.matchNodeNames(r)))[o])
                : null;
              var n, r, o, i;
            },
            e,
            ...
            ? bu(r)
              ? (function(e, t) {
                  ...
                  return (
                    bu(e) && t > e.data.length && (t = e.data.length), vu(e, t)
                  );
                })(r, parseInt(o, 10))
              : ((o = 'after' === o ? Cu(r) + 1 : Cu(r)), vu(r.parentNode, o))
            : null)
        : null;
    },
    Tu = function(e, t) {
      Bo.isText(t) && 0 === t.data.length && e.remove(t);
    },
    Au = function(e, t, n) {
      var r, o, i, a, u, s, c;
      Bo.isDocumentFragment(n)
        ? ((i = e),
          (a = t),
          (u = n),
          ...
          a.insertNode(u),
          s.each(function(e) {
            return Tu(i, e.previousSibling);
          }),
          c.each(function(e) {
            return Tu(i, e.nextSibling);
          }))
        : ((r = e),
          (o = n),
          t.insertNode(o),
          Tu(r, o.previousSibling),
          Tu(r, o.nextSibling));
    },
    Ru = Bo.isContentEditableFalse,
    ...
    Pu = function(e, t) {
      var n;
      if (Bo.isElement(e) && ((e = ja(e, t)), Ru(e))) return e;
      if (va(e)) {
        if (
          (Bo.isText(e) && pa(e) && (e = e.parentNode),
          (n = e.previousSibling),
          Ru(n))
        )
          return n;
        if (((n = e.nextSibling), Ru(n))) return n;
      }
    },
    Lu = function(e, t, n) {
      var r = n.getNode(),
        o = r ? r.nodeName : null,
        i = n.getRng();
      if (Ru(r) || 'IMG' === o) return { name: o, index: Du(n.dom, o, r) };
      var a,
        u,
        s,
        c,
        ...
        d,
        m =
          Pu((a = i).startContainer, a.startOffset) ||
          Pu(a.endContainer, a.endOffset);
      return m
        ? { name: (o = m.tagName), index: Du(n.dom, o, m) }
        : ((u = e),
          (c = t),
          (l = i),
          (f = (s = n).dom),
          ((d = {}).start = _u(f, u, c, l, !0)),
          s.isCollapsed() || (d.end = _u(f, u, c, l, !1)),
          d);
    },
    Iu = function(e, t, n) {
      var r = {
    ...
    Mu = function(e, t) {
      var n = e.dom,
        ...
        a = e.getNode(),
        u = a.nodeName;
      if ('IMG' === u) return { name: u, index: Du(n, u, a) };
      var s = Ou(r.cloneRange());
      if (!i) {
        s.collapse(!1);
        var c = Iu(n, o + '_end', t);
        Au(n, s, c);
      ...
      (r = Ou(r)).collapse(!0);
      var l = Iu(n, o + '_start', t);
      return Au(n, r, l), e.moveToBookmark({ id: o, keep: 1 }), { id: o };
    },
    Fu = {
      getBookmark: function(e, t, n) {
        return 2 === t
          ...
          ? ((o = (r = e).getRng()),
            {
              start: Su(r.dom.getRoot(), vu.fromRangeStart(o)),
              end: Su(r.dom.getRoot(), vu.fromRangeEnd(o)),
            })
          : t
          ? { rng: e.getRng() }
          : Mu(e, !1);
      ...
      getUndoBookmark: d(Lu, $, !0),
      getPersistentBookmark: Mu,
    },
    zu = '_mce_caret',
    Uu = function(e) {
      return Bo.isElement(e) && e.id === zu;
    },
    Vu = function(e, t) {
      for (; t && t !== e; ) {
        if (t.id === zu) return t;
    ...
    Xu = function(e, t) {
      var n,
        ...
        -1 === o ? A.none() : A.some(o))
          .map(function(e) {
            return e < t.offset() ? vu(i, t.offset() - 1) : t;
          })
          .getOr(t);
      return Gu(e), a;
    },
    Yu = function(e, t) {
      return ju(e) && t.container() === e
        ? ((r = t),
          (o = Wu((n = e).data.substr(0, r.offset()))),
          (i = Wu(n.data.substr(r.offset()))),
          0 < (a = o.text + i.text).length
            ? ($u(n, a), vu(n, r.offset() - o.count))
            : r)
        : Ku(e, t);
      var n, r, o, i, a;
    },
    Gu = function(e) {
      if (
        (Hu(e) &&
          va(e) &&
          (ba(e) ? e.removeAttribute('data-mce-caret') : qu(e)),
        ju(e))
      ) {
        var t = da(
          (function(e) {
    ...
    Ju = {
      removeAndReposition: function(e, t) {
        return vu.isTextPosition(t)
          ? Yu(e, t)
          : ((n = e),
            (r = t).container() === n.parentNode ? Xu(n, r) : Ku(n, r));
        var n, r;
      },
      remove: Gu,
    },
    Qu = nr.detect().browser,
    Zu = Bo.isContentEditableFalse,
    es = function(e, t, n) {
      var r,
        o,
        i,
    ...
    ts = function(a, u, e) {
      var t,
        ...
        l = function() {
          !(function(e) {
            var t, n, r, o, i;
            for (
              t = hn('*[contentEditable=false]', e), o = 0;
              o < t.length;
              o++
            )
            ...
            s && (Ju.remove(s), (s = null)),
            c.get().each(function(e) {
              hn(e.caret).remove(), c.set(A.none());
            }),
            clearInterval(t);
        },
        f = function() {
          t = be.setInterval(function() {
            e()
              ? hn('div.mce-visual-caret', a).toggleClass(
                  'mce-visual-caret-hidden',
                )
              : hn('div.mce-visual-caret', a).addClass(
                  'mce-visual-caret-hidden',
                );
          }, 500);
        };
      return {
        show: function(t, e) {
          var n, r, o;
          if ((l(), (o = e), Bo.isElement(o) && /^(TD|TH)$/i.test(o.tagName)))
            return null;
          if (!u(e))
            return (
              (s = (function(e, t) {
                var n, r, o;
                if (
                  ((r = e.ownerDocument.createTextNode(fa)),
                  (o = e.parentNode),
                  t)
                ) {
                  if (((n = e.previousSibling), ga(n))) {
                    if (va(n)) return n;
                    if (Na(n)) return n.splitText(n.data.length - 1);
                  }
                  o.insertBefore(r, e);
                } else {
                  if (((n = e.nextSibling), ga(n))) {
                    if (va(n)) return n;
                    if (wa(n)) return n.splitText(1), n;
                  }
                  e.nextSibling
          ...
          (s = xa('p', e, t)), (n = es(a, e, t)), hn(s).css('top', n.top);
          var i = hn(
          ...
          return (
            ...
            c.get().each(function(e) {
              t && hn(e.caret).addClass('mce-visual-caret-before');
            }),
            f(),
    ...
    ns = function() {
      return Qu.isIE() || Qu.isEdge() || Qu.isFirefox();
    },
    rs = function(e) {
      return Zu(e) || (Bo.isTable(e) && ns());
    },
    os = Bo.isContentEditableFalse,
    is = Bo.matchStyleValues(
      'display',
    ...
    ms = function(e, t, n, r, o) {
      var i = new oo(e, r);
      if (fs(t)) {
        if ((os(e) || us(e)) && n((e = ds(i.prev, !0)))) return e;
        for (; (e = ds(i.prev, o)); ) if (n(e)) return e;
      }
      if (ls(t)) {
        if ((os(e) || us(e)) && n((e = ds(i.next, !0)))) return e;
        for (; (e = ds(i.next, o)); ) if (n(e)) return e;
      }
      return null;
    },
    gs = function(e, t) {
    ...
    bs = function(e, t, n) {
      ...
      for (o = e ? 'previousSibling' : 'nextSibling'; n && n !== t; ) {
        if (((r = n[o]), as(r) && (r = r[o]), os(r))) {
          if (((a = n), gs(r, (i = t)) === gs(a, i))) return r;
          break;
        }
        if (cs(r)) break;
        n = n.parentNode;
    ...
    xs = function(e, t, n) {
      ...
      if (((o = n.startContainer), (i = n.startOffset), pa(o))) {
        if (
          ...
          'before' === (a = o.getAttribute('data-mce-caret')) &&
            ((r = o.nextSibling), rs(r)))
        )
          return ys(r);
        if ('after' === a && ((r = o.previousSibling), rs(r))) return Cs(r);
      }
      ...
      if (Bo.isText(o)) {
        ...
        if (Na(o) && i >= o.data.length - 1)
          return 1 === e && (r = s(o)) ? ys(r) : n;
        if (wa(o) && i <= 1) return -1 === e && (r = u(o)) ? Cs(r) : n;
        if (i === o.data.length) return (r = s(o)) ? ys(r) : n;
        if (0 === i) return (r = u(o)) ? Cs(r) : n;
      }
      return n;
    },
    ws = function(e, t) {
      return A.from(hs(e ? 0 : -1, t)).filter(os);
    },
    Ns = function(e, t, n) {
      var r = xs(e, t, n);
      return -1 === e ? gu.fromRangeStart(r) : gu.fromRangeEnd(r);
    },
    Es = function(e) {
      return A.from(e.getNode()).map(or.fromDom);
    },
    Ss = function(e, t) {
    ...
    ks = function(e, t) {
      var n = ps(e, t);
      return !(n || !Bo.isBr(e.getNode())) || n;
    };
  ((hu = pu || (pu = {}))[(hu.Backwards = -1)] = 'Backwards'),
    (hu[(hu.Forwards = 1)] = 'Forwards');
  var Ts,
    As,
    Rs,
    _s,
    Ds,
    Bs = Bo.isContentEditableFalse,
    Os = Bo.isText,
    Ps = Bo.isElement,
    Ls = Bo.isBr,
    Is = Oa,
    ...
    Us = function(e, t) {
      if (ls(e)) {
        if (Is(t.previousSibling) && !Os(t.previousSibling))
          return vu.before(t);
        if (Os(t)) return vu(t, 0);
      }
      if (fs(e)) {
        if (Is(t.nextSibling) && !Os(t.nextSibling)) return vu.after(t);
        if (Os(t)) return vu(t, t.data.length);
      }
      return fs(e) ? (Ls(t) ? vu.before(t) : vu.after(t)) : vu.before(t);
    },
    Vs = function(e, t, n) {
      var r, o, i, a, u;
      if (!Ps(n) || !t) return null;
      if (t.isEqual(vu.after(n)) && n.lastChild) {
        if (
          ((u = vu.after(n.lastChild)),
          fs(e) && Is(n.lastChild) && Ps(n.lastChild))
        )
          return Ls(n.lastChild) ? vu.before(n.lastChild) : u;
      } else u = t;
      var s,
        c,
        l,
        ...
        d = u.offset();
      if (Os(f)) {
        if (fs(e) && 0 < d) return vu(f, --d);
        if (ls(e) && d < f.length) return vu(f, ++d);
        r = f;
      } else {
        if (fs(e) && 0 < d && ((o = zs(f, d - 1)), Is(o)))
          return !Ms(o) && (i = ms(o, e, Fs, o))
            ? Os(i)
              ? vu(i, i.data.length)
              : vu.after(i)
            : Os(o)
            ? vu(o, o.data.length)
            : vu.before(o);
        if (ls(e) && d < f.childNodes.length && ((o = zs(f, d)), Is(o)))
          return Ls(o)
            ? ((s = n),
              (l = (c = o).nextSibling) && Is(l)
                ? Os(l)
                  ? vu(l, 0)
                  : vu.before(l)
                : Vs(pu.Forwards, vu.after(c), s))
            : !Ms(o) && (i = ms(o, e, Fs, o))
            ? Os(i)
              ? vu(i, 0)
              : vu.before(i)
      ...
      return ((ls(e) && u.isAtEnd()) || (fs(e) && u.isAtStart())) &&
        ((r = ms(r, e, q(!0), n, !0)), Fs(r, n))
        ? Us(e, r)
        : ((o = ms(r, e, Fs, n)),
          !(a = $t.last(
            z(
          ...
          (o && a.contains(o))
            ? o
              ? Us(e, o)
              : null
            : (u = ls(e) ? vu.after(a) : vu.before(a)));
    },
    Hs = function(t) {
      return {
        next: function(e) {
          return Vs(pu.Forwards, e, t);
        },
        prev: function(e) {
          return Vs(pu.Backwards, e, t);
        },
      };
    },
    js = function(e) {
      return vu.isTextPosition(e) ? 0 === e.offset() : Oa(e.getNode());
    },
    qs = function(e) {
      if (vu.isTextPosition(e)) {
        var t = e.container();
    ...
    Ws = function(e, t, n) {
      return e
        ? !$s(t, n) &&
            ((r = t), !(!vu.isTextPosition(r) && Bo.isBr(r.getNode()))) &&
            qs(t) &&
            js(n)
        : !$s(n, t) && js(t) && qs(n);
      var r;
    ...
    Xs = function(t, n, r) {
      return Ks(t, n, r).bind(function(e) {
        return ps(r, e, n) && Ws(t, r, e) ? Ks(t, n, e) : A.some(e);
      });
    },
    Ys = function(t, n, e, r) {
      return Xs(t, n, e).bind(function(e) {
        return r(e) ? Ys(t, n, e, r) : A.some(e);
      });
    },
    Gs = function(e, t) {
      var n,
      ...
      return Bo.isText(u)
        ? A.some(vu(u, e ? 0 : u.data.length))
        : u
        ? Oa(u)
          ? A.some(
              e
                ? vu.before(u)
                : ((a = u), Bo.isBr(a) ? vu.before(a) : vu.after(a)),
            )
          : ((r = t),
            (o = u),
            (i = (n = e) ? vu.before(o) : vu.after(o)),
            Ks(n, r, i))
        : A.none();
    },
    Js = d(Ks, !0),
    ...
    Zs = {
      ...
      navigateIgnore: Ys,
      positionIn: Gs,
      firstPositionIn: d(Gs, !0),
      lastPositionIn: d(Gs, !1),
    },
    ec = function(e, t) {
      return (
        !e.isBlock(t) ||
    ...
    tc = function(e, t) {
      return Zs.lastPositionIn(e).fold(
        function() {
          return !1;
        },
        function(e) {
    ...
    nc = function(e, t, n) {
      return !(
        ...
        !Vu(e, t) ||
        ((o = n),
        (i = (r = t).ownerDocument.createTextNode(fa)),
        r.appendChild(i),
        o.setStart(i, 0),
        o.setEnd(i, 0),
        0)
    ...
    rc = function(e, t, n, r) {
      ...
      if (s) {
        for (a = s[0], i = c, o = s.length - 1; 1 <= o; o--) {
          if (((u = i.childNodes), nc(c, i, r))) return !0;
          if (s[o] > u.length - 1) return !!nc(c, i, r) || tc(i, r);
          i = u[s[o]];
        }
      ...
      if (c) {
        if (
          ...
          for (
            a = c.previousSibling,
              i = c.nextSibling,
              Gt.each(Gt.grep(c.childNodes), function(e) {
                Bo.isText(e) &&
    ...
    ac = function(e, t) {
      var n,
        ...
        b = e.dom;
      if (t) {
        if (((v = t), Gt.isArray(v.start)))
          return (
            (p = t),
            (h = (g = b).createRng()),
            rc(g, !0, p, h) && rc(g, !1, p, h) ? A.some(h) : A.none()
          );
        if ('string' == typeof t.start)
          return A.some(
            ((f = t),
            (d = (l = b).createRng()),
            (m = ku(l.getRoot(), f.start)),
            d.setStart(m.container(), m.offset()),
            (m = ku(l.getRoot(), f.end)),
        ...
        if (t.hasOwnProperty('id'))
          return (
            (s = ic((o = b), 'start', (i = t))),
            (c = ic(o, 'end', i)),
            Wa([s, ((a = c), (u = s), a.isSome() ? a : u)], function(e, t) {
              var n = o.createRng();
              return (
                n.setStart(ec(o, e.container()), e.offset()),
                n.setEnd(ec(o, t.container()), t.offset()),
                n
              );
            })
          );
    ...
    uc = function(e, t, n) {
      return Fu.getBookmark(e, t, n);
    },
    sc = function(t, e) {
      ac(t, e).each(function(e) {
        t.setRng(e);
      });
    },
    cc = function(e) {
    ...
    xc = function(e, t, n, r, o, i) {
      var a, u, s, c;
      if (3 === n.nodeType) {
        if (-1 !== (s = Cc(o, i, n, r))) return { container: n, offset: s };
        c = n;
      }
      for (
        ...
        if (3 !== u.nodeType || gc(u.parentNode)) {
          if (e.isBlock(u) || mc.isEq(u, 'BR')) break;
        } else if (-1 !== (s = Cc(o, i, (c = u))))
    ...
    Nc = function(t, e, n, r) {
      ...
      if ((o && e[0].wrapper && (o = pc(i, o, 'ul,ol').reverse()[0] || o), !o))
        for (
          o = n;
    ...
    Ec = function(e, t, n, r, o, i, a) {
      ...
      if (
        ...
        (f = e.getRoot()),
        3 === u.nodeType && !hc(u) && (a ? 0 < r : i < u.nodeValue.length))
      )
        return u;
      for (;;) {
    ...
    Sc = function(e, t, n, r) {
      ...
      return (
        ...
        (i = yc(c, i)),
        (u = yc(c, u)),
        (gc(i.parentNode) || gc(i)) &&
          ((i = gc(i) ? i : i.parentNode),
          3 ===
            (i = t.collapsed ? i.previousSibling || i : i.nextSibling || i)
              .nodeType && (a = t.collapsed ? i.length : 0)),
        (gc(u.parentNode) || gc(u)) &&
          ((u = gc(u) ? u : u.parentNode),
          3 ===
        ...
        (n[0].block || n[0].selector) &&
          ((i = Nc(e, n, i, 'previousSibling')),
          (u = Nc(e, n, u, 'nextSibling')),
          n[0].block &&
    ...
    (As = 'text'),
    (Rs = function(e) {
      return Ts(e) ? A.from(e.dom().nodeValue) : A.none();
    }),
    (_s = nr.detect().browser),
    {
      get: function(e) {
        if (!Ts(e))
          throw new Error('Can only get ' + As + ' value of a ' + As + ' node');
        return Ds(e).getOr('');
      },
      getOption: (Ds =
        _s.isIE() && 10 === _s.version.major
          ? function(e) {
              try {
                return Rs(e);
              } catch (jN) {
      ...
      set: function(e, t) {
        if (!Ts(e))
          throw new Error(
            'Can only set raw ' + As + ' value of a ' + As + ' node',
          );
        e.dom().nodeValue = t;
      },
    }),
    ...
    _c = function(r, o, i, a) {
      return Mr(o).fold(
        ...
        function(e) {
          return 'br' === a || (fr((n = o)) && '\ufeff' === Rc(n))
            ? 'valid'
            : lr((t = o)) && Vi(t, Ji())
            ? 'existing'
            : Uu(o)
            ? 'caret'
            : mc.isValid(r, i, a) && mc.isValid(r, sr(e), i)
            ? 'valid'
            : 'invalid-child';
          var t, n;
        },
      ...
      var o,
        ...
        u =
          void 0 === a
            ? ((o = 'mce-annotation'),
              (i = new Date().getTime()),
              o + '_' + Math.floor(1e9 * Math.random()) + ++oa + String(i))
            : a,
        s = (function(e, t) {
          var n = {};
          for (var r in e)
    ...
    Bc = function(i, e, t, n, r) {
      ...
      return (
        Tc(i.dom, e, function(e) {
          var t;
          c(), (t = W(e, or.fromDom)), l(t);
        }),
        a
      );
    },
    Oc = function(s, c, l, f) {
      s.undoManager.transact(function() {
        ...
        if (
          ...
          var i = Dc(s.getDoc(), f, c, l.decorate);
          sa(i, '\xa0'),
            s.selection.getRng().insertNode(i.dom()),
            s.selection.select(i.dom());
        } else {
          var a = Fu.getPersistentBookmark(s.selection, !1),
            u = s.selection.getRng();
          Bc(s, u, c, l.decorate, f), s.selection.moveToBookmark(a);
        }
      });
    };
  function Pc(s) {
  ...
  var Lc = function(e) {
      return Gt.grep(e.childNodes, function(e) {
    ...
    Ic = function(e) {
      return (
        ...
        ('\xa0' === (t = e.firstChild).data || Bo.isBr(t))
      );
      var t;
    },
    Mc = function(e) {
      return 0 < e.length && (!(t = e[e.length - 1]).firstChild || Ic(t))
        ? e.slice(0, -1)
        : e;
      var t;
    },
    ...
    Uc = function(t, e, n) {
      var r,
        ...
        u = t.parentNode;
      return (
        Gt.each(e, function(e) {
          u.insertBefore(e, t);
        }),
        (r = t),
        (o = n),
        (i = vu.before(r)),
        (a = Hs(o).next(i)) ? a.toRange() : null
      );
    },
    Vc = function(e, t) {
      var n,
    ...
    Hc = function(e, o, i, t) {
      var n,
        ...
        a),
        E = Fc(o, i.startContainer),
        S = Mc(Lc(N.firstChild)),
        k = o.getRoot(),
        T = function(e) {
          var t = vu.fromRangeStart(i),
            n = Hs(o.getRoot()),
            r = 1 === e ? n.prev(t) : n.next(t);
          return !r || Fc(o, r.getNode()) !== E;
        };
      return T(1)
        ? Uc(E, S, k)
        : T(2)
    ...
    Wc = function(e) {
      var t = ji(e, 'br'),
        n = z(
          (function(e) {
            for (var t = [], n = e.dom(); n; )
              t.push(or.fromDom(n)), (n = n.lastChild);
            return t;
          })(e).slice(-1),
          mo,
        );
      t.length === n.length && F(n, Di);
    },
    Kc = function(e) {
      _i(e), Ai(e, or.fromHtml('<br data-mce-bogus="1">'));
    },
    Xc = function(n) {
      $r(n).each(function(t) {
        Fr(t).each(function(e) {
          lo(n) && mo(t) && lo(e) && Di(t);
        });
      });
    },
  ...
  var Qc,
    Zc = function(a) {
      var u = vu.fromRangeStart(a),
        s = vu.fromRangeEnd(a),
        c = a.commonAncestorContainer;
      return Zs.fromPosition(!1, c, s)
        .map(function(e) {
          return !ps(u, s, c) && ps(u, e, c)
            ? ((t = u.container()),
              (n = u.offset()),
              (r = e.container()),
              (o = e.offset()),
    ...
    el = function(e) {
      return e.collapsed ? e : Zc(e);
    },
    tl = Bo.matchNodeNames('td th'),
    nl = function(e, t) {
      var n,
        r,
        ...
        a = o.startOffset;
      o.collapsed &&
        ((n = i), (r = a), Bo.isText(n) && '\xa0' === n.nodeValue[r - 1]) &&
        Bo.isText(i) &&
        (i.insertData(a - 1, ' '),
        i.deleteData(a, 1),
        o.setStart(i, a),
    ...
    rl = function(e, t, n) {
      ...
      if (
        ...
        (r = e.parser),
        (m = n.merge),
        (o = Jc({ validate: e.settings.validate }, e.schema)),
        (d =
        ...
        w === N &&
          ...
          g.setRng(l)),
          g.isCollapsed() ||
            (e.selection.setRng(el(e.selection.getRng())),
        ...
        if (
          ((u = r.parse(t, T)), !0 === n.paste && Vc(e.schema, u) && jc(p, i))
        )
          return (
            (l = Hc(o, p, e.selection.getRng(), u)),
        ...
        !(function(e, t) {
          ...
          if (t) {
            var o = e.getBody(),
              i = new $c(r);
            Gt.each(r.select('*[data-mce-fragment]'), function(e) {
            ...
            if (e) {
              ...
              (i = e.previousSibling) && 3 === i.nodeType
                ...
                r &&
                  ...
                  !(o = (function(e) {
                    var t = vu.fromRangeStart(e);
                    if ((t = Hs(n.getBody()).next(t))) return t.toRange();
                  })(c))
          ...
          (E = e.getBody()),
          Gt.each(E.getElementsByTagName('*'), function(e) {
    ...
    ol = function(e, t) {
      var n,
        ...
        o =
          'string' != typeof (n = t)
            ? ((r = Gt.extend({ paste: n.paste, data: { paste: n.paste } }, n)),
              { content: n.content, details: r })
            : { content: n, details: {} };
      rl(e, o.content, o.details);
    },
    il = Sr('sections', 'settings'),
    al = nr.detect().deviceType.isTouch(),
    ul = ['lists', 'autolink', 'autosave'],
    sl = { theme: 'mobile' },
    cl = function(e) {
      var t = D(e) ? e.join(' ') : e,
        n = W(R(t) ? t.split(' ') : [], Xn);
    ...
    dl = function(e, t, n, r) {
      var o,
        i = cl(n.forced_plugins),
        a = cl(r.plugins),
        u = e && fl(t, 'mobile') ? z(a, d(M, ul)) : a,
        s = ((o = u), [].concat(cl(i)).concat(cl(o)));
      return Gt.extend(r, { plugins: s.join(' ') });
    },
    ml = function(e, t, n, r) {
      var o,
        i,
        ...
        p = Gt.extend(
            ...
            : {}),
          {
            ...
            external_plugins: ((o = n),
            (i = g.settings()),
            (a = i.external_plugins ? i.external_plugins : {}),
            o && o.external_plugins ? Gt.extend({}, o.external_plugins, a) : a),
          },
        );
      return dl(e, g, n, p);
    },
          ...
          'string' == typeof (i = u)
            ? F(
                ...
                function(e) {
                  var t = e.split('=');
                  1 < t.length
                    ? (a[Gt.trim(t[0])] = Gt.trim(t[1]))
                    : (a[Gt.trim(t[0])] = Gt.trim(t));
                },
              )
            : (a = i),
          a)
    ...
    bl = function(e, t) {
      ...
      return e
        ? ha(n)
          ...
          : t
        : ha(n)
        ? Bo.isText(n.previousSibling)
          ? vu(n.previousSibling, n.previousSibling.data.length)
          : vu.before(n)
        : Ca(t)
        ? vu(n, r - 1)
        : t;
    ...
    yl = {
      isInlineTarget: function(e, t) {
        var n = pl(e, 'inline_boundaries_selector').getOr('a[href],code');
        return Br(or.fromDom(t), n);
      },
      findRootInline: function(e, t, n) {
        var r,
          ...
          (o = t),
          (i = n),
          z(hi.DOM.getParents(i.container(), '*', o), r));
        return A.from(a[a.length - 1]);
      },
      isRtl: function(e) {
        return (
          'rtl' === hi.DOM.getStyle(e, 'direction', !0) ||
          ((t = e.textContent), vl.test(t))
        );
        var t;
      },
      isAtZwsp: function(e) {
      ...
      normalizePosition: bl,
      normalizeForwards: d(bl, !0),
      normalizeBackwards: d(bl, !1),
    ...
    Cl = function(e, t) {
      return Lr(e, t)
        ? Ki(
            ...
            ((n = e),
            function(e) {
              return Pr(n, or.fromDom(e.dom().parentNode));
            }),
          )
        : A.none();
      var n;
    ...
    wl = function(i, a, u) {
      return Wa([Zs.firstPositionIn(u), Zs.lastPositionIn(u)], function(e, t) {
        var n = yl.normalizePosition(!0, e),
          r = yl.normalizePosition(!1, t),
          o = yl.normalizePosition(!1, a);
        return i
          ? Zs.nextPosition(u, o)
              .map(function(e) {
    ...
    Nl = function(e, t) {
      var n,
        ...
        i = or.fromDom(e),
        a = or.fromDom(t);
      return (n = a), (r = 'pre,code'), (o = d(Pr, i)), Xi(n, r, o).isSome();
    },
    El = function(e, t) {
      return (
        (Oa(t) &&
          !1 ===
            ((r = e),
            (o = t),
            Bo.isText(o) && /^[ \t\r\n]*$/.test(o.data) && !1 === Nl(r, o))) ||
        ((n = t),
        Bo.isElement(n) && 'A' === n.nodeName && n.hasAttribute('name')) ||
        Sl(t)
      );
      var n, r, o;
    },
    Sl = Bo.hasAttribute('data-mce-bookmark'),
    kl = Bo.hasAttribute('data-mce-bogus'),
    Tl = Bo.hasAttributeValue('data-mce-bogus', 'all'),
    Al = function(e) {
      return (function(e) {
        var t,
          n,
    ...
    Rl = Sr('block', 'position'),
    _l = Sr('from', 'to'),
    Dl = function(e, t) {
      var n = or.fromDom(e),
        r = or.fromDom(t.container());
      return Cl(n, r).map(function(e) {
        return Rl(e, t);
      });
    },
    Bl = function(o, i, e) {
      var t = Dl(o, vu.fromRangeStart(e)),
        n = t.bind(function(e) {
          return Zs.fromPosition(i, o, e.position()).bind(function(e) {
            return Dl(o, e).map(function(e) {
              return (
                (t = o),
                (n = i),
                (r = e),
                Bo.isBr(r.position().getNode()) && !1 === Al(r.block())
                  ? Zs.positionIn(!1, r.block().dom())
                      .bind(function(e) {
                        return e.isEqual(r.position())
                          ? Zs.fromPosition(n, t, e).bind(function(e) {
                              return Dl(t, e);
                            })
                          : A.some(r);
                      })
      ...
      return Wa([t, n], _l).filter(function(e) {
        return (
          !1 === Pr((r = e).from().block(), r.to().block()) &&
          Mr((n = e).from().block())
            .bind(function(t) {
              return Mr(n.to().block()).filter(function(e) {
                return Pr(t, e);
              });
            })
            .isSome() &&
          ((t = e),
          !1 === Bo.isContentEditableFalse(t.from().block()) &&
            !1 === Bo.isContentEditableFalse(t.to().block()))
        );
        var t, n, r;
      });
    },
    Ol = function(e, t, n) {
      return n.collapsed ? Bl(e, t, n) : A.none();
    },
    Pl = function(e, t, n) {
      return Lr(t, e)
        ? (function(e, t) {
    ...
    zl = function(e, t) {
      var n = Ml(t, e);
      return V(n.reverse(), Al).each(Di);
    },
    Ul = function(e, t, n, r) {
      if (Al(n)) return Kc(n), Zs.firstPositionIn(n.dom());
      0 ===
        z(Ur(r), function(e) {
          return !Al(e);
        }).length &&
        Al(t) &&
        Si(r, or.fromTag('br'));
      var o = Zs.prevPosition(n.dom(), vu.before(r.dom()));
      return (
        F(Fl(t), function(e) {
          Si(r, e);
        }),
    ...
    Vl = function(e, t, n) {
      if (Al(n)) return Di(n), Al(t) && Kc(t), Zs.firstPositionIn(t.dom());
      var r = Zs.lastPositionIn(n.dom());
      return (
        F(Fl(t), function(e) {
          Ai(n, e);
        }),
    ...
    Hl = function(e, t) {
      return Lr(t, e) ? ((n = Ml(e, t)), A.from(n[n.length - 1])) : A.none();
      var n;
    },
    jl = function(e, t) {
      Zs.positionIn(e, t.dom())
        .map(function(e) {
          return e.getNode();
        })
        .map(or.fromDom)
    ...
    ql = function(e, t, n) {
      return (
        jl(!0, t), jl(!1, n), Hl(t, n).fold(d(Vl, e, t, n), d(Ul, e, t, n))
      );
    },
    $l = function(e, t, n, r) {
    ...
    Wl = function(t, n) {
      var e,
        r = or.fromDom(t.getBody());
      return (
        (e = Ol(r.dom(), n, t.selection.getRng()).bind(function(e) {
          return $l(r, n, e.from().block(), e.to().block());
        })).each(function(e) {
    ...
    Kl = function(e, t) {
      var n = or.fromDom(t),
        r = d(Pr, e);
      return Wi(n, yo, r).isSome();
    },
    Xl = function(e, t) {
      var n,
        r,
        o = Zs.prevPosition(e.dom(), vu.fromRangeStart(t)).isNone(),
        i = Zs.nextPosition(e.dom(), vu.fromRangeEnd(t)).isNone();
      return (
        !(Kl((n = e), (r = t).startContainer) || Kl(n, r.endContainer)) &&
        o &&
        i
      );
    },
    Yl = function(e) {
      ...
      return Xl(i, a)
        ...
        : ((n = i),
          ...
          Wa(
            [
              Cl(n, or.fromDom(o.startContainer)),
              Cl(n, or.fromDom(o.endContainer)),
            ],
            function(e, t) {
              return (
                !1 === Pr(e, t) &&
                (o.deleteContents(),
                $l(n, !0, e, t).each(function(e) {
                  r.setRng(e.toRange());
                }),
                !0)
              );
    ...
    Gl = function(e, t) {
      return !e.selection.isCollapsed() && Yl(e);
    },
    Jl = function(a) {
    ...
    Ql = function(e) {
      return Es(e).exists(mo);
    },
    Zl = function(e, t, n) {
      var r = z(Ml(or.fromDom(n.container()), t), lo),
        o = te(r).getOr(t);
      return Zs.fromPosition(e, o.dom(), n).filter(Ql);
    },
    ef = function(e, t) {
      return Es(t).exists(mo) || Zl(!0, e, t).isSome();
    },
    tf = function(e, t) {
      return (
        ((n = t), A.from(n.getNode(!0)).map(or.fromDom)).exists(mo) ||
        Zl(!1, e, t).isSome()
      );
      var n;
    },
    ...
    ff = function(e) {
      var t = e.container();
      return Bo.isText(t) && 0 === t.data.length;
    },
    df = function(e, t) {
      var n = hs(e, t);
      return Bo.isContentEditableFalse(n) && !Bo.isBogusAll(n);
    },
    mf = d(df, 0),
    gf = d(df, -1),
    pf = function(e, t) {
      return Bo.isTable(hs(e, t));
    },
    hf = d(pf, 0),
    vf = d(pf, -1),
    bf = Jl([
    ...
    yf = function(e, t, n, r) {
      var o = r.getNode(!1 === t);
      return Cl(or.fromDom(e), or.fromDom(n.getNode()))
        .map(function(e) {
          return Al(e) ? bf.remove(e.dom()) : bf.moveToElement(o);
        })
        .orThunk(function() {
          return A.some(bf.moveToElement(o));
        });
    },
    Cf = function(u, s, c) {
      return Zs.fromPosition(s, u, c).bind(function(e) {
        return (
          (a = e.getNode()),
          yo(or.fromDom(a)) || ho(or.fromDom(a))
            ? A.none()
            : ((t = u),
              (o = e),
              (i = function(e) {
                return fo(or.fromDom(e)) && !ps(r, o, t);
              }),
              ws(!(n = s), (r = c)).fold(function() {
                return ws(n, o).fold(q(!1), i);
              }, i)
                ? A.none()
                : s && Bo.isContentEditableFalse(e.getNode())
                ? yf(u, s, c, e)
                : !1 === s && Bo.isContentEditableFalse(e.getNode(!0))
                ? yf(u, s, c, e)
                : s && gf(c)
                ? A.some(bf.moveToPosition(e))
                : !1 === s && mf(c)
                ? A.some(bf.moveToPosition(e))
                : A.none())
        );
    ...
    xf = function(r, e, o) {
      return (
        ...
        (a = o.getNode(!1 === i)),
        (u = i ? 'after' : 'before'),
        Bo.isElement(a) && a.getAttribute('data-mce-caret') === u
          ? ((t = e),
            (n = o.getNode(!1 === e)),
            t && Bo.isContentEditableFalse(n.nextSibling)
              ? A.some(bf.moveToElement(n.nextSibling))
              : !1 === t && Bo.isContentEditableFalse(n.previousSibling)
              ? A.some(bf.moveToElement(n.previousSibling))
              : A.none()).fold(function() {
              return Cf(r, e, o);
            }, A.some)
          : Cf(r, e, o).bind(function(e) {
              return (
                (t = r),
                (n = o),
                e.fold(
                  function(e) {
                    return A.some(bf.remove(e));
                  },
                  function(e) {
                    return A.some(bf.moveToElement(e));
                  },
                  function(e) {
                    return ps(n, e, t)
                      ? A.none()
    ...
    Ef = function(e, t) {
      return (
        ...
        (o = (n = t).container()),
        (i = n.offset()),
        !1 === vu.isTextPosition(n) &&
        o === r.parentNode &&
        i > vu.before(r).offset()
          ? vu(t.container(), t.offset() - 1)
          : t
      );
      var n, r, o, i;
    },
    Sf = function(e) {
      return Oa(e.previousSibling)
        ? A.some(
            ((t = e.previousSibling),
            Bo.isText(t) ? vu(t, t.data.length) : vu.after(t)),
          )
        : e.previousSibling
        ? Zs.lastPositionIn(e.previousSibling)
        : A.none();
      var t;
    },
    kf = function(e) {
      return Oa(e.nextSibling)
        ? A.some(((t = e.nextSibling), Bo.isText(t) ? vu(t, 0) : vu.before(t)))
        : e.nextSibling
        ? Zs.firstPositionIn(e.nextSibling)
        : A.none();
      var t;
    },
    Tf = function(r, o) {
      return Sf(o)
        ...
        .orThunk(function() {
          return (
            ...
            Zs.prevPosition(e, n).fold(function() {
              return Zs.nextPosition(e, vu.after(t));
            }, A.some)
          );
          var e, t, n;
        });
      ...
      return kf(r)
        ...
        .orThunk(function() {
          return (
            (e = n),
            (t = r),
            Zs.nextPosition(e, vu.after(t)).fold(function() {
              return Zs.prevPosition(e, vu.before(t));
            }, A.some)
          );
          var e, t;
        });
    ...
    Rf = function(e, t, n) {
      return ((r = e), (o = t), (i = n), r ? Af(o, i) : Tf(o, i)).map(d(Ef, n));
      var r, o, i;
    },
    _f = function(t, n, e) {
      e.fold(
    ...
    Df = function(e, t) {
      return t && e.schema.getBlockElements().hasOwnProperty(sr(t));
    },
    Bf = function(e) {
      if (Al(e)) {
        var t = or.fromHtml('<br data-mce-bogus="1">');
        return _i(e), Ai(e, t), A.some(vu.before(t.dom()));
      }
      return A.none();
    },
    Of = function(e, t, l) {
      var n = Fr(e).filter(function(e) {
          return Bo.isText(e.dom());
        }),
        r = zr(e).filter(function(e) {
          return Bo.isText(e.dom());
        });
      return (
        Di(e),
        Wa([n, r, t], function(e, t, n) {
          var r,
            o,
            i,
            a,
          ...
          return (
            (o = s),
            (i = l),
            (a = Yn((r = u).data).length),
            r.appendData(o.data),
            Di(or.fromDom(o)),
            i && Nf(r, a),
            n.container() === s ? vu(u, c) : n
          );
        }).orThunk(function() {
          return (
            l &&
    ...
    Pf = function(e, t) {
      return (n = e.schema.getTextInlineElements()), (r = sr(t)), mr.call(n, r);
      var n, r;
    },
    Lf = function(t, n, e, r) {
      void 0 === r && (r = !0);
      var o,
        i = Rf(n, t.getBody(), e.dom()),
        a = Wi(
          e,
          d(Df, t),
          ((o = t.getBody()),
    ...
    If = function(a, u) {
      ...
      (r = xs(t ? 1 : -1, e, n)),
      (o = vu.fromRangeStart(r)),
      (i = or.fromDom(e)),
      !1 === t && gf(o)
        ? A.some(bf.remove(o.getNode(!0)))
        : t && mf(o)
        ? A.some(bf.remove(o.getNode()))
        : !1 === t && mf(o) && tf(i, o)
        ? nf(i, o).map(function(e) {
            return bf.remove(e.getNode());
          })
        : t && gf(o) && ef(i, o)
        ? rf(i, o).map(function(e) {
            return bf.remove(e.getNode());
          })
        : xf(e, t, o))
        .map(function(e) {
          return e.fold(
            ...
            (r = u),
            function(e) {
              var t = r ? vu.before(e) : vu.after(e);
    ...
    Mf = function(e, t) {
      ...
      return (
        !!Bo.isContentEditableFalse(r) &&
        ((n = or.fromDom(e.getBody())),
        F(ji(n, '.mce-offscreen-selection'), Di),
        Lf(e, t, or.fromDom(e.selection.getNode())),
        xl(e),
        !0)
      );
    },
    Ff = function(e, t) {
      return e.selection.isCollapsed() ? If(e, t) : Mf(e, t);
    },
    zf = function(e) {
      var t,
        n = (function(e, t) {
          for (; t && t !== e; ) {
            if (Bo.isContentEditableTrue(t) || Bo.isContentEditableFalse(t))
              return t;
            t = t.parentNode;
          }
          return null;
      ...
      return (
        Bo.isContentEditableTrue(n) &&
          e.dom.isBlock(n) &&
          e.dom.isEmpty(n) &&
          ((t = e.dom.create('br', { 'data-mce-bogus': '1' })),
          e.dom.setHTML(n, ''),
          n.appendChild(t),
          e.selection.setRng(vu.before(t).toRange())),
        !0
      );
    },
    Uf = Bo.isText,
    Vf = function(e) {
      return Uf(e) && e.data[0] === fa;
    },
    Hf = function(e) {
      return Uf(e) && e.data[e.data.length - 1] === fa;
    },
    jf = function(e) {
      return e.ownerDocument.createTextNode(fa);
    },
    qf = function(e, t) {
      return e
        ? (function(e) {
            if (Uf(e.previousSibling))
              return (
                Hf(e.previousSibling) || e.previousSibling.appendData(fa),
                e.previousSibling
              );
            if (Uf(e)) return Vf(e) || e.insertData(0, fa), e;
            var t = jf(e);
        ...
        : (function(e) {
            if (Uf(e.nextSibling))
              return (
                Vf(e.nextSibling) || e.nextSibling.insertData(0, fa),
                e.nextSibling
              );
            if (Uf(e)) return Hf(e) || e.appendData(fa), e;
            var t = jf(e);
            return (
              e.nextSibling
    ...
    Yf = function(n, e) {
      return e.fold(
        function(e) {
          Ju.remove(n.get());
          var t = $f(e);
          return n.set(t), A.some(vu(t, t.length - 1));
        },
        function(e) {
          return Zs.firstPositionIn(e).map(function(e) {
            if (Xf(e, n)) return vu(n.get(), 1);
            Ju.remove(n.get());
            var t = Kf(e, !0);
            return n.set(t), vu(t, 1);
          });
        },
        function(e) {
          return Zs.lastPositionIn(e).map(function(e) {
            if (Xf(e, n)) return vu(n.get(), n.get().length - 1);
            Ju.remove(n.get());
            var t = Kf(e, !1);
            return n.set(t), vu(t, t.length - 1);
          });
        },
        function(e) {
          Ju.remove(n.get());
          var t = Wf(e);
          return n.set(t), A.some(vu(t, 1));
        },
      );
    },
    Gf = function(e, t) {
    ...
    Zf = function(e, t, n) {
      var r = yl.normalizeForwards(n),
        o = Qf(t, r.container());
      return yl.findRootInline(e, o, r).fold(function() {
        return Zs.nextPosition(o, r)
          .bind(d(yl.findRootInline, e, o))
          .map(function(e) {
            return Jf.before(e);
          });
      }, A.none);
    ...
    td = function(e, t, n) {
      return yl.findRootInline(e, t, n).filter(d(ed, t));
    },
    nd = function(e, t, n) {
      var r = yl.normalizeBackwards(n);
      return td(e, t, r).bind(function(e) {
        return Zs.prevPosition(e, r).isNone() ? A.some(Jf.start(e)) : A.none();
      });
    },
    rd = function(e, t, n) {
      var r = yl.normalizeForwards(n);
      return td(e, t, r).bind(function(e) {
        return Zs.nextPosition(e, r).isNone() ? A.some(Jf.end(e)) : A.none();
      });
    },
    od = function(e, t, n) {
      var r = yl.normalizeBackwards(n),
    ...
    id = function(e) {
      return !1 === yl.isRtl(ud(e));
    },
    ad = function(e, t, n) {
      return Gf([Zf, nd, rd, od], [e, t, n]).filter(id);
    },
    ud = function(e) {
      return e.fold($, $, $, $);
    },
    ...
    ld = function(n, e, r, t, o, i) {
      return Wa(
        [yl.findRootInline(e, r, t), yl.findRootInline(e, r, o)],
        function(e, t) {
          return e !== t && yl.hasSameParentBlock(r, e, t)
            ? Jf.after(n ? e : t)
            : i;
        },
      ).getOr(i);
    ...
    fd = function(e, r) {
      return e.fold(q(!0), function(e) {
        return (n = r), !(sd((t = e)) === sd(n) && ud(t) === ud(n));
        var t, n;
      });
    },
    dd = function(e, t) {
      return e
        ? t.fold(j(A.some, Jf.start), A.none, j(A.some, Jf.after), A.none)
        : t.fold(A.none, j(A.some, Jf.before), A.none, j(A.some, Jf.end));
    },
    md = function(a, u, s, c) {
      var e = yl.normalizePosition(a, c),
        l = ad(u, s, e);
      return ad(u, s, e)
        .bind(d(dd, a))
        .orThunk(function() {
          return (
            ...
            (o = l),
            (e = c),
            (i = yl.normalizePosition(t, e)),
            Zs.fromPosition(t, r, i)
              .map(d(yl.normalizePosition, t))
              .fold(
                function() {
                  return o.map(cd);
                },
    ...
    yd = function(e, t, n) {
      var r = e ? 1 : -1;
      return (
        t.setRng(vu(n.container(), n.offset() + r).toRange()),
    ...
    Cd = function(e, t) {
      var n = t.selection.getRng(),
        r = e ? vu.fromRangeEnd(n) : vu.fromRangeStart(n);
      return (
        !!bd(t) &&
        (e && ya(r)
          ? yd(!0, t.selection, r)
          : !(e || !Ca(r)) && yd(!1, t.selection, r))
      );
    },
    xd = function(e, t) {
      ...
      move: function(a, u, s) {
        return function() {
          return (
            ...
            (e = s),
            (r = t.getBody()),
            (o = vu.fromRangeStart(t.selection.getRng())),
            (i = d(yl.isInlineTarget, t)),
            pd(e, i, r, o).bind(function(e) {
              return Ed(t, n, e);
            })).isSome()
          );
          var t, n, e, r, o, i;
            ...
            wd(a) &&
              ...
              (function(e, t) {
                if (
                  ...
                  var n = vu.fromRangeStart(e.selection.getRng());
                  vu.isTextPosition(n) &&
                    !1 === yl.isAtZwsp(n) &&
                    (xd(e, Ju.removeAndReposition(t.get(), n)), t.set(null));
                }
              })(a, u),
              (function(n, r, o, e) {
                if (r.selection.isCollapsed()) {
                  var t = z(e, n);
                  F(t, function(e) {
                    var t = vu.fromRangeStart(r.selection.getRng());
                    gd(n, r.getBody(), t).bind(function(e) {
                      return Ed(r, o, e);
                    });
                  });
                }
    ...
    Td = function(t, n) {
      return function(e) {
        return Yf(n, e)
          .map(function(e) {
            return kd.setCaretPosition(t, e), !0;
          })
          .getOr(!1);
      };
    },
    Ad = function(r, o, i, a) {
      ...
      r.undoManager.ignore(function() {
        ...
        r.selection.setRng(
          ...
          gd(s, u, vu.fromRangeStart(r.selection.getRng()))
            .map(vd)
            .map(Td(r, o));
      }),
        r.nodeChanged();
    ...
    Rd = function(n, r, i, o) {
      var e,
        t,
        a = ((e = n.getBody()), (t = o.container()), gs(t, e) || e),
        u = d(yl.isInlineTarget, n),
        s = gd(u, a, o);
      return s
        .bind(function(e) {
          return i
            ? e.fold(q(A.some(vd(e))), A.none, q(A.some(hd(e))), A.none)
            : e.fold(A.none, q(A.some(hd(e))), A.none, q(A.some(vd(e))));
        })
        .map(Td(n, r))
        .getOrThunk(function() {
          var t = Zs.navigate(i, a, o),
            e = t.bind(function(e) {
              return gd(u, a, e);
            });
            ...
            ? yl
                ...
                .map(function(e) {
                  return (
                    (o = e),
                    !!Wa(
                      [Zs.firstPositionIn(o), Zs.lastPositionIn(o)],
                      function(e, t) {
                        var n = yl.normalizePosition(!0, e),
                          r = yl.normalizePosition(!1, t);
                        return Zs.nextPosition(o, n)
                          .map(function(e) {
                            return e.isEqual(r);
                          })
                          .getOr(!0);
                      },
                    ).getOr(!0) && (Lf(n, i, or.fromDom(e)), !0)
                  );
                  var o;
                })
                .getOr(!1)
            : e
                .bind(function(e) {
                  return t.map(function(e) {
                    return i ? Ad(n, r, o, e) : Ad(n, r, e, o), !0;
                  });
                })
                .getOr(!1);
        });
    ...
    _d = function(e, t, n) {
      if (e.selection.isCollapsed() && !1 !== e.settings.inline_boundaries) {
        var r = vu.fromRangeStart(e.selection.getRng());
        return Rd(e, t, n, r);
      }
      return !1;
    },
    Dd = Sr('start', 'end'),
    Bd = Sr('rng', 'table', 'cells'),
    Od = Jl([{ removeTable: ['element'] }, { emptyCells: ['cells'] }]),
    Pd = function(e, t) {
      return Gi(or.fromDom(e), 'td,th', t);
    },
    Ld = function(e, t) {
      return Xi(e, 'table', t);
    },
    Id = function(e) {
      return !1 === Pr(e.start(), e.end());
    },
    Md = function(e, n) {
      return Ld(e.start(), n).bind(function(t) {
        return Ld(e.end(), n).bind(function(e) {
          return Pr(t, e) ? A.some(t) : A.none();
        });
      });
    },
    Fd = function(e) {
    ...
    Vd = function(e, t) {
      ...
      return ((n = t),
      (r = a),
      (o = Pd(n.startContainer, r)),
      (i = Pd(n.endContainer, r)),
      Wa([o, i], Dd)
        .filter(Id)
        .filter(function(e) {
          return Ud(r, e);
        ...
        return Md((t = e), a).map(function(e) {
          return Bd(t, e, Fd(e));
        });
        var t;
      });
    ...
    jd = function(n) {
      return ((r = n),
      Wa(
        [Hd(r.cells(), r.rng().start()), Hd(r.cells(), r.rng().end())],
        function(e, t) {
        ...
        return e.length === t.length
          ? Od.removeTable(n.table())
          : Od.emptyCells(e);
      });
      var r;
    },
    qd = function(e, t) {
      return Vd(e, t).bind(jd);
    },
    $d = function(e) {
      var t = [];
    ...
    Gd = function(e) {
      return ji(e, 'td[data-mce-selected],th[data-mce-selected]');
    },
    Jd = function(e, t) {
      var n = Gd(t),
        r = Yd(e);
    ...
    Qd = Jd,
    Zd = function(e) {
      return Jd(Wd(e.selection.getSel()), or.fromDom(e.getBody()));
    },
    em = function(e, t) {
      return F(t, Kc), e.selection.setCursorLocation(t[0].dom(), 0), !0;
    },
    tm = function(e, t) {
      return Lf(e, !1, t), !0;
    },
      ...
      return om(e, t)
        .fold(
          function() {
            return (
              (t = n),
              qd(e, r).map(function(e) {
                return e.fold(d(tm, t), d(em, t));
              })
            );
            var t;
          },
    ...
    am = function(u, s, c, l, f) {
      return Zs.navigate(c, u.getBody(), f)
        .bind(function(e) {
          return (
            (r = l),
            (o = c),
            (i = f),
            (a = e),
            Zs.firstPositionIn(r.dom())
              .bind(function(t) {
                return Zs.lastPositionIn(r.dom()).map(function(e) {
                  return o
              ...
              : ((t = l),
                (n = e),
                om(s, or.fromDom(n.getNode())).map(function(e) {
                  return !1 === Pr(e, t);
                }))
          );
          var t, n, r, o, i, a;
    ...
    um = function(a, u, s, e) {
      var c = vu.fromRangeStart(a.selection.getRng());
      return rm(s, e).bind(function(e) {
        return Al(e)
          ? im(a, e)
          : ((t = a),
            (n = s),
            ...
            (o = e),
            (i = c),
            Zs.navigate(r, t.getBody(), i).bind(function(e) {
              return rm(n, or.fromDom(e.getNode())).map(function(e) {
                return !1 === Pr(e, o);
              });
            }));
        var t, n, r, o, i;
        ...
        .fold(
          ...
          function(e) {
            return (
              ...
              (r = s),
              (o = e),
              (i = vu.fromRangeStart(t.selection.getRng())),
              Al(o) ? im(t, o) : am(t, r, n, o, i)
            );
            var t, n, r, o, i;
          },
        )
    ...
    cm = function(e, t) {
      var n,
        ...
        i,
        a,
        u = or.fromDom(e.selection.getStart(!0)),
        s = Zd(e);
      return e.selection.isCollapsed() && 0 === s.length
        ? sm(e, t, u)
        : ((n = e),
          (r = u),
          (o = or.fromDom(n.getBody())),
          (i = n.selection.getRng()),
          0 !== (a = Zd(n)).length ? em(n, a) : nm(n, o, i, r));
    },
    lm = mc.isEq,
    fm = function(e, t, n) {
    ...
    dm = function(t, e, n, r) {
      ...
      return (
        ...
        ((e = t.dom.getParent(e, function(e) {
          return !!fm(t, e, n) || e.parentNode === o || !!pm(t, e, n, r, !0);
        })),
        pm(t, e, n, r))
      );
    },
        ...
        if ('undefined' == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              ...
              if (
                (!o || n.exact) &&
                !lm(u, mc.normalizeStyleValue(e, mc.replaceVars(c[a], i), a))
              )
                return;
            }
        } else
    ...
    hm = {
      ...
      match: function(e, t, n, r) {
        ...
        return r
          ...
          : ((r = e.selection.getNode()),
            !!dm(e, r, t, n) ||
              !((o = e.selection.getStart()) === r || !dm(e, o, t, n)));
      },
        ...
        return (
          ...
          r.dom.getParent(
            ...
            function(e) {
              var t, n;
              for (t = 0; t < o.length; t++)
                (n = o[t]), !u[n] && pm(r, e, n, i) && ((u[n] = !0), a.push(n));
            },
            r.dom.getRoot(),
          ),
          a
      ...
      matchesUnInheritedFormatSelector: fm,
    },
    vm = function(e, t) {
      ...
      return (
        t === r && Bo.isText(t)
          ? 0 < n &&
            ...
            ((t = (r = vm(t, n)).previousSibling),
            n < o
              ? ((t = r = vm(r, (o -= n)).previousSibling),
          ...
          : (Bo.isText(t) &&
            ...
            Bo.isText(r) &&
              0 < o &&
              o < r.nodeValue.length &&
              (o = (r = vm(r, o).previousSibling).nodeValue.length)),
    ...
    Em = function(e, t, n) {
      ...
      var r,
        o = e.dom,
        i = e.selection;
      if (xm(t)) Lf(e, !1, or.fromDom(t), n);
      else {
        var a = i.getRng(),
          u = o.getParent(t, o.isBlock),
          s = ((r = wm(t)) &&
            r.nodeValue.charAt(0) === ym &&
            r.deleteData(0, 1),
          r);
        a.startContainer === s &&
          0 < a.startOffset &&
    ...
    Sm = function(e, t, n) {
      ...
      var r = e.dom,
        o = e.selection;
      if (t) Em(e, t, n);
      else if (!(t = Vu(e.getBody(), o.getStart())))
        for (; (t = r.get(Cm)); ) Em(e, t, !1);
    },
    km = function(e, t, n) {
      var r = e.dom,
        o = r.getParent(n, d(mc.isTextBlock, e));
      o && r.isEmpty(o)
    ...
    Am = function(e, t) {
      var n,
        ...
        r);
      return Tm(o, o.ownerDocument.createTextNode(ym));
    },
    Rm = function(i) {
      i.on('mouseup keydown', function(e) {
        ...
        (t = i),
          ...
          (8 !== n && 46 !== n) ||
            !r.isCollapsed() ||
            r.getStart().innerHTML !== ym ||
            Sm(t, Vu(o, r.getStart())),
          (37 !== n && 39 !== n) || Sm(t, Vu(o, r.getStart()));
      });
    },
    _m = function(e, t) {
      return (
        e.schema.getTextInlineElements().hasOwnProperty(sr(t)) &&
        !Uu(t.dom()) &&
        !Bo.isBogus(t.dom())
      );
    },
    ...
    Om = function(r, o) {
      var t,
        e = or.fromDom(r.getBody()),
        n = or.fromDom(r.selection.getStart()),
        i = z(
          ((t = Ml(n, e)),
          X(t, lo).fold(q(t), function(e) {
            return t.slice(0, e);
          })),
          Dm,
        );
      return ne(i)
        .map(function(e) {
          var t,
            n = vu.fromRangeStart(r.selection.getRng());
          return !(
            !wl(o, n, e.dom()) ||
            (Uu((t = e).dom()) && xm(t.dom())) ||
            (Bm(o, r, e, i), 0)
    ...
    Pm = function(e, t) {
      return !!e.selection.isCollapsed() && Om(e, t);
    },
    Lm = Bo.isContentEditableTrue,
    ...
    zm = function(e, t, n) {
      var r = xs(1, e.getBody(), t),
        o = vu.fromRangeStart(r),
        i = o.getNode();
      if (Im(i)) return Mm(1, e, i, !o.isAtEnd(), !1);
      var a = o.getNode(!0);
      if (Im(a)) return Mm(1, e, a, !1, !1);
      var u = e.dom.getParent(o.getNode(), function(e) {
        return Im(e) || Lm(e);
      });
      return Im(u) ? Mm(1, e, u, !1, n) : null;
    },
    Um = function(e, t, n) {
    ...
    Vm = function(e, t, n, r, o, i) {
      var a,
        u,
        s = Mm(r, e, i.getNode(!o), o, !0);
      if (t.collapsed) {
        var c = t.cloneRange();
        o
      ...
      return (
        ...
        (a = e.dom),
        (u = n),
        Bo.isText(u) && 0 === u.data.length && a.remove(u),
        !0
      );
    },
    Hm = function(e, t) {
      return (function(e, t) {
        ...
        if (!Bo.isText(n.commonAncestorContainer)) return !1;
        var r = t ? pu.Forwards : pu.Backwards,
          o = Hs(e.getBody()),
          i = d(Ss, o.next),
          a = d(Ss, o.prev),
          u = t ? i : a,
          s = t ? mf : gf,
          c = Ns(r, e.getBody(), n),
          l = yl.normalizePosition(t, u(c));
        if (!l) return !1;
        if (s(l)) return Vm(e, n, c.getNode(), r, t, l);
        var f = u(l);
        return !!(f && s(f) && ks(l, f)) && Vm(e, n, c.getNode(), r, t, f);
      })(e, t);
    },
    jm = function(e, t) {
    ...
    Gm = function(e) {
      return Wm(e, 'body_id', 'tinymce');
    },
    Jm = function(e) {
      return Wm(e, 'body_class', '');
    },
    Qm = function(e) {
    ...
    ag = function(e) {
      return Gt.explode(e.getParam('font_size_style_values', ''));
    },
    ug = function(e) {
      return Gt.explode(e.getParam('font_size_classes', ''));
    },
    sg = function(e) {
    ...
    bg = function(o) {
      return function(r, e) {
        return A.from(e)
          ...
          .filter(lr)
          .bind(function(e) {
            return vg(o, r, e.dom()).or(
              ((t = o), (n = e.dom()), A.from(hi.DOM.getStyle(n, t, !0))),
            );
            var t, n;
          })
          .getOr('');
    ...
    Cg = function(e) {
      return Zs.firstPositionIn(e.getBody()).map(function(e) {
        var t = e.container();
    ...
    Ag = function(e, t, n, r, o) {
      ...
      if (
        ...
        r && Bo.isBr(o) && t && e.isEmpty(u))
      )
        return A.some(gu(o.parentNode, e.nodeIndex(o)));
      for (i = new oo(o, u); (s = i[r ? 'prev' : 'next']()); ) {
        if (
          'false' === e.getContentEditableParent(s) ||
          ((l = f), va((c = s)) && !1 === Eg(c, l, Uu))
        )
          return A.none();
        if (Bo.isText(s) && 0 < s.nodeValue.length)
          return !1 === Sg(s, f, 'A')
            ? A.some(gu(s, r ? s.nodeValue.length : 0))
            : A.none();
        if (e.isBlock(s) || d[s.nodeName.toLowerCase()]) return A.none();
        a = s;
      }
      return n && a ? A.some(gu(a, 0)) : A.none();
    },
    Rg = function(e, t, n, r) {
      var o,
        i,
      ...
      if (
        ...
        (l = Bo.isElement(o) && i === o.childNodes.length),
        ...
        return A.none();
      if (
        (Bo.isElement(o) && i > o.childNodes.length - 1 && (c = !1),
        Bo.isDocument(o) && ((o = g), (i = 0)),
        o === g)
      ) {
        if (c && (u = o.childNodes[0 < i ? i - 1 : 0])) {
          if (va(u)) return A.none();
          if (s[u.nodeName] || kg(u)) return A.none();
        }
        if (o.hasChildNodes()) {
          if (
            ((i = Math.min(!c && 0 < i ? i - 1 : i, o.childNodes.length - 1)),
            (o = o.childNodes[i]),
            (i = Bo.isText(o) && l ? o.data.length : 0),
          ...
          if (o.hasChildNodes() && !1 === kg(o)) {
            a = new oo((u = o), g);
            do {
              if (Bo.isContentEditableFalse(u) || va(u)) {
                p = !1;
                break;
              }
      ...
      return (
        ...
        p ? A.some(gu(o, i)) : A.none()
      );
    },
    _g = function(e, t) {
      var n = t.collapsed,
        r = t.cloneRange(),
        o = gu.fromRangeStart(t);
      return (
        Rg(e, n, !0, r).each(function(e) {
          (n && gu.isAbove(o, e)) || r.setStart(e.container(), e.offset());
        }),
        n ||
    ...
    Pg = function(e, t) {
      var n = or.fromTag('br');
      Si(or.fromDom(t), n), e.undoManager.add();
    },
    Lg = function(e, t) {
      Ig(e.getBody(), t) || ki(or.fromDom(t), or.fromTag('br'));
      var n = or.fromTag('br');
      ki(or.fromDom(t), n),
        Dg(e.dom, e.selection, n.dom()),
    ...
    Ug = function(e, t) {
      var n,
        ...
        o,
        i = ((n = e),
        (r = d(yl.isInlineTarget, n)),
        (o = vu.fromRangeStart(n.selection.getRng())),
        gd(r, n.getBody(), o).filter(Fg));
      i.isSome() ? i.each(d(zg, e)) : Og(e, t);
    },
    Vg = (Jl([
      { before: ['element'] },
      { on: ['element', 'offset'] },
    ...
    Hg = nr.detect().browser,
    jg = function(e, t) {
      var n = fr(t) ? Rc(t).length : Hr(t).length + 1;
      return n < e ? n : e < 0 ? 0 : e;
    },
    qg = function(e) {
      return Vg(
        e.start(),
        jg(e.soffset(), e.start()),
        e.finish(),
        jg(e.foffset(), e.finish()),
      );
    },
    $g = function(e, t) {
      return Lr(e, t) || Pr(e, t);
    },
    Wg = function(t) {
      return function(e) {
        return $g(t, e.start()) && $g(t, e.finish());
      };
    },
    Kg = function(e) {
      return !0 === e.inline || Hg.isIE();
    },
    Xg = function(e) {
      return Vg(
        or.fromDom(e.startContainer),
        e.startOffset,
        or.fromDom(e.endContainer),
        e.endOffset,
      );
    },
    Yg = function(e) {
    ...
    Gg = function(e) {
      var t,
        n = ((t = e.dom().ownerDocument.defaultView), or.fromDom(t));
      return Yg(n.dom()).filter(Wg(e));
    },
    Jg = function(e, t) {
      return A.from(t)
        .filter(Wg(e))
    ...
    Zg = function(e) {
      return (e.bookmark ? e.bookmark : A.none())
        .bind(d(Jg, or.fromDom(e.getBody())))
        .bind(Qg);
    },
    ep = function(e) {
      var t = Kg(e) ? Gg(or.fromDom(e.getBody())) : A.none();
    ...
    op = function(e) {
      return z(W(e.selection.getSelectedBlocks(), or.fromDom), function(e) {
        return (
          !rp(e) &&
          !Mr(e)
            .map(rp)
  ...
  function lp(s) {
    ...
    var r = function(e) {
      ...
      e = function(e, n) {
        (n = n || 'exec'),
          ap(e, function(t, e) {
            ap(e.toLowerCase().split(','), function(e) {
              c[n][e] = t;
            });
          });
      },
    ...
    e({
      ...
      'JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone': function(
        ...
        var t = e.substring(7);
        'full' === t && (t = 'justify'),
          ap('left,center,right,justify'.split(','), function(e) {
      ...
      FontName: function(e, t, n) {
        var r, o;
        (o = n),
          (r = s).formatter.toggle('fontname', { value: wg(r, o) }),
          r.nodeChanged();
      },
      FontSize: function(e, t, n) {
        var r, o;
        (o = n),
          (r = s).formatter.toggle('fontsize', { value: wg(r, o) }),
          r.nodeChanged();
      },
        ...
        function() {
          return xg((t = s)).fold(
            function() {
              return Cg(t)
                .map(function(e) {
                  return yg.getFontFamily(t.getBody(), e);
                })
                .getOr('');
            },
            function(e) {
        ...
        function() {
          return xg((t = s)).fold(
            function() {
              return Cg(t)
                .map(function(e) {
                  return yg.getFontSize(t.getBody(), e);
                })
                .getOr('');
            },
            function(e) {
  ...
  dp.isNative = function(e) {
    return !!fp[e.toLowerCase()];
  };
  var mp,
    gp = function(n) {
      return (
        n._eventDispatcher ||
          (n._eventDispatcher = new dp({
            scope: n,
    ...
    pp = {
      fire: function(e, t, n) {
        ...
        if (((t = gp(this).fire(e, t, n)), !1 !== n && this.parent))
          for (var r = this.parent(); r && !t.isPropagationStopped(); )
            r.fire(e, t, !1), (r = r.parent());
        return t;
      },
      on: function(e, t, n) {
        return gp(this).on(e, t, n);
      },
      off: function(e, t) {
        return gp(this).off(e, t);
      },
      once: function(e, t) {
        return gp(this).once(e, t);
      },
      hasEventListeners: function(e) {
        return gp(this).has(e);
      },
    },
    hp = function(e, t) {
    ...
    Ep = function(e, t, n) {
      var r, o;
      Vi(e, t) && !1 === n
        ? ((o = t), Ii((r = e)) ? r.dom().classList.remove(o) : Fi(r, o), Ui(r))
        : n && zi(e, t);
    },
    Sp = function(e, t) {
      Ep(or.fromDom(e.getBody()), 'mce-content-readonly', t),
        t
          ...
          : ((e.readonly = !1),
            ...
            Np(e, 'StyleWithCSS', !1),
            Np(e, 'enableInlineTableEditing', !1),
            Np(e, 'enableObjectResizing', !1),
            e.focus(),
            e.nodeChanged());
    },
    kp = function(e) {
    ...
    _p = function(i, a) {
      ...
      if ((i.delegates || (i.delegates = {}), !i.delegates[a] && !i.removed))
        if (((e = Ap(i, a)), i.settings.event_root)) {
          if (
            (mp ||
              ((mp = {}),
              i.editorManager.on('removeEditor', function() {
                var e;
                if (!i.editorManager.activeEditor && mp) {
                  for (e in mp) i.dom.unbind(Ap(i, e));
                  mp = null;
                }
              })),
            mp[a])
    ...
    Dp = {
      bindPendingEventDelegates: function() {
        var t = this;
        Gt.each(t._pendingNativeEvents, function(e) {
          _p(t, e);
        });
      },
      toggleNativeEvent: function(e, t) {
        ...
        'focus' !== e &&
          ...
          (t
            ...
            : n.initialized &&
              (n.dom.unbind(Ap(n, e), e, n.delegates[e]),
      ...
      unbindAllNativeEvents: function() {
        var e,
          ...
          r = t.dom;
        if (t.delegates) {
          for (e in t.delegates) t.dom.unbind(Ap(t, e), e, t.delegates[e]);
          delete t.delegates;
        }
        !t.inline &&
          n &&
    ...
    Ip = Gt.makeMap('alt,ctrl,shift,meta,access');
  function Mp(i) {
    var a = {},
      r = [],
      u = function(e) {
        var t,
          n,
          r = {};
        for (n in (Op(Pp(e, '+'), function(e) {
          e in Ip
            ? (r[e] = !0)
            : /^[0-9]{2,}$/.test(e)
            ? (r.keyCode = parseInt(e, 10))
            : ((r.charCode = e.charCodeAt(0)),
              (r.keyCode = Lp[e] || e.toUpperCase().charCodeAt(0)));
        }),
        (t = [r.keyCode]),
        Ip))
          r[n] ? t.push(n) : (r[n] = !1);
      ...
      s = function(e, t, n, r) {
        var o;
        return (
          ((o = Gt.map(Pp(e, '>'), u))[o.length - 1] = Gt.extend(
            o[o.length - 1],
            { func: n, scope: r || i },
          )),
          Gt.extend(o[0], { desc: i.translate(t), subpatterns: o.slice(1) })
        );
      },
      o = function(e, t) {
        return (
    ...
    i.on('keyup keypress keydown', function(t) {
      ...
      (this.add = function(e, n, r, o) {
        ...
        return (
          ...
          Op(Pp(Gt.trim(e.toLowerCase())), function(e) {
            var t = s(e, n, r, o);
            a[t.id] = t;
          }),
          !0
  ...
  var Fp = function(e) {
    ...
    zp = function(t) {
      ...
      A.from(n.activeElement).map(or.fromDom)).filter(function(e) {
    ...
    Up = function(t, e) {
      return ((n = e),
      n.collapsed
        ? A.from(ja(n.startContainer, n.startOffset)).map(or.fromDom)
        : A.none()).bind(function(e) {
        return bo(e) ? A.some(e) : !1 === Lr(t, e) ? A.some(t) : A.none();
      });
      var n;
    },
    Vp = function(t, e) {
      Up(or.fromDom(t.getBody()), e)
        .bind(function(e) {
          return Zs.firstPositionIn(e.dom());
        })
        .fold(
          function() {
    ...
    jp = function(e) {
      var t,
        n = e.getBody();
      return n && ((t = or.fromDom(n)), Fp(t) || zp(t).isSome());
    },
    qp = function(e) {
      return e.inline
        ? jp(e)
        : (t = e).iframeElement && Fp(or.fromDom(t.iframeElement));
      var t;
    },
    $p = function(e) {
      ...
      e.removed ||
        (t
          ...
          : (function(t) {
              ...
              if (t.$.contains(r, u)) return Hp(u), Vp(t, o), $p(t);
              t.bookmark !== undefined &&
                !1 === qp(t) &&
                np(t).each(function(e) {
                  t.selection.setRng(e), (o = e);
                }),
                n || (me.opera || Hp(r), t.getWin().focus()),
                (me.gecko || n) && (Hp(r), Vp(t, o)),
                $p(t);
            })(e));
    },
    Kp = qp,
    ...
    eh = function(e, t, n) {
      var r,
        ...
        d,
        m,
        g = or.fromDom(e.getBody()),
        p = e.inline
          ? g
          : ((r = g), or.fromDom(r.dom().ownerDocument.documentElement)),
        h = ((o = e.inline),
        (a = t),
        (u = n),
        (s = (i = p).dom().getBoundingClientRect()),
        {
          x: a - (o ? s.left + i.dom().clientLeft + Zp(i) : 0),
          y: u - (o ? s.top + i.dom().clientTop + Qp(i) : 0),
        });
      return (
        (l = h.x),
        (f = h.y),
    ...
    th = function(e) {
      ...
      return ((t = n), A.from(t).map(or.fromDom))
        .map(function(e) {
          return Lr(Ir(e), e);
        })
        .getOr(!1);
  ...
  function rh(r) {
    ...
    return (
      ...
      }),
      {
        windows: o,
        open: function(e, t) {
          r.editorManager.setActive(r), ep(r);
          var n = i().open(e, t, s);
          return u(n), n;
        },
  ...
  var oh = {},
    ...
    ah = {
      ...
      add: function(e, t) {
        var n = oh[e];
        for (var r in (n || (oh[e] = n = {}), t)) n[r] = t[r];
        this.setCode(e);
      },
      translate: function(e) {
        var t = oh[ih] || {},
          n = function(e) {
            return Gt.is(e, 'function')
          ...
          r = function(e) {
            return '' === e || null === e || Gt.is(e, 'undefined');
          },
          o = function(e) {
            return (e = n(e)), Gt.hasOwn(t, e) ? n(t[e]) : e;
          };
        if (r(e)) return '';
        if (Gt.is(e, 'object') && Gt.hasOwn(e, 'raw')) return n(e.raw);
        if (Gt.is(e, 'array')) {
          var i = e.slice(1);
          e = o(e[0]).replace(/\{([0-9]+)\}/g, function(e, t) {
            return Gt.hasOwn(i, t) ? n(i[t]) : e;
          });
        }
    ...
    sh = function(e, t) {
      var n = (function(e, t) {
        for (var n in uh.urls)
          if (uh.urls[n] + '/plugin' + t + '.js' === e) return n;
        return null;
      })(t, e.suffix);
      return n
        ? ah.translate(['Failed to load plugin: {0} from url {1}', n, t])
        : ah.translate(['Failed to load plugin url: {0}', t]);
    },
    ch = function(e, t) {
    ...
    dh = {
      ...
      pluginInitError: function(e, t, n) {
        var r = ah.translate(['Failed to initialize plugin: {0}', t]);
        fh(r, n), lh(e, r);
      },
      uploadError: function(e, t) {
        lh(e, ah.translate(['Failed to upload image: {0}', t]));
      },
      displayError: lh,
      initError: fh,
    },
    ...
    gh = Ei.ThemeManager;
  function ph() {
    return new (ae.getOrDie('XMLHttpRequest'))();
  }
  function hh(u, s) {
    var r = {},
      n = function(e, r, o, t) {
        var i, n;
        (i = ph()).open('POST', s.url),
  ...
  var vh = function(e) {
    ...
    yh = function(a) {
      return new ge(function(e) {
        ...
        for (
          o = t.length, n = new (ae.getOrDie('Uint8Array'))(o), r = 0;
          r < n.length;
          r++
        )
          n[r] = t.charCodeAt(r);
    ...
    xh = function(n) {
      return new ge(function(e) {
        var t = new (ae.getOrDie('FileReader'))();
    ...
    kh = function(e) {
      return e ? re(e.getElementsByTagName('img')) : [];
    },
    Th = 0,
    Ah = {
      uuid: function(e) {
    ...
    var n,
      ...
      (o = function(e) {
        ...
        return (
          ...
          (n = e.name || t),
          {
            ...
            blob: q(e.blob),
            base64: q(e.base64),
            blobUri: q(e.blobUri || se.createObjectURL(e.blob)),
            uri: q(e.uri),
          }
        );
      }),
      {
        ...
        removeByUri: function(t) {
          n = z(n, function(e) {
            return e.blobUri() !== t || (se.revokeObjectURL(e.blobUri()), !1);
          });
        },
        destroy: function() {
          F(n, function(e) {
            se.revokeObjectURL(e.blobUri());
          }),
            (n = []);
        },
      }),
                  ...
                  m(function(e) {
                    var t = W(e, function(e, t) {
                      ...
                      return (
                        e.status && fg(u)
                          ? b(n, e.url)
                          : e.error && dh.uploadError(u, e.error),
      ...
      x = function(t) {
        return (
          ...
          (0 !== t.getAttribute('src').indexOf('data:') || sg(u)(t))
        );
      },
      w = function() {
        var o, i, a;
        return (
          ...
          r.findAll(u.getBody(), x).then(
            m(function(e) {
              return (
                (e = z(e, function(e) {
                  return 'string' != typeof e || (dh.displayError(u, e), !1);
                })),
                F(e, function(e) {
  ...
  var _h = function(e, t) {
    ...
    Dh = function(t, e, n) {
      return (
        (r = Il(or.fromDom(n), or.fromDom(e))),
        X(r, function(e) {
          return _h(t, e.dom());
        }).isSome()
      );
    ...
    Bh = function(e, t) {
      if (Bo.isText(t)) {
        ...
        if (
          /^\s+$/.test(t.nodeValue) &&
          (!t.nextSibling || _h(e, t.nextSibling))
        )
          return !0;
      }
      return !1;
    ...
    Oh = function(e) {
      ...
      if (
        ...
        v &&
          ...
          p.isValidChild(l, f.toLowerCase()) && !Dh(h, b, v)))
      ) {
        for (
          ...
          if (
            ((y = h),
            (C = v),
            Bo.isText(C) || (Bo.isElement(C) && !_h(y, C) && !cc(C)))
          ) {
            if (Bh(h, v)) {
    ...
    Ph = function(e) {
      e.settings.forced_root_block && e.on('NodeChange', d(Oh, e));
    },
    Lh = function(t) {
      return qr(t).fold(q([t]), function(e) {
        return [t].concat(Lh(e));
      });
    },
    Ih = function(t) {
      return $r(t).fold(q([t]), function(e) {
        return 'br' === sr(e)
          ? Fr(e)
              .map(function(e) {
                return [t].concat(Ih(e));
              })
              .getOr([])
          : [t].concat(Ih(e));
      });
        ...
        [
          ...
          Bo.isText(a)
            ? 0 === u
              ? A.some(or.fromDom(a))
              : A.none()
            : A.from(a.childNodes[u]).map(or.fromDom)),
          ((t = e),
          (n = t.endContainer),
          (r = t.endOffset),
          Bo.isText(n)
            ? r === n.data.length
              ? A.some(or.fromDom(n))
              : A.none()
            : A.from(n.childNodes[r - 1]).map(or.fromDom)),
        ],
        function(e, t) {
          var n = V(Lh(o), d(Pr, e)),
            r = V(Ih(o), d(Pr, t));
    ...
    Fh = function(e, t, n, r) {
      ...
      do {
        if (3 === n.nodeType && 0 !== Gt.trim(n.nodeValue).length)
    ...
    'onselectionchange' in i.getDoc() ||
      i.on('NodeChange Click MouseUp KeyUp Focus', function(e) {
        ...
        (n = {
          ...
          ('nodechange' !== e.type && Ng(n, r)) || i.fire('SelectionChange'),
          (r = n);
      }),
      ...
      i.on('SelectionChange', function() {
        ...
        !e ||
          (!me.range && i.selection.isCollapsed()) ||
          (zh(i) &&
            !(function(e) {
              var t, n;
              if (
      ...
      i.on('MouseUp', function(e) {
        !e.isDefaultPrevented() &&
          ...
          ('IMG' === i.selection.getNode().nodeName
            ? be.setEditorTimeout(i, function() {
                i.nodeChanged();
              })
            : i.nodeChanged());
      }),
  ...
  var Vh,
    ...
    qh = function(e, t) {
      return (
        (n = (u = e).inline ? jh(u.getBody()) : { left: 0, top: 0 }),
        (a = (i = e).getBody()),
        (r = i.inline
          ...
          pageX:
            (o = (function(e, t) {
              if (t.target.ownerDocument !== e.getDoc()) {
                var n = jh(e.getContentAreaContainer()),
                  r = ((i = (o = e).getBody()),
    ...
    $h = Bo.isContentEditableFalse,
    Wh = Bo.isContentEditableTrue,
    Kh = function(e) {
    ...
    Xh = function(u, s) {
      return function(e) {
        if (0 === e.button) {
          var t = V(s.dom.getParents(e.target), Ya($h, Wh)).getOr(null);
          if (((i = s.getBody()), $h((a = t)) && a !== i)) {
    ...
    Gh = function(e) {
      (e.dragging = !1), (e.element = null), Kh(e.ghost);
    },
    Jh = function(e) {
      var t,
        n,
      ...
      (t = hi.DOM),
        ...
        (r = function(e) {
          ...
          if (p.dragging) {
            var g = ((f = p),
            { pageX: (d = qh(h, e)).pageX - f.relX, pageY: d.pageY + 5 });
            (c = p.ghost),
              (l = h.getBody()),
        ...
        (u = c),
        (i = function() {
          u.dragging && s.fire('dragend'), Gh(u);
        }),
        (s = e).on('mousedown', n),
        e.on('mousemove', r),
        e.on('mouseup', o),
        ...
        (n = e).on('drop', function(e) {
          var t =
            'undefined' != typeof e.clientX
              ...
              : null;
          ($h(t) || $h(n.dom.getContentEditableParent(t))) &&
            e.preventDefault();
        });
    },
    Zh = function(e) {
  ...
  ((Hh = Vh || (Vh = {}))[(Hh.Up = -1)] = 'Up'), (Hh[(Hh.Down = 1)] = 'Down');
  var ev = function(o, i, a, e, u, t) {
      var n,
        s,
        c = 0,
        l = [],
        r = function(e) {
          var t, n, r;
          for (
            r = Zh([e]), -1 === o && (r = r.reverse()), t = 0;
            t < r.length;
            t++
          )
            if (((n = r[t]), !a(n, s))) {
              if ((0 < l.length && i(n, $t.last(l)) && c++, (n.line = c), u(n)))
                return !0;
              l.push(n);
            }
        };
      return (
        (s = $t.last(t.getClientRects())) &&
          (r((n = t.getNode())),
          (function(e, t, n, r) {
            for (; (r = ms(r, e, La, t)); ) if (n(r)) return;
          })(o, e, r, n)),
        l
      );
    },
    tv = d(ev, Vh.Up, Ua, Va),
    nv = d(ev, Vh.Down, Va, Ua),
    rv = function(n) {
      return function(e) {
        return (t = n), e.line > t;
        var t;
    ...
    lv = function(e, o) {
      return $t.reduce(e, function(e, t) {
        var n, r;
        return (
          (n = Math.min(uv(e, o), sv(e, o))),
          (r = Math.min(uv(t, o), sv(t, o))),
          cv(o, t)
            ? t
            : cv(o, e)
            ? e
    ...
    fv = function(e, t, n, r) {
      for (; (r = av(r, e, La, t)); ) if (n(r)) return;
    },
    dv = function(e, t, n) {
      var r,
        o,
        ...
        s,
        c,
        l = Zh(z(re(e.getElementsByTagName('*')), rs)),
        f = z(l, function(e) {
      ...
      return (r = lv(f, t)) &&
        (r = lv(
          ...
          (s = []).push((u = r)),
          fv(Vh.Up, a, d(c, Ua), u.node),
          fv(Vh.Down, a, d(c, Va), u.node),
          s),
          t,
        )) &&
        rs(r.node)
        ? ((i = t), { node: (o = r).node, before: uv(o, i) < sv(o, i) })
        : null;
    },
    mv = function(i, a, e) {
      return (
    ...
    gv = function(t) {
      var e = Oi(function() {
        if (!t.removed && t.selection.getRng().collapsed) {
          var e = Um(t, t.selection.getRng(), !1);
          t.selection.setRng(e);
        }
      }, 0);
      t.on('focus', function() {
    ...
    hv = Bo.isContentEditableTrue,
    vv = Bo.isContentEditableFalse,
    bv = function(e, t) {
      for (var n = e.getBody(); t && t !== n; ) {
        if (hv(t) || vv(t)) return t;
        t = t.parentNode;
      }
      return null;
    },
    yv = function(g) {
      var p,
        ...
        b = function(e, t) {
          return (
            (t = xs(e, a, t)),
            -1 === e ? vu.fromRangeStart(t) : vu.fromRangeEnd(t)
          );
        },
        n = function(e) {
          return va(e) || wa(e) || Na(e);
        },
        y = function(e) {
        ...
        c = function(e, t) {
          ...
          if (e.collapsed) {
            if (!y(e))
              if (!1 === t) {
                if (((c = b(-1, e)), rs(c.getNode(!0))))
                  return v(-1, c.getNode(!0), !1, !1);
                if (rs(c.getNode()))
                  return v(-1, c.getNode(), !c.isAtEnd(), !1);
              } else {
                if (((c = b(1, e)), rs(c.getNode())))
                  return v(1, c.getNode(), !c.isAtEnd(), !1);
                if (rs(c.getNode(!0))) return v(1, c.getNode(!0), !1, !1);
              }
            return null;
          }
          return (
                ...
                vv(n)
                  ? ((l = f = n.cloneNode(!0)),
                    (s = g.fire('ObjectSelected', {
                      ...
                      ? null
                      : ((r = Yi(or.fromDom(g.getBody()), '#' + h).fold(
                          function() {
                            return d([]);
                          },
                          function(e) {
                        ...
                        o.addRange(e),
                        F(
                          ji(or.fromDom(g.getBody()), '*[data-mce-selected]'),
                          function(e) {
                            xr(e, 'data-mce-selected');
                          },
                        ),
        ...
        l = function() {
          p &&
            ...
            Yi(or.fromDom(g.getBody()), '#' + h).each(Di),
            (p = null)),
            Yi(or.fromDom(g.getBody()), '#' + h).each(Di),
            (p = null);
        },
        ...
        me.ceFalse &&
          ((function() {
            g.on('mouseup', function(e) {
              var t = s();
              t.collapsed && eh(g, e.clientX, e.clientY) && u(zm(g, t, !1));
            }),
              g.on('click', function(e) {
                var t;
                (t = bv(g, e.target)) &&
                  (vv(t) && (e.preventDefault(), g.focus()),
                  hv(t) && g.dom.isChildOf(t, g.selection.getNode()) && l());
              }),
            ...
            var n,
              ...
              i = function(e, t) {
                ...
                return (
                  !(!o || !g.dom.isChildOf(o, i) || !1 !== vv(bv(g, o))) ||
                  (o &&
                    ((n = o),
                    (r = i),
                    !(
            ...
            (r = !1),
              ...
              n.on('touchend', function(e) {
                var t = bv(n, e.target);
                vv(t) && (r || (e.preventDefault(), c(Fm(n, t))));
              }),
              g.on('mousedown', function(e) {
                ...
                if (
                  ...
                  !1 !== eh(g, e.clientX, e.clientY)
                )
                  if ((t = bv(g, n)))
                    vv(t)
                      ? (e.preventDefault(), c(Fm(g, t)))
                      : (l(),
                        (hv(t) && e.shiftKey) ||
                          mv(e.clientX, e.clientY, g.selection.getRng()) ||
                          (C(),
                          g.selection.placeCaretAt(e.clientX, e.clientY)));
                  else if (!1 === rs(n)) {
                    l(), C();
                    var r = dv(a, e.clientX, e.clientY);
              ...
              g.on('keypress', function(e) {
                pv.modifierPressed(e) ||
                  (e.keyCode, vv(g.selection.getNode()) && e.preventDefault());
              }),
              ...
              g.on('copy', function(e) {
                var t,
                  n = e.clipboardData;
                if (!e.isDefaultPrevented() && e.clipboardData && !me.ie) {
                  var r = (t = g.dom.get(h))
          ...
          )),
        {
          ...
          showBlockCaretContainer: function(e) {
            e.hasAttribute('data-mce-caret') &&
              (Ea(e), u(s()), g.selection.scrollIntoView(e[0]));
          },
          hideFakeCaret: C,
          destroy: function() {
            o.destroy(), (p = null);
        ...
        for (
          ...
          if ((_ < t.index && j(O(e.substr(_, t.index - _))), (n = t[6])))
            ...
            ':' === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)),
              (c = n in s),
              R && E[n] && 0 < D.length && D[D.length - 1].name === n && I(n);
            var F = xv(k, t[8]);
            if (null !== F) {
              if ('all' === F) {
                (_ = Cv(U, e, S.lastIndex)), (S.lastIndex = _);
                continue;
              }
              f = !1;
            }
  ...
  var Nv = wv,
    Ev = function(e, t) {
      ...
      for (
        ...
        (r = f.lastIndex),
          (o = i[0].length),
          (n = a[i[1]] ? r : Nv.findEndTag(d, l, r)),
          (l = l.substring(0, r - o) + l.substring(n)),
          (f.lastIndex = r - o);
      return da(l);
    },
    Sv = { trimExternal: Ev, trimInternal: Ev },
    kv = 0,
    Tv = 2,
    Av = 1,
    Rv = function(g, p) {
    ...
    _v = function(e) {
      return Bo.isElement(e)
        ? e.outerHTML
        : Bo.isText(e)
        ? Wo.encodeRaw(e.data, !1)
        : Bo.isComment(e)
        ? '\x3c!--' + e.data + '--\x3e'
        : '';
    },
    ...
    Bv = function(e) {
      return z(W(re(e.childNodes), _v), function(e) {
        return 0 < e.length;
      });
    },
    Ov = function(e, t) {
    ...
    Fv = function(e) {
      var t = or.fromTag(
        'body',
        Pv.get().getOrThunk(function() {
          var e = H.document.implementation.createHTMLDocument('undo');
          return Pv.set(A.some(e)), e;
        }),
      );
      return sa(t, Mv(e)), F(ji(t, '*[data-mce-bogus]'), Bi), t.dom().innerHTML;
    },
    zv = function(n) {
      var e, t, r;
      return (
        ...
        -1 !==
        (t = (r = J(e, function(e) {
          var t = Sv.trimInternal(n.serializer, e);
          return 0 < t.length ? [t] : [];
        })).join('')).indexOf('</iframe>')
          ? Lv(r)
          : Iv(t)
    ...
    return (
      ...
      (o = {
        ...
        beforeChange: function() {
          f() && (s = Fu.getUndoBookmark(u.selection));
        },
        add: function(e, t) {
          var n,
            r,
          ...
          (e.bookmark = Fu.getUndoBookmark(u.selection)),
        ...
        undo: function() {
          ...
          return (
            ...
            0 < c &&
              ((e = l[--c]), Uv(u, e, !0), d(!0), u.fire('undo', { level: e })),
            e
          );
        },
        redo: function() {
          ...
          return (
            c < l.length - 1 &&
              ((e = l[++c]), Uv(u, e, !1), d(!0), u.fire('redo', { level: e })),
            e
          );
        },
        clear: function() {
        ...
        hasUndo: function() {
          return 0 < c || (o.typing && l[0] && !Vv(zv(u), l[0]));
        },
        hasRedo: function() {
      ...
      r.collapsed ||
        ...
        Kv(
          Wv(Wv(n, t), function(e) {
            return (
              t(e.previousSibling) && -1 !== $t.indexOf(n, e.previousSibling)
            );
          }),
          function(e) {
            var t, n;
  ...
  var Xv = function(e, t) {
    ...
    tb = function(e, t, n, r, o) {
      var i = or.fromDom(t),
        a = or.fromDom(e.create(r, o)),
        u = n ? Vr(i) : Ur(i);
      return Ri(a, u), n ? (Si(i, a), Ti(a, i)) : (ki(i, a), Ai(a, i)), a.dom();
    },
    nb = function(e, t, n, r) {
      return (
    ...
    rb = function(e, n, r, o, i) {
      ...
      if (
        ...
        !(
          Jv((l = o), (f = n).inline) ||
          Jv(l, f.block) ||
          (f.selector ? Bo.isElement(l) && c.is(l, f.selector) : void 0) ||
      ...
      if ('all' !== n.remove)
        for (
          Gv(n.styles, function(e, t) {
            (e = mc.normalizeStyleValue(y, mc.replaceVars(e, r), t)),
              'number' == typeof t && ((t = e), (i = 0)),
              (n.remove_similar || !i || Jv(mc.getStyle(y, i, t), e)) &&
                y.setStyle(o, t, ''),
              (u = 1);
          }),
            u &&
            ...
            (b
              ? h === v.getRoot() &&
                ((g.list_block && Jv(m, g.list_block)) ||
                  Gv(Gt.grep(m.childNodes), function(e) {
                    mc.isValid(d, b, e.nodeName.toLowerCase())
                      ? p
                        ? p.appendChild(e)
                        : ((p = eb(v, e, b)),
              ...
              : v.isBlock(m) &&
                !v.isBlock(h) &&
                (nb(v, m, !1) ||
                  nb(v, m.firstChild, !0, 1) ||
                  m.insertBefore(v.create('br'), m.firstChild),
                nb(v, m, !0) ||
                  nb(v, m.lastChild, !1, 1) ||
    ...
    ib = function(s, c, l, e, f) {
      var t,
        ...
        i = function(e) {
          var n,
            ...
            (o = l),
            (i = f),
            Gv(mc.getParents(n.dom, t.parentNode).reverse(), function(e) {
              var t;
              a ||
                '_start' === e.id ||
                '_end' === e.id ||
                ((t = hm.matchNode(n, e, r, o, i)) &&
                  !1 !== t.split &&
                  (a = e));
            }),
            a);
        ...
        g = function(e) {
          ...
          if (
            ...
            (t = Gt.grep(e.childNodes)),
            a && !i)
          )
            for (n = 0, r = d.length; n < r && !rb(s, d[n], l, e, e); n++);
          if (m.deep && t.length) {
        ...
        o = function(e) {
          ...
          if (((e = Sc(s, e, d, !0)), m.split)) {
            if (((e = bm(e)), (t = Zv(s, e, !0)) !== (n = Zv(s, e)))) {
              if (
            ...
            Gv(e, function(e) {
              g(e),
                Bo.isElement(e) &&
                  ...
                  e.parentNode &&
                  'underline' === mc.getTextDecoration(u, e.parentNode) &&
                  rb(
                    s,
                    {
                      deep: !1,
      ...
      if (e)
        ...
        !u.select('td[data-mce-selected],th[data-mce-selected]').length
          ? (function(e, t, n, r) {
              ...
              if (c)
                if (u) {
                  ...
                  var p = Sc(e, g, e.formatter.get(t), !0);
                  (p = bm(p)), e.formatter.remove(t, n, p), d.moveToBookmark(a);
                } else {
                  l = Vu(e.getBody(), c);
                  var h = Nm(!1).dom(),
                    v = Am(m, h);
          ...
          : ((t = Fu.getPersistentBookmark(s.selection, !0)),
            o(r.getRng()),
            r.moveToBookmark(t),
            m.inline &&
              hm.match(s, c, l, r.getStart()) &&
              mc.moveStart(u, r, r.getRng()),
            s.nodeChanged());
      else {
        e = r.getNode();
        for (
          var h = 0, v = d.length;
          h < v && (!d[h].ceFalseOverride || !rb(s, d[h], l, e, e));
          h++
        );
      }
    },
    ab = Gt.each,
    ub = function(e) {
      return e && 1 === e.nodeType && !cc(e) && !Uu(e) && !Bo.isBogus(e);
    },
    sb = function(e, t) {
      var n;
      for (n = e; n; n = n[t]) {
        if (3 === n.nodeType && 0 !== n.nodeValue.length) return e;
        if (1 === n.nodeType && !cc(n)) return n;
      }
      return e;
    },
    cb = function(e, t, n) {
      ...
      if (
        ...
        return (
          e.remove(n),
          Gt.each(Gt.grep(n.childNodes), function(e) {
            t.appendChild(e);
          }),
          t
        );
    ...
    lb = function(e, t, n) {
      ab(e.childNodes, function(e) {
        ub(e) && (t(e) && n(e), e.hasChildNodes() && lb(e, t, n));
      });
    },
    fb = function(n, e) {
      return d(function(e, t) {
        return !(!t || !mc.getStyle(n, t, e));
      }, e);
    },
    db = function(r, e, t) {
      return d(
    ...
    pb = function(n, e, r, o) {
      ab(e, function(t) {
        ab(n.dom.select(t.inline, o), function(e) {
          ub(e) && ob(n, t, r, e, t.exact ? e : null);
        }),
          (function(r, e, t) {
            if (e.clear_child_styles) {
              var n = e.links ? '*:not(a)' : '*';
              ab(r.select(n, t), function(n) {
                ub(n) &&
                  ab(e.styles, function(e, t) {
                    r.setStyle(n, t, '');
                  });
              });
            }
    ...
    hb = function(e, t, n, r) {
      (t.styles.color || t.styles.textDecoration) &&
        (Gt.walk(r, d(gb, e), 'childNodes'), gb(e, r));
    },
    vb = function(e, t, n, r) {
      t.styles &&
        ...
        lb(
          r,
          fb(e, 'fontSize'),
          db(e, 'backgroundColor', mc.replaceVars(t.styles.backgroundColor, n)),
        );
    },
    bb = function(e, t, n, r) {
      ('sub' !== t.inline && 'sup' !== t.inline) ||
        (lb(r, fb(e, 'fontSize'), db(e, 'fontSize', '')),
        e.remove(e.select('sup' === t.inline ? 'sub' : 'sup', r), !0));
    },
    yb = function(e, t, n, r) {
      r &&
        !1 !== t.merge_siblings &&
        ((r = cb(e, mc.getNonWhiteSpaceSibling(r), r)),
        (r = cb(e, r, mc.getNonWhiteSpaceSibling(r, !0))));
    },
    Cb = function(t, n, r, o, i) {
      (hm.matchNode(t, i.parentNode, r, o) && ob(t, n, o, i)) ||
        (n.merge_with_parents &&
          t.dom.getParent(i.parentNode, function(e) {
            if (hm.matchNode(t, e, r, o)) return ob(t, n, o, i), !0;
          }));
    },
    xb = Gt.each,
    wb = function(g, p, h, r) {
          ...
          if (((e = e || b), n)) {
            if (
              ...
              xb(e.styles, function(e, t) {
                i.setStyle(n, t, mc.replaceVars(e, h));
              }),
              e.styles)
            ) {
            ...
            xb(e.attributes, function(e, t) {
              i.setAttrib(n, t, mc.replaceVars(e, h));
            }),
              xb(e.classes, function(e) {
                (e = mc.replaceVars(e, h)),
        ...
        a = function(s, e, t, c) {
          ...
          (l = b.inline || b.block),
            ...
            Tc(s, e, function(e) {
              var a,
                u = function(e) {
                  ...
                  if (b.wrapper && hm.matchNode(g, e, p, h)) a = 0;
                  else {
                    if (
                      m &&
                      !r &&
            ...
            !0 === b.links &&
              xb(d, function(e) {
                var t = function(e) {
                  'A' === e.nodeName && y(e, b), xb(Gt.grep(e.childNodes), t);
                };
                t(e);
              }),
            xb(d, function(e) {
          ...
          if (r)
            ...
            !(function(e, t, n) {
              ...
              (a = (r = c.getRng(!0)).startOffset),
                ...
                (o = Vu(e.getBody(), c.getStart())) && (i = wm(o));
              var l,
                f,
                d = /[^\s\u00a0\u00ad\u200b\ufeff]/;
              s &&
            ...
            g.settings.forced_root_block ||
              ...
              wb(g, v[0].defaultBlock),
              g.selection.setRng(el(g.selection.getRng())),
              (e = Fu.getPersistentBookmark(g.selection, !0)),
              a(i, Sc(g, n.getRng(), v)),
              b.styles && hb(i, b, h, u),
              n.moveToBookmark(e),
              mc.moveStart(i, n, n.getRng()),
              g.nodeChanged();
          }
          Xv(p, g);
        }
    ...
    Sb = function(e, t, n, r, o) {
      ...
      null === t.get() &&
        ...
        a.on('NodeChange', function(n) {
          var r = mc.getParents(a.dom, n.element),
            o = {};
          (r = Gt.grep(r, function(e) {
            return 1 === e.nodeType && !e.getAttribute('data-mce-bogus');
          })),
            Eb(i.get(), function(e, n) {
              Eb(r, function(t) {
                return a.formatter.matchNode(t, n, {}, e.similar)
                  ? (u[n] ||
                    ...
                    (o[n] = e),
                    !1)
                  : !hm.matchesUnInheritedFormatSelector(a, t, n) && void 0;
              });
            }),
            Eb(u, function(e, t) {
              o[t] ||
    ...
    Rb = function(e, t) {
      var n,
        ...
        g = function(e) {
          ...
          return (
            ...
            (t = Ab.create(o.name)),
            (n = t),
            (r = o).classes.length && Ab.addClass(n, r.classes.join(' ')),
            Ab.setAttribs(n, r.attrs),
            t
          );
        },
        p = function(n, e, t) {
          ...
          return (
            ...
            t &&
              (r || (r = Ab.create('div')).appendChild(n),
              Gt.each(t, function(e) {
                var t = g(e);
                r.insertBefore(t, n);
              })),
            p(r, e, o && o.siblings)
      ...
      return e && e.length
        ? ((o = e[0]),
          (n = g(o)),
          (r = Ab.create('div')).appendChild(p(n, e.slice(1), o.siblings)),
          r)
        : '';
    },
    _b = function(e) {
    ...
    Db = function(e) {
      return e && 'string' == typeof e
        ? ((e = (e = e.split(/\s*,\s*/)[0]).replace(
          ...
          Gt.map(e.split(/(?:>|\s+(?![^\[\]]+\]))/), function(e) {
            var t = Gt.map(e.split(/(?:~\+|~|\+)/), _b),
              n = t.pop();
    ...
    Bb = function(n, e) {
      ...
      return 'preview' in e && !1 === (u = e.preview)
        ...
        : ((t = e.block || e.inline || 'span'),
          (i = Db(e.selector)).length
            ? (i[0].name || (i[0].name = t), (t = e.selector), (r = Rb(i, n)))
            : (r = Rb([t], n)),
          (o = Ab.select(t, r)[0] || r.firstChild),
          Tb(e.styles, function(e, t) {
            (e = c(e)) && Ab.setStyle(o, t, e);
          }),
          Tb(e.attributes, function(e, t) {
            (e = c(e)) && Ab.setAttrib(o, t, e);
          }),
          Tb(e.classes, function(e) {
            (e = c(e)), Ab.hasClass(o, e) || Ab.addClass(o, e);
          }),
          n.fire('PreviewFormats'),
          Ab.setStyles(r, { position: 'absolute', left: -65535 }),
          n.getBody().appendChild(r),
          (a = Ab.getStyle(n.getBody(), 'fontSize', !0)),
          (a = /px$/.test(a) ? parseInt(a, 10) : 0),
          Tb(u.split(' '), function(e) {
            var t = Ab.getStyle(o, e, !0);
            if (
              !(
                ('background-color' === e &&
                  /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) &&
                  ((t = Ab.getStyle(n.getBody(), e, !0)),
                  '#ffffff' === Ab.toHex(t).toLowerCase())) ||
                ('color' === e && '#000000' === Ab.toHex(t).toLowerCase())
              )
            ) {
  ...
  function Lb(e) {
    ...
    return (
      ...
      Rm(e),
      {
        ...
        apply: d(Nb.applyFormat, e),
        remove: d(ib, e),
        toggle: d(Ob, e, o),
        match: d(hm.match, e),
        matchAll: d(hm.matchAll, e),
        matchNode: d(hm.matchNode, e),
        canApply: d(hm.canApply, e),
        formatChanged: d(Sb, e, i),
        getCssText: d(Bb, e),
      }
    );
  }
  var Ib,
    ...
    function() {
      ...
      for (var n = {}, r = 0; r < e.length; r++) {
        var o = e[r];
        for (var i in o) Mb.call(o, i) && (n[i] = Ib(n[i], o[i]));
      }
      return n;
    }),
    zb = {
        ...
        t.addAttributeFilter('data-mce-tabindex', function(e, t) {
          ...
          t.addNodeFilter('noscript', function(e) {
            for (var t, n = e.length; n--; )
              (t = e[n].firstChild) && (t.value = Wo.decode(t.value));
          }),
          ...
          (l = e) && l.hasEventListeners('PreProcess') && !f.no_events
            ? ((o = t),
              ...
              (a = H.document.implementation).createHTMLDocument &&
                ...
                Gt.each('BODY' === o.nodeName ? o.childNodes : [o], function(
                  e,
                ) {
    ...
    Hb = function(e, t) {
      ...
      t.convert_fonts_to_spans &&
        Vb(e, r, Gt.explode(t.font_size_legacy_values)),
        (n = r),
    ...
    Kb = (function() {
      ...
      return (
        (a.create = function(e, t) {
          var n, r;
          if (((n = new a(e, $b[e] || 1)), t)) for (r in t) n.attr(r, t[r]);
          return n;
        }),
        ...
        (a.prototype.getAll = function(e) {
          var t,
            n = [];
          for (t = this.firstChild; t; t = Wb(t, this))
            t.name === e && n.push(t);
          return n;
        }),
        (a.prototype.empty = function() {
          var e, t, n;
          if (this.firstChild) {
            for (e = [], n = this.firstChild; n; n = Wb(n, this)) e.push(n);
            for (t = e.length; t--; )
              (n =
                e[
                  t
    ...
    Xb = function(e, t, n, r) {
      (e.padd_empty_with_br || t.insert) && n[r.name]
        ? (r.empty().append(new Kb('br', 1)).shortEnded = !0)
        : (r.empty().append(new Kb('#text', 3)).value = '\xa0');
    },
    Yb = function(e) {
      return Gb(e, '#text') && '\xa0' === e.firstChild.value;
    },
    Gb = function(e, t) {
      return (
        e &&
      ...
      p.remove_trailing_brs &&
        e.addNodeFilter('br', function(e, t, n) {
          var r,
            ...
            l,
            f = e.length,
            d = Gt.extend({}, h.getBlockElements()),
            ...
            if (
              ...
              o &&
                ...
                Jb(h, m, g, i) &&
                  ...
                  (c.removeEmpty ? i.remove() : c.paddEmpty && Xb(p, n, d, i)));
            } else {
              for (
                a = o;
                i &&
              ...
              a === i &&
                ...
                (((l = new Kb('#text', 3)).value = '\xa0'), o.replace(l));
            }
        }),
  ...
  function oy(k, T) {
    ...
    var B = function(e) {
      ...
      e = {
        ...
        parse: function(e, a) {
          ...
          t = Nv(
            {
              ...
              text: function(e, t) {
                ...
                f ||
                  ((e = e.replace(x, ' ')),
                  Qb(d.lastChild, l) && (e = e.replace(y, ''))),
                  0 !== e.length &&
              ...
              start: function(e, t, n) {
                ...
                if ((n = h ? T.getElementRule(e) : {})) {
                  ...
                  n.paddEmpty && (Yb(d) || Jb(T, g, b, d)) && Xb(k, a, l, d),
                    (d = d.parent);
                }
              },
            },
          ...
          var S = (d = new Kb(a.context || k.root_name, 11));
          if (
            (t.parse(e),
            h &&
              m.length &&
              (a.context
                ...
                : (function(e) {
                    ...
                    for (
                      d = ey('tr,td,th,tbody,thead,tfoot,table'),
    ...
    return Zb(e, k), jb.register(e, k), e;
  }
  var iy = function(e, t, n) {
    ...
    ay = function(e, t, n) {
      var r = da(n.getInner ? t.innerHTML : e.getOuterHTML(t));
      return n.selection || Co(or.fromDom(t)) ? r : Gt.trim(r);
    },
    uy = function(e, t, n) {
      var r = n.selection ? Fb({ forced_root_block: !1 }, n) : n,
        o = e.parse(t, r);
      return zb.trimTrailingBr(o), o;
    },
    sy = function(e, t, n, r, o) {
      ...
      return (
        (a = e),
        (s = c),
        !(u = o).no_events && a ? vp(a, Fb(u, { content: s })).content : s
      );
    };
  function cy(e, t) {
    var a,
      ...
      r = ((a = e),
      (n = ['data-mce-selected']),
      (s = (u = t) && u.dom ? u.dom : hi.DOM),
      (c = u && u.schema ? u.schema : ri(a)),
      ...
      zb.register(l, a, s),
      {
        ...
        serialize: function(e, t) {
          var n = Fb({ format: 'html' }, t || {}),
            r = Ub.process(u, e, n),
            o = ay(s, r, n),
            i = uy(l, o, n);
          return 'tree' === n.format ? i : sy(u, a, c, i, n);
        },
        addRules: function(e) {
  ...
  function ly(e) {
    return { getBookmark: d(uc, e), moveToBookmark: d(sc, e) };
  }
  (ly || (ly = {})).isBookmarkNode = cc;
  var fy,
    dy,
    my = ly,
        ...
        O = function(e) {
          ...
          (t = e.screenX - d),
            ...
            (_(u) && !1 !== a.settings.resize_img_proportional
              ? !pv.modifierPressed(e)
              : pv.modifierPressed(e) || (_(u) && f[2] * f[3] != 0)) &&
              (T(t) > T(n)
                ? ((C = A(y * b)), (y = A(C / b)))
                : ((y = A(C / b)), (C = A(y * b)))),
    ...
    by = function(e, t, n) {
      ...
      if (
        ...
        !u.isDefaultPrevented() && Bo.isElement(t))
      ) {
    ...
    yy = function(d, e) {
      te(gu.fromRangeStart(e).getClientRects()).each(function(e) {
        var t,
          n,
          r,
          o,
        ...
        try {
          ...
          r = (function(e, n, t) {
            ...
            if (
              ...
              0 <
                (i = (i = Gt.toArray(o.getClientRects())).sort(function(e, t) {
                  return (
    ...
    Ey = Sr('element', 'width', 'rows'),
    Sy = Sr('element', 'cells'),
    ky = Sr('x', 'y'),
    Ty = function(e, t) {
      var n = parseInt(Cr(e, t), 10);
      return isNaN(n) ? 1 : n;
    },
    Ay = function(e) {
      return U(
    ...
    Ry = function(e, t) {
      for (var n = e.rows(), r = 0; r < n.length; r++)
        for (var o = n[r].cells(), i = 0; i < o.length; i++)
          if (Pr(o[i], t)) return A.some(ky(i, r));
      return A.none();
    },
    _y = function(e, t, n, r, o) {
      for (var i = [], a = e.rows(), u = n; u <= o; u++) {
        var s = a[u].cells(),
          c = t < r ? s.slice(t, r + 1) : s.slice(r, t + 1);
        i.push(Sy(a[u].element(), c));
      }
      return i;
    },
    Dy = function(e) {
      var o = Ey(aa(e), 0, []);
      return (
        F(ji(e, 'tr'), function(n, r) {
          F(ji(n, 'td,th'), function(e, t) {
            !(function(e, t, n, r, o) {
              for (
                var i = Ty(o, 'rowspan'),
                  a = Ty(o, 'colspan'),
      ...
      return (
        (n = W((t = e).rows(), function(e) {
          var t = W(e.cells(), function(e) {
              var t = ua(e);
              return xr(t, 'colspan'), xr(t, 'rowspan'), t;
            }),
            n = aa(e.element());
          return Ri(n, t), n;
        })),
    ...
    Oy = function(l, e, t) {
      return Ry(l, e).bind(function(c) {
        return Ry(l, t).map(function(e) {
          return (
            (t = l),
            (r = e),
            (o = (n = c).x()),
            ...
            (a = r.x()),
            (u = r.y()),
            (s = i < u ? _y(t, o, i, a, u) : _y(t, o, u, a, i)),
            Ey(t.element(), Ay(s), s)
          );
          var t, n, r, o, i, a, u, s;
        });
    ...
    Py = function(n, t) {
      return V(n, function(e) {
        return 'li' === sr(e) && Mh(e, t);
      }).fold(q([]), function(e) {
        return ((t = n),
        V(t, function(e) {
          return 'ul' === sr(e) || 'ol' === sr(e);
        }))
          .map(function(e) {
            return [or.fromTag('li'), or.fromTag(sr(e))];
          })
          .getOr([]);
        var t;
      });
    ...
    Ly = function(e, t) {
      var n,
        r = or.fromDom(t.commonAncestorContainer),
        o = Ml(r, e),
        i = z(o, function(e) {
          return fo(e) || co(e);
        }),
    ...
    Fy = function(e, o) {
      return ((t = e), (n = o[0]), Xi(n, 'table', d(Pr, t)))
        .bind(function(e) {
          var t = o[0],
            n = o[o.length - 1],
            r = Dy(e);
          return Oy(r, t, n).map(function(e) {
            return Ny([By(e)]);
          });
        })
        .getOrThunk(Iy);
    ...
    zy = function(e, t) {
      ...
      return 0 < o.length
        ? Fy(e, o)
        : ((n = e), 0 < (r = t).length && r[0].collapsed ? Iy() : My(n, r[0]));
    },
    Uy = function(e, t) {
      if (
        (void 0 === t && (t = {}),
    ...
    Hy = function(e, t, n, r, o) {
      ...
      return A.from(i)
        .map(or.fromDom)
        .map(function(e) {
          return r && t.collapsed ? e : jr(e, o(e, a)).getOr(e);
        })
        .bind(function(e) {
          return lr(e) ? A.some(e) : Mr(e);
        })
        .map(function(e) {
          return e.dom();
        })
    ...
    jy = function(e, t, n) {
      return Hy(e, t, !0, n, function(e, t) {
        return Math.min(e.dom().childNodes.length, t);
      });
    },
    qy = function(e, t, n) {
      return Hy(e, t, !1, n, function(e, t) {
        return 0 < t ? t - 1 : t;
      });
    },
    $y = function(e, t) {
      for (var n = e; e && Bo.isText(e) && 0 === e.length; )
    ...
    Xy = function(e) {
      return (
        !(!e || !e.ownerDocument) &&
        Lr(or.fromDom(e.ownerDocument), or.fromDom(e))
      );
    },
    Yy = function(u, s, e, c) {
      var n,
        ...
        m = function() {
          ...
          if (c.bookmark !== undefined && !1 === Kp(c)) {
            var i = np(c);
            if (i.isSome())
              return i
                .map(function(e) {
        ...
        i = function(e, t) {
          ...
          if (
            (o = e) &&
            (Ky(o) || (Xy(o.startContainer) && Xy(o.endContainer)))
          ) {
            var o,
              i = Ky(e) ? e : null;
            if (i) {
        ...
        p = {
              ...
              (t = m())
                ? ((r = t.startContainer),
                  ...
                  3 === r.nodeType &&
                    3 === o.nodeType &&
                    ((r =
                      r.length === i ? $y(r.nextSibling, !0) : r.parentNode),
                    (o = 0 === a ? $y(o.previousSibling, !1) : o.parentNode),
                    r && r === o))
                    ? r
                    : n && 3 === n.nodeType
                    ? n.parentNode
          ...
          getRng: m,
          getStart: function(e) {
            return jy(c.getBody(), m(), e);
          },
          getEnd: function(e) {
            return qy(c.getBody(), m(), e);
          },
          getSelectedBlocks: function(e, t) {
            return (function(e, t, n, r) {
              ...
              if (
                ((i = e.getRoot()),
                (n = e.getParent(n || jy(i, t, t.collapsed), e.isBlock)),
                (r = e.getParent(r || qy(i, t, t.collapsed), e.isBlock)),
                n && n !== i && a.push(n),
                n && r && n !== r)
              )
          ...
          placeCaretAt: function(e, t) {
            return i(xy(e, t, c.getDoc()));
          },
          getBoundingClientRect: function() {
            var e = m();
            return e.collapsed
              ? vu.fromRangeStart(e).getClientRects()[0]
  ...
  ((dy = fy || (fy = {}))[(dy.Br = 0)] = 'Br'),
    ...
    (dy[(dy.Eol = 3)] = 'Eol');
  var Gy = function(e, t) {
      return e === pu.Backwards ? t.reverse() : t;
    },
    Jy = function(e, t, n, r) {
      for (
        var o, i, a, u, s, c, l = Hs(n), f = r, d = [];
        f &&
        ((s = l), (c = f), (o = t === pu.Forwards ? s.next(c) : s.prev(c)));

      ) {
        if (Bo.isBr(o.getNode(!1)))
          return t === pu.Forwards
            ? {
                positions: Gy(t, d).concat([o]),
                breakType: fy.Br,
                breakAt: A.some(o),
              }
            : { positions: Gy(t, d), breakType: fy.Br, breakAt: A.some(o) };
        if (o.isVisible()) {
          if (e(f, o)) {
            var m = ((i = t),
            (a = f),
            (u = o),
            Bo.isBr(u.getNode(i === pu.Forwards))
              ? fy.Br
              : !1 === ps(a, u)
              ? fy.Block
              : fy.Wrap);
            return { positions: Gy(t, d), breakType: m, breakAt: A.some(o) };
          }
          d.push(o), (f = o);
        } else f = o;
      }
      return { positions: Gy(t, d), breakType: fy.Eol, breakAt: A.none() };
    },
    Qy = function(n, r, o, e) {
      return r(o, e)
        .breakAt.map(function(e) {
          var t = r(o, e).positions;
          return n === pu.Backwards ? t.concat(e) : [e].concat(t);
        })
        .getOr([]);
    },
    Zy = function(e, i) {
      return U(
        ...
        function(e, o) {
          return e.fold(
            ...
            function(r) {
              return Wa(
                [te(r.getClientRects()), te(o.getClientRects())],
                function(e, t) {
    ...
    eC = function(t, e) {
      return te(e.getClientRects()).bind(function(e) {
        return Zy(t, e.left);
      });
    },
    tC = d(Jy, gu.isAbove, -1),
    nC = d(Jy, gu.isBelow, 1),
    rC = d(Qy, -1, tC),
    oC = d(Qy, 1, nC),
    iC = Bo.isContentEditableFalse,
    aC = Ha,
    uC = function(e, t, n, r) {
      var o = e === pu.Forwards,
        i = o ? mf : gf;
      if (!r.collapsed) {
        var a = aC(r);
        if (iC(a)) return Mm(e, t, a, e === pu.Backwards, !0);
      }
      var u = pa(r.startContainer),
        s = Ns(e, t.getBody(), r);
      if (i(s)) return Fm(t, s.getNode(!o));
      var c = yl.normalizePosition(o, n(s));
      if (!c) return u ? r : null;
      if (i(c)) return Mm(e, t, c.getNode(!o), o, !0);
      var l = n(c);
      return l && i(l) && ks(c, l)
        ? Mm(e, t, l.getNode(!o), o, !0)
        : u
        ? Um(t, c.toRange(), !0)
        : null;
    },
    sC = function(e, t, n, r) {
      ...
      if (
        ((d = aC(r)),
        (o = Ns(e, t.getBody(), r)),
        (i = n(t.getBody(), rv(1), o)),
        (a = z(i, ov(1))),
        (s = $t.last(o.getClientRects())),
        (mf(o) || hf(o)) && (d = o.getNode()),
        (gf(o) || vf(o)) && (d = o.getNode(!0)),
        !s)
      )
        return null;
      if (((c = s.left), (u = lv(a, c)) && iC(u.node)))
        return (
          (l = Math.abs(c - u.left)),
      ...
      if (d) {
        var m = (function(e, t, n, r) {
          ...
          1 === e
            ? ((o = l.next), (i = Va), (a = Ua), (u = vu.after(r)))
            : ((o = l.prev), (i = Ua), (a = Va), (u = vu.before(r))),
            (c = m(u));
          do {
            if (u.isVisible() && !a((s = m(u)), c)) {
              if (
                (0 < f.length && i(s, $t.last(f)) && d++,
                ((s = Ma(s)).position = u),
                (s.line = d),
                n(s))
              )
        ...
        if ((u = lv(z(m, ov(1)), c))) return Um(t, u.position.toRange(), !0);
        if ((u = $t.last(z(m, ov(0))))) return Um(t, u.position.toRange(), !0);
      }
    },
    cC = function(e, t, n) {
      var r,
      ...
      if (n.collapsed && e.settings.forced_root_block) {
        ...
        (1 === t ? s(vu.fromRangeStart(n)) : c(vu.fromRangeStart(n))) ||
          ((a = (i = e).dom.create(eg(i))),
          (!me.ie || 11 <= me.ie) && (a.innerHTML = '<br data-mce-bogus="1">'),
          (o = a),
    ...
    lC = function(l, f) {
      return function() {
        var e,
          ...
          (o = d(Ss, r.next)),
          (i = d(Ss, r.prev)),
          (a = t ? pu.Forwards : pu.Backwards),
          (u = t ? o : i),
          (s = e.selection.getRng()),
          (n = uC(a, e, u, s)) ? n : (n = cC(e, a, s)) || null);
    ...
    fC = function(u, s) {
      return function() {
        var e,
          ...
          (n = sC(r, e, o, i)) ? n : (n = cC(e, r, i)) || null);
    ...
    dC = function(r, o) {
      return function() {
        var t,
          e = o
            ? vu.fromRangeEnd(r.selection.getRng())
            : vu.fromRangeStart(r.selection.getRng()),
          n = o ? nC(r.getBody(), e) : tC(r.getBody(), e);
        return (o ? ne(n.positions) : te(n.positions))
          .filter(
            ((t = o),
            function(e) {
              return t ? gf(e) : mf(e);
    ...
    mC = function(e, t, n, r, o) {
      var i,
        ...
        u,
        s,
        c = ji(or.fromDom(n), 'td,th,caption').map(function(e) {
          return e.dom();
        }),
        l = z(
          ((i = e),
          J(c, function(e) {
            var t,
              n,
              r = ((t = Ma(e.getBoundingClientRect())),
              (n = -1),
              {
                left: t.left - n,
                top: t.top - n,
      ...
      return te(n.getClientRects())
        ...
        .bind(function(e) {
          return eC(
            ...
            Zs.lastPositionIn(t)
              .map(function(e) {
                return tC(t, e).positions.concat(e);
              })
              .getOr([])),
            n,
          );
    ...
    vC = function(t, n) {
      return ne(n.getClientRects())
        .bind(function(e) {
          return pC(t, e.left, e.top);
        })
        .bind(function(e) {
          return eC(
            ((t = e),
            Zs.firstPositionIn(t)
              .map(function(e) {
                return [e].concat(nC(t, e).positions);
              })
              .getOr([])),
            n,
          );
    ...
    yC = function(e, t, n) {
      var r,
        ...
        a,
        u = e(t, n);
      return ((a = u).breakType === fy.Wrap && 0 === a.positions.length) ||
        (!Bo.isBr(n.getNode()) &&
          (i = u).breakType === fy.Br &&
    ...
    EC = function(u, s, c) {
      ...
      e.fold(
        ...
        function(a) {
          return Zs.positionIn(t, u.getBody())
            .filter(function(e) {
              return e.isEqual(c);
            })
            .fold(
                ...
                return (
                  ...
                  void ((i = eg((r = u)))
                    ? r.undoManager.transact(function() {
                        ...
                        yr(e, tg(r)),
                          Ai(e, or.fromTag('br')),
                          n ? ki(or.fromDom(o), e) : Si(or.fromDom(o), e);
    ...
    SC = function(e, t, n, r) {
      var o,
        ...
        f = vu.fromRangeStart(l),
        d = e.getBody();
      if (!t && CC(r, f)) {
        var m = ((u = d),
        hC((s = n), (c = f))
          .orThunk(function() {
            return te(c.getClientRects()).bind(function(e) {
              return Zy(rC(u, vu.before(s)), e.left);
            });
          })
          .getOr(vu.before(s)));
        return EC(e, t, m), !0;
      ...
      return (
        ...
        (m = vC((i = n), (a = f))
          .orThunk(function() {
            return te(a.getClientRects()).bind(function(e) {
              return Zy(oC(o, vu.after(i)), e.left);
            });
          })
          .getOr(vu.after(i))),
        EC(e, t, m),
    ...
    DC = function(e, t, n, r) {
      return '' === t
        ? ((l = e), (f = r), (d = or.fromTag('br')), _C(l, d, f), RC(d))
        : ((o = e),
          (i = r),
          (a = t),
          (u = n),
    ...
    BC = function(e, t, n) {
      return t
        ? ((o = e.dom()), nC(o, n).breakAt.isNone())
        : ((r = e.dom()), tC(r, n).breakAt.isNone());
      var r, o;
    },
    OC = function(t, n) {
      var e,
        r,
        o,
        i = or.fromDom(t.getBody()),
        a = vu.fromRangeStart(t.selection.getRng()),
        u = eg(t),
        s = tg(t);
      return ((e = a),
      (r = i),
      (o = d(Pr, r)),
      Ki(or.fromDom(e.container()), lo, o).filter(AC)).exists(function() {
        if (BC(i, n, a)) {
          var e = DC(i, u, s, n);
    ...
    PC = function(e, t) {
      return function() {
        return !!e.selection.isCollapsed() && OC(e, t);
      };
    },
    LC = function(e, r) {
      return J(
    ...
    FC = function(i, a) {
      i.on('keydown', function(e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          MC(
            [
              { keyCode: pv.RIGHT, action: lC(t, !0) },
              { keyCode: pv.LEFT, action: lC(t, !1) },
              { keyCode: pv.UP, action: fC(t, !1) },
              { keyCode: pv.DOWN, action: fC(t, !0) },
              { keyCode: pv.RIGHT, action: kC(t, !0) },
              { keyCode: pv.LEFT, action: kC(t, !1) },
              { keyCode: pv.UP, action: TC(t, !1) },
              { keyCode: pv.DOWN, action: TC(t, !0) },
              { keyCode: pv.RIGHT, action: kd.move(t, n, !0) },
              { keyCode: pv.LEFT, action: kd.move(t, n, !1) },
              {
                keyCode: pv.RIGHT,
                ctrlKey: !o.isOSX(),
                altKey: o.isOSX(),
                action: kd.moveNextWord(t, n),
              },
              {
                keyCode: pv.LEFT,
                ctrlKey: !o.isOSX(),
                altKey: o.isOSX(),
                action: kd.movePrevWord(t, n),
              },
              { keyCode: pv.UP, action: PC(t, !1) },
              { keyCode: pv.DOWN, action: PC(t, !0) },
            ],
            r,
          ).each(function(e) {
            r.preventDefault();
    ...
    zC = function(o, i) {
      o.on('keydown', function(e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          MC(
            [
              { keyCode: pv.BACKSPACE, action: IC(Ff, t, !1) },
              { keyCode: pv.DELETE, action: IC(Ff, t, !0) },
              { keyCode: pv.BACKSPACE, action: IC(Hm, t, !1) },
              { keyCode: pv.DELETE, action: IC(Hm, t, !0) },
              { keyCode: pv.BACKSPACE, action: IC(_d, t, n, !1) },
              { keyCode: pv.DELETE, action: IC(_d, t, n, !0) },
              { keyCode: pv.BACKSPACE, action: IC(cm, t, !1) },
              { keyCode: pv.DELETE, action: IC(cm, t, !0) },
              { keyCode: pv.BACKSPACE, action: IC(Gl, t, !1) },
              { keyCode: pv.DELETE, action: IC(Gl, t, !0) },
              { keyCode: pv.BACKSPACE, action: IC(Wl, t, !1) },
              { keyCode: pv.DELETE, action: IC(Wl, t, !0) },
              { keyCode: pv.BACKSPACE, action: IC(Pm, t, !1) },
              { keyCode: pv.DELETE, action: IC(Pm, t, !0) },
            ],
            r,
          ).each(function(e) {
            r.preventDefault();
        ...
        o.on('keyup', function(e) {
          ...
          !1 === e.isDefaultPrevented() &&
            ...
            MC(
              [
                { keyCode: pv.BACKSPACE, action: IC(zf, t) },
                { keyCode: pv.DELETE, action: IC(zf, t) },
              ],
              n,
            ));
        });
    ...
    YC = function(e, t, n) {
      for (var r = e[n ? 'firstChild' : 'lastChild']; r && !Bo.isElement(r); )
    ...
    GC = function(e, t, n, r, o) {
      ...
      if (n !== e.getBody()) {
        var u;
        KC((u = n)) && KC(u.parentNode) && (o = 'LI');
        var s,
          c,
          l = o ? t(o) : i.create('BR');
        if (YC(n, r, !0) && YC(n, r, !1))
          WC(n, 'LI') ? i.insertAfter(l, XC(n)) : i.replace(l, n);
        else if (YC(n, r, !0))
          WC(n, 'LI')
            ? (i.insertAfter(l, XC(n)),
              l.appendChild(i.doc.createTextNode(' ')),
              l.appendChild(n))
            : n.parentNode.insertBefore(l, n);
        else if (YC(n, r, !1)) i.insertAfter(l, XC(n));
        else {
          n = XC(n);
          var f = a.cloneRange();
    ...
    ex = function(e, t, n) {
      return !1 === Bo.isText(t)
        ? n
        : e
        ? 1 === n && t.data.charAt(n - 1) === fa
          ? 0
          : n
        : n === t.data.length - 1 && t.data.charAt(n) === fa
        ? t.data.length
        : n;
    },
    tx = function(e, t) {
    ...
    rx = function(a, e) {
      var t,
        ...
        k = function(e) {
          ...
          if (
            ((o = ex(e, s, i)),
            Bo.isText(s) && (e ? 0 < o : o < s.nodeValue.length))
          )
            return !1;
      ...
      _g(x, E).each(function(e) {
        ...
        Bo.isElement(s) &&
          ...
          (i = g && Bo.isText(s) ? s.nodeValue.length : 0)),
        (u = tx(x, s)) &&
          (((m && !n) || (!m && n)) &&
            (s = (function(e, t, n, r, o) {
              var i,
                ...
                m = e.dom,
                g = tx(m, r);
              if (!(a = m.getParent(r, m.isBlock)) || !ZC(m, a)) {
                if (
                  ((l =
                    (a = a || g) === e.getBody() ||
          ...
          /^(LI|DT|DD)$/.test(f) && x.isEmpty(c)
            ...
            : (m && c === a.getBody()) ||
              ((m = m || 'P'),
              pa(c)
                ? ((r = Ea(c)), x.isEmpty(c) && JC(c), VC(a, r))
                : k()
                ? T()
                : k(!0)
                ...
                : ((t = ((y = E),
                  ...
                  C.setStart(
                    y.startContainer,
                    ex(!0, y.startContainer, y.startOffset),
                  ),
                  C.setEnd(y.endContainer, ex(!1, y.endContainer, y.endOffset)),
                  C).cloneRange()).setEndAfter(c),
                  (o = t.extractContents()),
                  (b = o),
                  F(Hi(or.fromDom(b), fr), function(e) {
                    var t = e.dom();
                    t.nodeValue = da(t.nodeValue);
                  }),
                  (function(e) {
                    for (
                      ;
                  ...
                  x.isEmpty(c) && JC(c),
                  r.normalize(),
                  x.isEmpty(r) ? (x.remove(r), T()) : VC(a, r)),
              x.setAttrib(r, 'id', ''),
    ...
    ox = function(e, t) {
      return jC(e)
        .filter(function(e) {
          return 0 < t.length && Br(or.fromDom(e), t);
        })
        .isSome();
    },
    ix = function(e) {
    ...
    hx = function(e) {
      var t = eg(e),
        n = HC(e.dom, e.selection.getStart());
    ...
    bx = function(e, t) {
      return Gf(
        [
          vx([sx], ux.none()),
          vx([fx('summary', !0)], ux.br()),
          vx([dx(!0), mx(!1), px], ux.br()),
          vx([dx(!0), mx(!1)], ux.block()),
          vx([dx(!0), mx(!0), px], ux.block()),
          vx([dx(!0), mx(!0)], ux.br()),
          vx([lx(!0), px], ux.br()),
          vx([lx(!0)], ux.block()),
          vx([cx(!0), px, hx], ux.block()),
          vx([cx(!0)], ux.br()),
          vx([gx], ux.br()),
          vx([cx(!1), px], ux.br()),
          vx([hx], ux.block()),
    ...
    xx = function(n, r) {
      var e = r.container(),
        t = r.offset();
      return Bo.isText(e)
        ? (e.insertData(t, n), A.some(gu(e, t + n.length)))
        : Es(r).map(function(e) {
            var t = or.fromText(n);
            return r.isAtEnd() ? ki(e, t) : Si(e, t), gu(t.dom(), n.length);
          });
    },
    wx = d(xx, '\xa0'),
    Nx = d(xx, ' '),
    Ex = function(e, t, n) {
      return Zs.navigateIgnore(e, t, n, ff);
    },
    Sx = function(t, n, r) {
      var e = z(Ml(or.fromDom(r.container()), n), lo);
      return te(e).fold(
        function() {
          return Ex(t, n.dom(), r).forall(function(e) {
            return !1 === ps(e, r, n.dom());
          });
        },
        function(e) {
          return Ex(t, e.dom(), r).isNone();
        },
      );
    },
    kx = d(Sx, !1),
    Tx = d(Sx, !0),
    Ax = function(e) {
      return gu.isTextPosition(e) && !e.isAtStart() && !e.isAtEnd();
    },
    Rx = function(e, t) {
      var n = z(Ml(or.fromDom(t.container()), e), lo);
      return te(n).getOr(e);
    },
    _x = function(e, t) {
      return Ax(t)
        ? lf(t)
        : lf(t) || Zs.prevPosition(Rx(e, t).dom(), t).exists(lf);
    },
    Dx = function(e, t) {
      return Ax(t)
        ? cf(t)
        : cf(t) || Zs.nextPosition(Rx(e, t).dom(), t).exists(cf);
    },
    Bx = function(e) {
      return Es(e)
        .bind(function(e) {
        ...
        .exists(function(e) {
          return (
            (t = Nr(e, 'white-space')), M(['pre', 'pre-line', 'pre-wrap'], t)
          );
          var t;
        });
    },
    Ox = function(e, t) {
      return (
        (o = e),
        (i = t),
        Zs.prevPosition(o.dom(), i).isNone() ||
          ((n = e), (r = t), Zs.nextPosition(n.dom(), r).isNone()) ||
          kx(e, t) ||
          Tx(e, t) ||
          tf(e, t) ||
          ef(e, t)
    ...
    Px = function(e, t) {
      var n,
        ...
        i = ((r = (n = t).container()),
        (o = n.offset()),
        Bo.isText(r) && o < r.data.length ? gu(r, o + 1) : n);
      return !Bx(i) && (Tx(e, i) || ef(e, i) || Dx(e, i));
    },
    Lx = function(e, t) {
      return (
        (n = e),
        (!Bx((r = t)) && (kx(n, r) || tf(n, r) || _x(n, r))) || Px(e, t)
      );
      var n, r;
    },
    Ix = function(e, t) {
    ...
    Mx = function(e) {
      var t = e.container();
      return Bo.isText(t) && Kn(t.data, '\xa0');
    },
    Fx = function(e) {
      var t = e.data,
      ...
      return A.some(e)
        ...
        .bind(function(e) {
          ...
          return (
            ...
            (u = (a = c).data),
            (s = gu(a, 0)),
            (Ix(u, 0) && !Lx(i, s) && ((a.data = ' ' + u.slice(1)), 1)) ||
            Fx(c) ||
            ((t = l),
            (r = (n = c).data),
            (o = gu(n, r.length - 1)),
    ...
    Ux = function(t) {
      var e = or.fromDom(t.getBody());
      t.selection.isCollapsed() &&
        zx(e, gu.fromRangeStart(t.selection.getRng())).each(function(e) {
          t.selection.setRng(e.toRange());
        });
    },
    Vx = function(r, o) {
      return function(e) {
        return (
          (t = r),
          !Bx((n = e)) && (Ox(t, n) || _x(t, n) || Dx(t, n)) ? wx(o) : Nx(o)
        );
        var t, n;
      };
    },
    Hx = function(e) {
      var t,
        n,
        r = vu.fromRangeStart(e.selection.getRng()),
        o = or.fromDom(e.getBody());
      if (e.selection.isCollapsed()) {
        var i = d(yl.isInlineTarget, e),
          a = vu.fromRangeStart(e.selection.getRng());
        return gd(i, e.getBody(), a)
          .bind(
            ((n = o),
            function(e) {
              return e.fold(
                function(e) {
                  return Zs.prevPosition(n.dom(), vu.before(e));
                },
                function(e) {
                  return Zs.firstPositionIn(e);
                },
                function(e) {
                  return Zs.lastPositionIn(e);
                },
                function(e) {
                  return Zs.nextPosition(n.dom(), vu.after(e));
                },
              );
            }),
          )
    ...
    jx = function(r) {
      r.on('keydown', function(e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          MC([{ keyCode: pv.SPACEBAR, action: IC(Hx, t) }], n).each(function(
            e,
          ) {
            n.preventDefault();
          }));
    ...
    $x = function(e, t) {
      var n,
        r = ((n = e),
        Yi(or.fromDom(n.getBody()), '*[data-mce-caret]').fold(q(null), function(
          e,
        ) {
          return e.dom();
        }));
      if (r)
        return 'compositionstart' === t.type
          ? (t.preventDefault(), t.stopPropagation(), void qx(e, r))
          : void (ba(r) && (qx(e, r), e.undoManager.add()));
    },
    Wx = function(e) {
      e.on('keyup compositionstart', d($x, e));
    },
    Kx = nr.detect().browser,
    Xx = function(t) {
      var e, n;
      (e = t),
        (n = Oi(function() {
    ...
    Yx = function(r) {
      r.on('keydown', function(e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          MC(
            [
              { keyCode: pv.END, action: dC(t, !0) },
              { keyCode: pv.HOME, action: dC(t, !1) },
            ],
            n,
          ).each(function(e) {
            n.preventDefault();
    ...
    Gx = function(e) {
      var t = kd.setupSelectedState(e);
      Wx(e), FC(e, t), zC(e, t), Cx(e), jx(e), Xx(e), Yx(e);
    };
  function Jx(u) {
    var s,
      n,
        ...
        u.inline ||
          ...
          u.on('click', function(e) {
            ...
            if ('HTML' === e.target.nodeName) {
              if (11 < me.ie) return void u.getBody().focus();
    ...
    return (
      ...
      me.windowsPhone ||
        u.on(
          ...
          function(e) {
            pv.modifierPressed(e) || d.normalize();
          },
          !0,
        ),
      m &&
        ...
        H.Range.prototype.getClientRects ||
          u.on('mousedown', function(e) {
            if (!v(e) && 'HTML' === e.target.nodeName) {
              var t = u.getBody();
              t.blur(),
                be.setEditorTimeout(u, function() {
                  t.focus();
                });
            }
          }),
  ...
  var Qx = function(e) {
      return Bo.isElement(e) && go(or.fromDom(e));
    },
    Zx = function(t) {
        ...
        3 <= e.detail &&
          (function(e) {
            var t = e.selection.getRng(),
              n = gu.fromRangeStart(t),
              r = gu.fromRangeEnd(t);
            if (gu.isElementPosition(n)) {
              var o = n.container();
              Qx(o) &&
                Zs.firstPositionIn(o).each(function(e) {
                  return t.setStart(e.container(), e.offset());
                });
            }
            gu.isElementPosition(r) &&
              ((o = n.container()),
              Qx(o) &&
                Zs.lastPositionIn(o).each(function(e) {
                  return t.setEnd(e.container(), e.offset());
                })),
              e.selection.setRng(el(t));
          })(t);
      });
    },
    ew = function(e) {
    ...
    rw = function(t, e) {
      ...
      f.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        f.content_editable &&
          (t.on('remove', function() {
            var e = this.getBody();
            tw.removeClass(e, 'mce-content-body'),
              tw.removeClass(e, 'mce-edit-focus'),
              tw.setAttrib(e, 'contentEditable', null);
          }),
          tw.addClass(d, 'mce-content-body'),
        ...
        t.readonly ||
          (t.inline &&
            'static' === tw.getStyle(n, 'position', !0) &&
        ...
        (t.parser = ((o = oy((u = t).settings, u.schema)).addAttributeFilter(
        ...
        o.addNodeFilter('p,h1,h2,h3,h4,h5,h6,div', function(e) {
          for (var t, n = e.length, r = u.schema.getNonEmptyElements(); n--; )
            (t = e[n]).isEmpty(r) &&
              ...
              (t.append(new Kb('br', 1)).shortEnded = !0);
        }),
        o)),
        (t.serializer = cy(f, t)),
        (t.selection = Yy(t.dom, t.getWin(), t.serializer, t)),
        (t.annotator = Pc(t)),
        (t.formatter = Lb(t)),
        (t.undoManager = Hv(t)),
        (t._nodeChangeDispatcher = new Uh(t)),
        (t._selectionOverrides = yv(t)),
        ew(t),
        Zx(t),
        Gx(t),
        Ph(t),
        ...
        f.browser_spellcheck ||
          f.gecko_spellcheck ||
          ((m.body.spellcheck = !1), tw.setAttrib(n, 'spellcheck', 'false')),
        (t.quirks = Jx(t)),
        t.fire('PostRender'),
        ...
        0 < t.contentStyles.length &&
          ((r = ''),
          Gt.each(t.contentStyles, function(e) {
            r += e + '\r\n';
          }),
          t.dom.addStyle(r)),
        ((i = t),
        i.inline ? tw.styleSheetLoader : i.dom.styleSheetLoader).loadAll(
          t.contentCSS,
          function(e) {
            nw(t);
          },
    ...
    iw = function(e, t) {
      ...
      return (
        ...
        (e.iframeElement = l),
        (e.iframeHTML = ((g = Xm((f = e)) + '<html><head>'),
        Ym(f) !== f.documentBaseUrl &&
    ...
    aw = function(e, t) {
      var n = iw(e, t);
      t.editorContainer &&
        ((ow.get(t.editorContainer).style.display = e.orgDisplay),
        (e.hidden = ow.isHidden(t.editorContainer))),
        (e.getElement().style.display = 'none'),
        ow.setAttrib(e.id, 'aria-hidden', 'true'),
        n || rw(e);
    },
    uw = hi.DOM,
    sw = function(t, n, e) {
      var r = mh.get(e),
        o = mh.urls[e] || t.documentBaseUrl.replace(/\/$/, '');
      if (((e = Gt.trim(e)), r && -1 === Gt.inArray(n, e))) {
        if (
          (Gt.each(mh.dependencies(e), function(e) {
            sw(t, n, e);
          }),
          t.plugins[e])
        )
    ...
    fw = function(e) {
      ...
      return e.inline
        ? lw(null)
        : ((t = r), (n = uw.create('div')), uw.insertAfter(n, t), lw(n));
    },
    dw = function(e) {
      var t,
        n,
      ...
      return (
        ...
        R(d.theme)
          ? ((l = (o = e).settings),
            (f = o.getElement()),
            (i = l.width || uw.getStyle(f, 'width') || '100%'),
            (a = l.height || uw.getStyle(f, 'height') || f.offsetHeight),
            (u = l.min_height || 100),
            (s = /^[0-9\.]+(|px)$/i).test('' + i) &&
    ...
    mw = function(t) {
      ...
      return (
        ...
        (u.aria_label =
          u.aria_label ||
          uw.getAttrib(s, 'aria-label', t.getLang('aria.rich_text_area'))),
        t.fire('ScriptsLoaded'),
        (o = (n = t).settings.theme),
        R(o)
          ? ((n.settings.theme = cw(o)),
            (r = gh.get(o)),
            (n.theme = new r(n, gh.urls[o])),
            n.theme.init &&
              n.theme.init(
                n,
                gh.urls[o] || n.documentBaseUrl.replace(/\/$/, ''),
                n.$,
              ))
          : (n.theme = {}),
        (i = t),
        (a = []),
        Gt.each(i.settings.plugins.split(/[ ,]/), function(e) {
          sw(i, a, cw(e));
        }),
        (e = dw(t)),
        (t.editorContainer = e.editorContainer ? e.editorContainer : null),
        u.content_css &&
          Gt.each(Gt.explode(u.content_css), function(e) {
            t.contentCSS.push(t.documentBaseURI.toAbsolute(e));
          }),
        u.content_editable ? rw(t) : aw(t, e)
      );
    },
    gw = hi.DOM,
    pw = function(e) {
    ...
    hw = function(i, a) {
      ...
      !(function(e, t, n, r) {
        var o = t.settings,
          i = o.theme;
        if (R(i)) {
          if (!pw(i) && !gh.urls.hasOwnProperty(i)) {
            var a = o.theme_url;
            a
              ? gh.load(i, t.documentBaseURI.toAbsolute(a))
              : gh.load(i, 'themes/' + i + '/theme' + n + '.js');
          }
        ...
        (e = u),
          ...
          (r = i.settings),
          (o = a),
          Gt.isArray(r.plugins) && (r.plugins = r.plugins.join(' ')),
          Gt.each(r.external_plugins, function(e, t) {
            mh.load(t, e), (r.plugins += ' ' + t);
          }),
          Gt.each(r.plugins.split(/[ ,]/), function(e) {
            if ((e = Gt.trim(e)) && !mh.urls[e])
              if (pw(e)) {
                e = e.substr(1, e.length);
                var t = mh.dependencies(e);
                Gt.each(t, function(e) {
                  var t = {
                    prefix: 'plugins/',
                    resource: e,
                  ...
                  (e = mh.createUrl(t, e)), mh.load(e.resource, e);
                });
              } else
                mh.load(e, {
                  prefix: 'plugins/',
          ...
          u.loadQueue(
            ...
            i,
            function(e) {
              dh.pluginLoadError(i, e[0]), i.removed || mw(i);
            },
          );
      });
    },
    vw = function(t) {
      var e = t.settings,
        n = t.id,
        r = function() {
          gw.unbind(H.window, 'ready', r), t.render();
        };
      if (Te.Event.domLoaded) {
        if (t.getElement() && me.contentEditable) {
          e.inline
            ? (t.inline = !0)
            : ((t.orgVisibility = t.getElement().style.visibility),
              (t.getElement().style.visibility = 'hidden'));
          var o = t.getElement().form || gw.getParent(n, 'form');
          o &&
            ((t.formElement = o),
            e.hidden_input &&
              !/TEXTAREA|INPUT/i.test(t.getElement().nodeName) &&
              (gw.insertAfter(
                gw.create('input', { type: 'hidden', name: n }),
                n,
              ),
              (t.hasHiddenInput = !0)),
            ...
            gw.bind(o, 'submit reset', t.formEventDelegate),
            t.on('reset', function() {
            ...
            'xml' === e.encoding &&
              t.on('GetContent', function(e) {
                e.save && (e.content = gw.encode(e.content));
              }),
    ...
    yw = Gt.each,
    Cw = Gt.trim,
    xw = 'source protocol authority userInfo user password host port relative path directory file query anchor'.split(
      ' ',
    ),
    ww = { ftp: 21, http: 80, https: 443, mailto: 25 },
    Nw = function(r, e) {
      var t,
        n,
        o = this;
      if (
        ...
        0 !== r.indexOf('/') ||
          ...
          /^[\w\-]*:?\/\//.test(r) ||
            ((n = e.base_uri
              ? e.base_uri.path
              : new Nw(H.document.location.href).directory),
            '' == e.base_uri.protocol
  ...
  (Nw.prototype = {
    ...
    toRelative: function(e) {
      ...
      if ('./' === e) return e;
      if (
        ('mce_host' !== (e = new Nw(e, { base_uri: this })).host &&
          this.host !== e.host &&
          e.host) ||
        this.port !== e.port ||
    ...
    toAbsolute: function(e, t) {
      return (e = new Nw(e, { base_uri: this })).getURI(
    ...
    (Nw.getDocumentBaseUrl = function(e) {
      var t;
      return (
        (t =
  ...
  var Ew = function(e, t, n) {
      ...
      if (
        ...
        r = Gt.trim(Sv.trimExternal(e.serializer, n.innerHTML));
      else if ('text' === t.format) r = da(n.innerText || n.textContent);
      else {
    ...
    Sw = function(e, t) {
      t(e), e.firstChild && Sw(e.firstChild, t), e.next && Sw(e.next, t);
    },
    kw = function(e, t, n) {
    ...
    Aw = function(e, t) {
      ...
      e.dom.setHTML(e.getBody(), t),
        Kp((r = e)) &&
          Zs.firstPositionIn(r.getBody()).each(function(e) {
            var t = e.getNode(),
              n = Bo.isTable(t) ? Zs.firstPositionIn(t).getOr(e) : e;
        ...
        A.from(u.getBody()).fold(q(s), function(e) {
          return Tw(s)
            ? (function(e, t, n, r) {
                ...
                return (
                  (r.content = Co(or.fromDom(t)) ? o : Gt.trim(o)),
                  Aw(e, r.content),
            ...
            : ((t = u),
              ...
              0 === (r = s).length || /^\s+$/.test(r)
                ...
                : ('raw' !== o.format &&
                  ...
                  (o.content = Co(or.fromDom(n)) ? r : Gt.trim(r)),
                  Aw(t, o.content),
    ...
    Bw = function(e) {
      if (!e.removed) {
        ...
        r && e.save({ is_removing: !0 }),
          ...
          e.hasHiddenInput && o && _w.remove(o.nextSibling),
          bp(e),
          e.editorManager.remove(e),
          !e.inline &&
            r &&
            ((i = e), _w.setStyle(i.id, 'display', i.orgDisplay)),
          yp(e),
          _w.remove(e.getContainer()),
          Dw(t),
          Dw(n),
          e.destroy();
      }
        ...
        (t || e.removed
          ? (t ||
            ...
            (r = (n = e).formElement) &&
              ...
              _w.unbind(r, 'submit reset', n.formEventDelegate)),
    ...
    zw = function(e, t, n) {
      ...
      (r = l),
        ...
        l.setDirty(!1),
        (l.plugins = {}),
        (l.documentBaseURI = new Nw(t.document_base_url, { base_uri: d })),
        (l.baseURI = d),
        (l.contentCSS = []),
        (l.contentStyles = []),
        (l.shortcuts = new Mp(l)),
        (l.loadedCSS = {}),
        (l.editorCommands = new lp(l)),
        (l.suffix = n.suffix),
        (l.editorManager = n),
        (l.inline = t.inline),
        (l.buttons = {}),
  ...
  Lw(
    (zw.prototype = {
      ...
      show: function() {
        this.hidden &&
          ...
          this.inline
            ...
            : (Pw.show(this.getContainer()), Pw.hide(this.id)),
          this.load(),
          this.fire('show'));
      },
      hide: function() {
        var e = this,
          t = e.getDoc();
        e.hidden ||
          (Fw && t && !e.inline && t.execCommand('SelectAll'),
          e.save(),
          e.inline
            ? ((e.getBody().contentEditable = !1),
              e === e.editorManager.focusedEditor &&
                (e.editorManager.focusedEditor = null))
            : (Pw.hide(e.getContainer()),
              Pw.setStyle(e.id, 'display', e.orgDisplay)),
          (e.hidden = !0),
          e.fire('hide'));
      },
      isHidden: function() {
      ...
      getContent: function(e) {
        return (
          ...
          A.from(t.getBody()).fold(
            q('tree' === n.format ? new Kb('body', 11) : ''),
            function(e) {
              return Ew(t, n, e);
            },
          )
      ...
      getElement: function() {
        return (
          this.targetElm || (this.targetElm = Pw.get(this.id)), this.targetElm
        );
      },
      getWin: function() {
        var e;
      ...
      addVisual: function(e) {
        ...
        (e = e || r.getBody()),
          ...
          Iw(i.select('table,a', e), function(e) {
            var t;
            switch (e.nodeName) {
              case 'TABLE':
                return (
  ...
  var Uw,
    ...
    qw = function(n, e) {
      ...
      nr.detect().browser.isIE()
        ...
        n.on('keyup nodechange', function(e) {
          var t;
          ('nodechange' === (t = e).type && t.selectionChange) || ep(n);
        });
    },
    $w = function(e) {
      var t,
      ...
      e.inline &&
        ...
        hi.DOM.bind(H.document, 'mouseup', r),
        t.on('remove', function() {
          hi.DOM.unbind(H.document, 'mouseup', r);
        })),
        e.on('init', function() {
          qw(e, o);
        }),
    ...
    Ww = hi.DOM,
    Kw = function(e) {
      return jw.isEditorUIElement(e);
    },
    Xw = function(t, e) {
      var n = t ? t.settings.custom_ui_selector : '';
      return (
        null !==
        Ww.getParent(e, function(e) {
          return Kw(e) || (!!n && t.dom.is(e, n));
        })
      );
    },
    Yw = function(r, e) {
      ...
      $w(t),
        ...
        Uw ||
          ...
          Ww.bind(H.document, 'focusin', Uw));
    },
    Gw = function(e, t) {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        e.activeEditor || (Ww.unbind(H.document, 'focusin', Uw), (Uw = null));
    },
    Jw = function(e) {
      e.on('AddEditor', d(Yw, e)), e.on('RemoveEditor', d(Gw, e));
    },
    Qw = hi.DOM,
    Zw = Gt.explode,
    eN = Gt.each,
    ...
    uN = function(e) {
      e !== rN &&
        (e
          ? hn(window).on('resize scroll', aN)
          : hn(window).off('resize scroll', aN),
        (rN = e));
    },
    sN = function(t) {
      var e = iN;
      ...
      return (
        ...
        Hw.activeEditor === t &&
          (Hw.activeEditor = 0 < iN.length ? iN[0] : null),
        Hw.focusedEditor === t && (Hw.focusedEditor = null),
        e.length !== iN.length
      );
    };
  tN(
    (Hw = {
      ...
      setup: function() {
        var e,
          ...
          o = '';
        if (
          ((t = Nw.getDocumentBaseUrl(H.document.location)),
          /^[^:]+:\/\/\/?[^\/]+\//.test(t) &&
            ((t = t.replace(/[\?#].*$/, '').replace(/[\/\\][^\/]+$/, '')),
            /[\/\\]$/.test(t) || (t += '/')),
        ...
        (this.baseURL = new Nw(t).toAbsolute(e)),
          (this.documentBaseURL = t),
          (this.baseURI = new Nw(this.baseURL)),
          (this.suffix = o),
          Jw(this);
      },
      overrideDefaults: function(e) {
        var t, n;
        (t = e.base_url) &&
          ((this.baseURL = new Nw(this.documentBaseURL).toAbsolute(
            t.replace(/\/+$/, ''),
          )),
          (this.baseURI = new Nw(this.baseURL))),
          (n = e.suffix),
      ...
      init: function(r) {
        ...
        var c = function(e) {
            ...
            return (
              t ||
                ((t = (t = e.name) && !Qw.get(t) ? e.name : Qw.uniqueId()),
                e.setAttribute('id', t)),
              t
            );
          },
          ...
          e = function() {
            ...
            Qw.unbind(window, 'ready', e),
                ...
                (function(t) {
                  ...
                  switch (t.mode) {
                    case 'exact':
                      0 < (e = t.elements || '').length &&
                        eN(Zw(e), function(t) {
                          ...
                          (e = Qw.get(t))
                            ? n.push(e)
                            : eN(H.document.forms, function(e) {
                    ...
                    case 'specific_textareas':
                      eN(Qw.select('textarea'), function(e) {
              ...
              r.types
                ? eN(r.types, function(t) {
                    Gt.each(o, function(e) {
                      return (
                        !Qw.is(e, t.selector) || (n(c(e), tN({}, r, t), e), !1)
                      );
                    });
                  })
                : (Gt.each(o, function(e) {
      ...
      add: function(e) {
        ...
        return (
          oN[e.id] === e ||
            (null === t.get(e.id) &&
              ('length' !== e.id && (oN[e.id] = e), oN.push(e), iN.push(e)),
            uN(!0),
            (t.activeEditor = e),
            ...
            Vw ||
              ...
              Qw.bind(window, 'beforeunload', Vw))),
          e
        );
      },
      createEditor: function(e, t) {
        return this.add(new zw(e, t, this));
      },
      remove: function(e) {
        var t,
          n,
            ...
            return (
              ...
              B(r.get(n.id))
                ...
                : (sN(n) && r.fire('RemoveEditor', { editor: n }),
                  0 === iN.length && Qw.unbind(window, 'beforeunload', Vw),
                  n.remove(),
                  uN(0 < iN.length),
                  n)
            );
          eN(Qw.select(e), function(e) {
            (n = r.get(e.id)) && r.remove(n);
          });
        } else for (t = iN.length - 1; 0 <= t; t--) r.remove(iN[t]);
      },
      execCommand: function(e, t, n) {
        var r = this.get(n);
        switch (e) {
          case 'mceAddEditor':
            return this.get(n) || new zw(n, this.settings, this).render(), !0;
  ...
  ((cN = fN || (fN = {})).compareRanges = Ng),
    (cN.getCaretRangeFromPoint = xy),
    (cN.getSelectedNode = Ha),
    (cN.getNode = ja);
  var dN,
    mN,
    gN = fN,
    ...
    CN = {
      ...
      intersect: function(e, t) {
        ...
        return (
          (n = hN(e.x, t.x)),
          (r = hN(e.y, t.y)),
          (o = pN(e.x + e.w, t.x + t.w)),
          (i = pN(e.y + e.h, t.y + t.h)),
    ...
    wN = {
      ...
      get: function(e) {
        var t = e.toLowerCase(),
          n = xN.hasOwnProperty(t) ? xN[t] : null;
  ...
  SN.extend = dN = function(n) {
    ...
    (mN = !1),
    n.Mixins &&
      (NN(n.Mixins, function(e) {
        for (var t in e) 'init' !== t && (n[t] = e[t]);
      }),
      o.Mixins && (n.Mixins = o.Mixins.concat(n.Mixins))),
    n.Methods &&
      NN(n.Methods.split(','), function(e) {
        n[e] = a;
      }),
    n.Properties &&
      NN(n.Properties.split(','), function(e) {
        var t = '_' + e;
        n[e] = function(e) {
    ...
    n.Statics &&
      NN(n.Statics, function(e, t) {
        i[t] = e;
      }),
    n.Defaults && o.Defaults && (n.Defaults = EN({}, o.Defaults, n.Defaults)),
    n))
      'function' == typeof (r = n[t]) && o[t] ? (e[t] = u(t, r)) : (e[t] = r);
    return (i.prototype = e), ((i.constructor = i).extend = dN), i;
  };
  var kN = Math.min,
    TN = Math.max,
    AN = Math.round,
    ...
    BN = {
      send: function(e) {
        ...
        if (
          ...
          (e.async = !1 !== e.async),
          (e.data = e.data || ''),
          BN.fire('beforeInitialize', { settings: e }),
          (t = ph()))
        ) {
          if (
            ...
            e.requestheaders &&
              Gt.each(e.requestheaders, function(e) {
                t.setRequestHeader(e.key, e.value);
              }),
            t.setRequestHeader('X-Requested-With', 'XMLHttpRequest'),
            (t = BN.fire('beforeSend', { xhr: t, settings: e }).xhr).send(
              e.data,
            ),
            !e.async)
          )
  ...
  var ON,
    ...
    MN = Gt.extend,
    FN = function(e) {
      (this.settings = MN({}, e)), (this.count = 0);
    };
  (FN.sendRPC = function(e) {
    return new FN().send(e);
  }),
    (FN.prototype = {
      send: function(n) {
        var r = n.error,
          o = n.success;
        ((n = MN(this.settings, n)).success = function(e, t) {
          void 0 === (e = _N.parse(e)) && (e = { error: 'JSON Parse error.' }),
            e.error
  ...
  try {
    ...
    (PN = {}),
      ...
      Object.defineProperty(IN, 'length', {
        get: function() {
          return LN.length;
        },
        configurable: !1,
