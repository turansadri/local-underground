!(function(u) {
  ...
  var e,
    ...
    f = tinymce.util.Tools.resolve('tinymce.dom.RangeUtils'),
    d = tinymce.util.Tools.resolve('tinymce.dom.TreeWalker'),
    l = tinymce.util.Tools.resolve('tinymce.util.VK'),
    ...
    L = function(e, n) {
      return !!g(n) && !(!e.isBlock(n.nextSibling) || g(n.previousSibling));
    },
    E = function(e, n, t) {
      var r = e.isEmpty(n);
      return (
      ...
      var i = {},
        e = function(e) {
          ...
          (t = o[e ? 'startContainer' : 'endContainer']),
            ...
            1 === t.nodeType &&
              ((n = x.create('span', { 'data-mce-type': 'bookmark' })),
              t.hasChildNodes()
                ? ((r = Math.min(r, t.childNodes.length - 1)),
                  e
                    ? t.insertBefore(n, t.childNodes[r])
                    : x.insertAfter(n, t.childNodes[r]))
                : t.appendChild(n),
              (t = n),
              (r = 0)),
    ...
    ie = (V(Array.from) && Array.from,
    'undefined' != typeof u.window ? u.window : Function('return this;')()),
    ue = function(e, n) {
      return (function(e, n) {
        for (
          var t = n !== undefined && null !== n ? n : ie, r = 0;
    ...
    se = function(e) {
      var n,
        t = ue('ownerDocument.defaultView', e);
      return ((n = t), ae('HTMLElement', n)).prototype.isPrototypeOf(e);
    },
    ce = tinymce.util.Tools.resolve('tinymce.dom.DomQuery'),
    fe = function(e) {
      var n = e.selection.getStart(!0);
      return e.dom.getParent(n, 'OL,UL,DL', le(e, n));
    },
    de = function(e) {
      var t,
        n,
      ...
      return v.grep(
        ...
        (r = v.map(n, function(e) {
          var n = t.dom.getParent(e, 'li,dd,dt', le(t, e));
          return n || e;
        })),
        ce.unique(r)),
        function(e) {
    ...
    me = function(e, n) {
      var t = e.dom.getParents(n, 'ol,ul', le(e, n));
      return oe(t);
    },
    ge = function(n, e) {
      var t = Q(e, function(e) {
        return me(n, e).getOr(e);
      });
      return ce.unique(t);
    },
    pe = {
      ...
      getSelectedListRoots: function(e) {
        var n,
          t,
          r,
          o = ((t = me((n = e), n.selection.getStart())),
          (r = G(n.selection.getSelectedBlocks(), N)),
          t.toArray().concat(r));
        return ge(e, o);
      },
    },
    ...
    he = {
      ...
      fromPoint: function(e, n, t) {
        var r = e.dom();
        return q.from(r.elementFromPoint(n, t)).map(ve);
      },
    },
    ye = function(e, n) {
      for (var t = [], r = 0; r < e.length; r++) {
        var o = e[r];
        if (!o.isSome()) return q.none();
        t.push(o.getOrDie());
      }
      return q.some(n.apply(null, t));
    },
    Ne = Object.keys,
    Se = function() {
      return ae('Node');
    ...
    Oe = function(e, n) {
      return Ce(e, n, Se().DOCUMENT_POSITION_CONTAINED_BY);
    },
    be = function(e, n) {
      var t = (function(e, n) {
    ...
    ke = function(e) {
      ...
      return {
        ...
        version: e.version,
        isEdge: we('Edge', n),
        isChrome: we('Chrome', n),
        isIE: we('IE', n),
        isOpera: we('Opera', n),
        isFirefox: we(Ee, n),
        isSafari: we('Safari', n),
      };
    },
    Ae = {
      unknown: function() {
        return ke({ current: undefined, version: Le.unknown() });
      },
      nu: ke,
      edge: _('Edge'),
      chrome: _('Chrome'),
    ...
    Me = {
      unknown: function() {
        return Pe({ current: undefined, version: Le.unknown() });
      },
      nu: Pe,
      windows: _(xe),
      ios: _('iOS'),
    ...
    Fe = function(e, t) {
      return Ue(e, t).map(function(e) {
        var n = Le.detect(e.versionRegexes, t);
    ...
    ze = [
      ...
      { name: 'Linux', search: qe('linux'), versionRegexes: [] },
      { name: 'Solaris', search: qe('sunos'), versionRegexes: [] },
      { name: 'FreeBSD', search: qe('freebsd'), versionRegexes: [] },
    ],
    Ke = { browsers: _(We), oses: _(ze) },
    Ve = function(e) {
      var n,
        t,
        r,
        ...
        l = Ke.browsers(),
        m = Ke.oses(),
        g = Fe(l, e).fold(Ae.unknown, Ae.nu),
        p = je(m, e).fold(Me.unknown, Me.nu);
      return {
        browser: g,
        os: p,
        deviceType: ((t = g),
    ...
    Xe = {
      ...
      function() {
        for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        return a || ((a = !0), (i = o.apply(null, e))), i;
      }),
    },
    Qe = (u.Node.ATTRIBUTE_NODE,
    ...
    Je = Xe.detect().browser.isIE()
      ? function(e, n) {
          return Oe(e.dom(), n.dom());
        }
      : function(e, n) {
          var t = e.dom(),
            r = n.dom();
    ...
    en = function(e) {
      var n = e.dom();
      return q.from(n.parentNode).map(he.fromDom);
    },
    nn = function(e) {
      var n = e.dom();
      return Q(n.childNodes, he.fromDom);
    },
    tn = function(e, n) {
      var t = e.dom().childNodes;
      return q.from(t[n]).map(he.fromDom);
    },
    rn = function(e) {
      return tn(e, 0);
    },
    ...
    dn = function(e, n) {
      var t = e.dom();
      !(function(e, n) {
        for (var t = Ne(e), r = 0, o = t.length; r < o; r++) {
          var i = t[r];
          n(e[i], i, e);
        }
      })(n, function(e, n) {
    ...
    gn = function(e) {
      return (n = e), (t = !0), he.fromDom(n.dom().cloneNode(t));
      var n, t;
    },
    pn = function(e, n) {
      var t,
        ...
        o,
        i,
        u = ((t = e), (r = n), (o = he.fromTag(r)), (i = ln(t)), dn(o, i), o);
      un(e, u);
      var a = nn(e);
      return sn(u, a), cn(e), u;
    },
    vn = function(e, n) {
      an(e.item, n.list);
    },
      ...
      return (
        oe(n).each(function(e) {
          ...
          (u = c),
            ...
            (i.item = u),
            (s = d),
            fn((a = e).list) !== s.listType &&
              (a.list = pn(a.list, s.listType)),
            dn(a.list, s.listAttributes);
        }),
        n
      );
    },
    yn = function(e, n, t) {
        ...
        o = (function(e, n, t) {
          for (var r, o, i, u = [], a = 0; a < t; a++)
            u.push(
              ((r = e),
              (o = n.listType),
              (i = { list: he.fromTag(o, r), item: he.fromTag('li', r) }),
              an(i.list, i.item),
              i),
            );
          return u;
      ...
      return (
        (function(e) {
          for (var n = 1; n < e.length; n++) vn(e[n - 1], e[n]);
        })(o),
        (function(e, n) {
          ...
          oe(e).each(function(e) {
            dn(e.list, n.listAttributes),
              dn(e.item, n.itemAttributes),
              sn(e.item, n.content);
          });
        })(o, t),
        (r = o),
    ...
    function() {
      ...
      for (var t = {}, r = 0; r < e.length; r++) {
        var o = e[r];
        for (var i in o) Tn.call(o, i) && (t[i] = s(t[i], o[i]));
      }
      return t;
    }),
    Ln = function(n) {
      Y(n, function(r, e) {
        (function(e, n) {
          ...
          (t = e),
            ...
            (n.listAttributes = Dn({}, t.listAttributes));
        });
      });
    },
    En = function(e) {
    ...
    kn = function(n, t, r, e) {
      return ne(nn(e), function(e) {
        return (Nn(e) ? kn : wn)(n + 1, t, r, e);
      });
    },
    An = tinymce.util.Tools.resolve('tinymce.Env'),
    xn = function(e, n) {
      var t,
        r,
        o,
      ...
      if (
        ...
        o &&
          ...
          D(n.firstChild, a) || s.appendChild(r)),
        n)
      )
        for (; (t = n.firstChild); ) {
          var c = t.nodeName;
          i ||
            ('SPAN' === c && 'bookmark' === t.getAttribute('data-mce-type')) ||
            (i = !0),
            D(t, a)
              ? (s.appendChild(t), (r = null))
              : o
              ? (r || ((r = u.create(o)), s.appendChild(r)), r.appendChild(t))
              : s.appendChild(t);
        }
      return (
    ...
    In = function(e, n) {
      return (
        ...
        (o = J(
          r,
          function(e, n) {
            return n.depth > e.length ? yn(t, e, n) : hn(t, e, n);
          },
          [],
        )),
        re(o).map(function(e) {
    ...
    _n = function(e) {
      var n,
        t,
        r = Q(pe.getSelectedListItems(e), he.fromDom);
      return ye(
        [Z(r, B(Sn)), Z(((n = r), (t = te.call(n, 0)), t.reverse(), t), B(Sn))],
        function(e, n) {
    ...
    Bn = function(a, e, s) {
      var n,
        ...
        (r = En(!1)),
        Q(n, function(e) {
          return { sourceList: e, entries: kn(0, t, r, e) };
        }));
      Y(o, function(e) {
        var n, t, r, o, i, u;
        (n = e.entries),
    ...
    Mn = function(e, n, t) {
      var r, o, i, u, a, s;
      for (
        i = Pn.select('span[data-mce-type="bookmark"]', n),
          a = xn(e, t),
          (r = Pn.createRng()).setStartAfter(t),
          r.setEndAfter(n),
      ...
      e.dom.isEmpty(o) || Pn.insertAfter(o, n),
        Pn.insertAfter(a, n),
        E(e.dom, t.parentNode) &&
          ((s = t.parentNode),
          v.each(i, function(e) {
          ...
          : function(e) {
              return (
                ...
                void (Ze((t = e), 'DD')
                  ? pn(t, 'DT')
                  : Ze(t, 'DT') &&
                    en(t).each(function(e) {
                      return Mn(n, e.dom(), t.dom());
                    }))
              );
              var n, t;
            },
    ...
    jn = function(e, n) {
      var t = Q(pe.getSelectedListRoots(e), he.fromDom),
        r = Q(pe.getSelectedDlItems(e), he.fromDom),
        o = !1;
      if (t.length || r.length) {
        ...
        Bn(e, t, n),
          ...
          e.selection.setRng(A(e.selection.getRng())),
          e.nodeChanged(),
          (o = !0);
      }
      return o;
    ...
    Kn = function(e, n, t, r) {
      ...
      for (
        o = n[t ? 'startContainer' : 'endContainer'],
          ...
          !t && b(o.nextSibling) && (o = o.nextSibling);
        o.parentNode !== r;
    ...
    Vn = function(f, d, l) {
      ...
      var e,
        ...
        m = 'LI',
        t = pe.getClosestListRootElm(f, f.selection.getStart(!0)),
        g = f.dom;
      'false' !== g.getContentEditable(f.selection.getNode()) &&
        ...
        v.each(
          (function(t, e, r) {
            ...
            return (
              v.each(s, function(e) {
                if (T(t, e)) return i.push(e), void (o = null);
                if (u.isBlock(e) || b(e))
                  return b(e) && u.remove(e), void (o = null);
                var n = e.nextSibling;
                p.isBookmarkNode(e) && (T(t, n) || (!n && e.parentNode === r))
                  ? (o = null)
                  : (o ||
                      ((o = u.create('p')),
    ...
    Qn = function(e, n) {
      var t, r;
      if (((t = n.nextSibling), Xn(e, n, t))) {
        for (; (r = t.firstChild); ) n.appendChild(r);
        e.remove(t);
      }
      if (((t = n.previousSibling), Xn(e, n, t))) {
    ...
    Jn = {
      toggleList: function(e, n, t) {
        var r = pe.getParentList(e),
          o = pe.getSelectedSubLists(e);
        (t = t || {}),
          r && 0 < o.length
            ? Yn(e, r, o, n, t)
            : (function(e, n, t, r) {
    ...
    et = function(e, n) {
      ...
      'LI' === r.nodeName &&
        ...
        ((t = r.previousSibling) && 'LI' === t.nodeName
          ? (t.appendChild(n), E(e, r) && Zn.remove(r))
          : Zn.setStyle(r, 'listStyleType', 'none')),
        y(r) &&
          (t = r.previousSibling) &&
          'LI' === t.nodeName &&
          t.appendChild(n);
    ...
    tt = function(e, n, t, r) {
      var o,
        ...
        u = n.startContainer,
        a = n.startOffset;
      if (3 === u.nodeType && (t ? a < u.data.length : 0 < a)) return u;
      for (
    ...
    rt = function(e, n) {
      var t = n.childNodes;
      return 1 === t.length && !y(t[0]) && e.isBlock(t[0]);
    },
    ot = function(e, n, t) {
      var r, o, i, u;
      if (
        ((o = rt(e, t) ? t.firstChild : t),
    ...
    it = function(n, e, t) {
      var r,
        ...
        i = e.parentNode;
      if (w(n, e) && w(n, t)) {
        y(t.lastChild) && (o = t.lastChild),
          i === t.lastChild &&
            b(i.previousSibling) &&
            n.remove(i.previousSibling),
          (r = t.lastChild) && b(r) && e.hasChildNodes() && n.remove(r),
          E(n, t, !0) && n.$(t).empty(),
          ot(n, e, t),
          o && t.appendChild(o);
        var u = Je(he.fromDom(t), he.fromDom(e)) ? n.getParents(e, y, t) : [];
        n.remove(e),
          Y(u, function(e) {
            E(n, e) && e !== n.getRoot() && n.remove(e);
          });
      }
    },
    ut = function(e, n, t, r) {
      ...
      if (a.isEmpty(r))
        ...
        var s = R(n);
        it(a, t, r), e.selection.setRng(I(s));
      }
    },
    at = function(e, n) {
      var t,
        ...
        u = e.selection,
        a = u.getStart(),
        s = pe.getClosestListRootElm(e, a),
        c = i.getParent(u.getStart(), 'LI', s);
      if (c) {
        if ((t = c.parentNode) === e.getBody() && E(i, t)) return !0;
        if (
          ((r = A(u.getRng(!0))),
      ...
      return (
        ...
        (function(o, i) {
          var u = o.dom,
            ...
            a = pe.getClosestListRootElm(o, e),
            s = u.getParent(e, u.isBlock, a);
          if (s && u.isEmpty(s)) {
            var n = A(o.selection.getRng(!0)),
    ...
    ct = function(e, n) {
      return e.selection.isCollapsed()
        ...
        : ((r = (t = e).selection.getStart()),
          (o = pe.getClosestListRootElm(t, r)),
          !!(
            t.dom.getParent(r, 'LI,DT,DD', o) ||
            0 < pe.getSelectedListItems(t).length
          ) &&
    ...
    ft = function(n) {
      n.on('keydown', function(e) {
        e.keyCode === l.BACKSPACE
          ? ct(n, !1) && e.preventDefault()
          : e.keyCode === l.DELETE && ct(n, !0) && e.preventDefault();
      });
    },
    dt = ct,
    lt = function(n) {
        ...
        (n = e).on('keydown', function(e) {
          e.keyCode !== l.TAB ||
            ...
            n.undoManager.transact(function() {
              (e.shiftKey ? $n(n) : Hn(n)) && e.preventDefault();
            });
        }),
        ft(e);
    },
      ...
      (t = 'advlist'),
        ...
        -1 === v.inArray(r.split(/[ ,]/), t) &&
          (e.addButton('numlist', {
            ...
            onPostRender: ht(e, 'OL'),
          }),
          e.addButton('bullist', {
            active: !1,
            title: 'Bullet list',
            cmd: 'InsertUnorderedList',
            onPostRender: ht(e, 'UL'),
          })),
        e.addButton('indent', {
          icon: 'indent',
