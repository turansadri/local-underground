(function() {
  var paste = (function(domGlobals) {
    ...
    var shouldInformUserAboutPlainText = function(editor, userIsInformedState) {
      return (
        userIsInformedState.get() === false &&
        Settings.shouldPlainTextInform(editor)
      );
    };
    ...
    var togglePlainTextPaste = function(
      editor,
      clipboard,
      userIsInformedState,
    ) {
      ...
      if (typeof rootAttrs === 'object') {
        for (key in rootAttrs) {
          if (rootAttrs.hasOwnProperty(key)) {
            attrs.push(
              key + '="' + global$5.encodeAllRaw(rootAttrs[key]) + '"',
            );
          }
        }
        if (attrs.length) {
    ...
    var toBlockElements = function(text, rootTag, rootAttrs) {
      ...
      return paragraphs.length === 1
        ? paragraphs[0]
        : global$3.map(paragraphs, stitch).join('');
    };
    ...
    function innerText(html) {
      ...
      var ignoreElements = global$3.makeMap(
    ...
    var postProcessFilter = function(editor, html, internal, isWordHtml) {
      ...
      var postProcessArgs = Events.firePastePostProcess(
        editor,
        tempBody,
        internal,
        isWordHtml,
    ...
    var filterContent = function(editor, content, internal, isWordHtml) {
      var preProcessArgs = Events.firePastePreProcess(
        editor,
        content,
        internal,
        isWordHtml,
    ...
    var pasteHtml$1 = function(editor, html, internalFlag) {
      ...
      var args = ProcessFilters.process(
        editor,
        InternalHtml.unmark(html),
        internal,
      );
    ...
    var getClipboardContent = function(editor, clipboardEvent) {
      ...
      return Utils.isMsEdge()
        ? global$3.extend(content, { 'text/html': '' })
        : content;
    };
    ...
    var getPasteBinParent = function(editor) {
      return global$1.ie && editor.inline
    ...
    var getCaretRangeFromEvent = function(editor, e) {
      return global$a.getCaretRangeFromPoint(
        e.clientX,
        e.clientY,
        editor.getDoc(),
      );
    ...
    var setup = function(editor, clipboard, draggingInternallyState) {
      if (Settings.shouldBlockDrop(editor)) {
        editor.on('dragend dragover draggesture dragdrop drop drag', function(
          e,
        ) {
          e.preventDefault();
          e.stopPropagation();
      ...
      editor.on('drop', function(e) {
        ...
        var internal = clipboard.hasContentType(
          dropContent,
          InternalHtml.internalHtmlMime(),
        );
        if (
    ...
    function removeExplorerBrElementsAfterBlocks(editor, html) {
      ...
      var blockElements = [];
      global$3.each(editor.schema.getBlockElements(), function(
        block,
        blockName,
      ) {
