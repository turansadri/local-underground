  ...
  api.Values = api.Class.extend(
    /** @lends wp.customize.Values.prototype */ {
      ...
      instance: function(id) {
        if (arguments.length === 1) return this.value(id);
      ...
      when: function() {
        ...
        if ($.isFunction(ids[ids.length - 1])) dfd.done(ids.pop());
  ...
  api.Messenger = api.Class.extend(
    /** @lends wp.customize.Messenger.prototype */ {
      ...
      send: function(id, data) {
        ...
        if (!this.url() || !this.targetWindow()) return;
