  ...
  23: function(a, b, c) {
    ...
    (window.wp = window.wp || {}),
      (g = wp.media = function(a) {
        ...
        if (c)
          return (
            (a = _.defaults(a || {}, { frame: 'select' })),
            'select' === a.frame && c.Select
              ? (b = new c.Select(a))
              : 'post' === a.frame && c.Post
              ? (b = new c.Post(a))
              : 'manage' === a.frame && c.Manage
              ? (b = new c.Manage(a))
              : 'image' === a.frame && c.ImageDetails
              ? (b = new c.ImageDetails(a))
              : 'audio' === a.frame && c.AudioDetails
              ? (b = new c.AudioDetails(a))
              : 'video' === a.frame && c.VideoDetails
              ? (b = new c.VideoDetails(a))
              : 'edit-attachments' === a.frame &&
                c.EditAttachments &&
                (b = new c.EditAttachments(a)),
            delete a.frame,
            (g.frame = b),
            b
          );
      }),
      _.extend(g, { model: {}, view: {}, controller: {}, frames: {} }),
      (f = g.model.l10n = window._wpMediaModelsL10n || {}),
      (g.model.settings = f.settings || {}),
      delete f.settings,
      (d = g.model.Attachment = c(24)),
      (e = g.model.Attachments = c(25)),
      (g.model.Query = c(26)),
      (g.model.PostImage = c(27)),
      (g.model.Selection = c(28)),
      ...
      _.extend(g, {
        ...
        fit: function(a) {
          var b,
            ...
            f = a.maxHeight;
          return (
            _.isUndefined(e) || _.isUndefined(f)
              ? _.isUndefined(f)
                ? (b = 'width')
                : _.isUndefined(e) && d > f && (b = 'height')
              : (b = c / d > e / f ? 'width' : 'height'),
            'width' === b && c > e
              ? { width: e, height: Math.round((e * d) / c) }
              : 'height' === b && d > f
              ? { width: Math.round((f * c) / d), height: f }
              : { width: c, height: d }
          );
        },
      ...
      (g.query = function(a) {
        return new e(null, {
          props: _.extend(_.defaults(a || {}, { orderby: 'date' }), {
            query: !0,
          }),
        });
      }),
    ...
    var c = Backbone.Collection.extend(
      {
        ...
        _changeOrderby: function(a, b) {
          (this.comparator && this.comparator !== c.comparator) ||
            (b && 'post__in' !== b
        ...
        _changeFilteredProps: function(a) {
          if (!this.props.get('query')) {
            var b = _.chain(a.changed)
              .map(function(b, d) {
                var e = c.filters[d],
                  f = a.get(d);
                if (e) {
                  if (f && !this.filters[d]) this.filters[d] = e;
                  else {
                    if (f || this.filters[d] !== e) return;
              ...
              .value();
            b &&
              (this._source || (this._source = new c(this.models)),
        ...
        validator: function(a) {
          return (
            !(
              !_.isUndefined(a.attributes.context) &&
              '' !== a.attributes.context
            ) &&
            (!(!this.validateDestroyed && a.destroyed) &&
              _.all(
                this.filters,
                function(b) {
        ...
        validate: function(a, b) {
          var c = this.validator(a),
            d = !!this.get(a.cid);
          return !c && d ? this.remove(a, b) : c && !d && this.add(a, b), this;
        },
          ...
          return (
            a
              ? (a.off(null, null, this),
                (this.observers = _.without(this.observers, a)))
              : (_.each(
                  this.observers,
                  function(a) {
                    a.off(null, null, this);
        ...
        _validateHandler: function(a, b, c) {
          return (
            (c = b === this.mirroring ? c : { silent: c && c.silent }),
            this.validate(a, c)
          );
        },
        ...
        mirror: function(a) {
          return this.mirroring && this.mirroring === a
            ? this
            : (this.unmirror(),
              (this.mirroring = a),
              this.reset([], { silent: !0 }),
        ...
        more: function(a) {
          var b = jQuery.Deferred(),
            ...
            d = this;
          return c && c.more
            ? (c.more(a).done(function() {
                this === d.mirroring && b.resolveWith(this);
              }),
              b.promise())
            : b.resolveWith(this).promise();
        },
        hasMore: function() {
        ...
        saveMenuOrder: function() {
          if ('menuOrder' === this.props.get('orderby')) {
            var a = this.chain()
              ...
              .map(function(a, b) {
                return (b += 1), a.set('menuOrder', b), [a.id, b];
              })
              .object()
              .value();
            if (!_.isEmpty(a))
      ...
      },
      {
        comparator: function(a, b, c) {
          ...
          return (
            ...
            (b = b.get(d)),
            ('date' !== d && 'modified' !== d) ||
              ((a = a || new Date()), (b = b || new Date())),
            c && c.ties && (f = g = null),
            'DESC' === e
              ? wp.media.compare(a, b, f, g)
              : wp.media.compare(b, a, g, f)
          );
        },
        filters: {
          search: function(a) {
          ...
          type: function(a) {
            var b,
              c,
              d = this.props.get('type'),
              e = a.toJSON();
            return (
              !(d && (!_.isArray(d) || d.length)) ||
              ((b = e.mime || (e.file && e.file.type) || ''),
              (c = _.isArray(d)
                ? _.find(d, function(a) {
          ...
          (b = b || {}),
            ...
            (this.filters.order = function(a) {
              ...
              return (
                !this.comparator ||
                (this.length
                  ? 1 !== this.comparator(a, this.last(), { ties: !0 })
                  : 'DESC' !== c || ('date' !== b && 'modified' !== b)
                  ? 'ASC' === c && 'menuOrder' === b && 0 === a.get(b)
                  : a.get(b) >= this.created)
              );
            }),
            (c = [
              's',
            ...
            ? ((a = a || {}),
              ...
              (this._more = this.fetch(a).done(function(a) {
                (_.isEmpty(a) ||
                  ...
                  a.length < this.args.posts_per_page) &&
                  (b._hasMore = !1);
              })))
            : jQuery
                .Deferred()
        ...
        sync: function(a, b, c) {
          ...
          return 'read' === a
            ? ((c = c || {}),
              ...
              (e = _.clone(this.args)),
              -1 !== e.posts_per_page &&
                (e.paged = Math.round(this.length / e.posts_per_page) + 1),
              (c.data.query = e),
              wp.media.ajax(c))
            : ((f = d.prototype.sync ? d.prototype : Backbone),
        ...
        get: (function() {
          ...
          return function(b, d) {
            var e,
              ...
              g = c.orderby,
              h = c.defaultProps,
              i = !!b.cache || _.isUndefined(b.cache);
            return (
              delete b.query,
              delete b.cache,
              _.defaults(b, h),
              ...
              i
                ? (e = _.find(a, function(a) {
                    return _.isEqual(a.args, f);
                  }))
                : (a = []),
              e ||
                ((e = new c([], _.extend(d || {}, { props: b, args: f }))),
                a.push(e)),
              e
            );
          };
  ...
  27: function(a, b) {
    var c = Backbone.Model.extend({
      initialize: function(a) {
        ...
        (this.attachment = !1),
          a.attachment_id &&
            ((this.attachment = b.get(a.attachment_id)),
      ...
      setLinkTypeFromUrl: function() {
        ...
        return b
          ? ((a = 'custom'),
            this.attachment
              ? this.attachment.get('url') === b
                ? (a = 'file')
                : this.attachment.get('link') === b && (a = 'post')
              : this.get('url') === b && (a = 'file'),
            void this.set('link', a))
          : void this.set('link', 'none');
      },
      ...
      setAspectRatio: function() {
        ...
        return this.attachment &&
          ...
          (a = this.attachment.get('sizes').full)
          ? void this.set('aspectRatio', a.width / a.height)
          : void this.set(
              'aspectRatio',
    ...
    (c = d.extend({
      ...
      single: function(a) {
        ...
        return (
          ...
          this._single !== b &&
            (b &&
              (b.trigger('selection:unsingle', b, this),
