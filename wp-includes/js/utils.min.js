(window.wpCookies = {
  ...
  set: function(a, b, c, d, e, f) {
    ...
    'object' == typeof c && c.toGMTString
      ? (c = c.toGMTString())
      : parseInt(c, 10)
      ? (g.setTime(g.getTime() + 1e3 * parseInt(c, 10)), (c = g.toGMTString()))
      : (c = ''),
      (document.cookie =
        a +
        '=' +
  ...
  (window.deleteUserSetting = function(a) {
