...
wp.customize.selectiveRefresh = (function($, api) {
    ...
    /** @lends wp.customize.SelectiveRefresh.Partial.prototype */ {
      ...
      getType: function() {
        var partial = this,
          settingId;
        settingId =
          partial.params.primarySetting ||
          _.first(partial.settings()) ||
          'unknown';
      ...
      createEditShortcut: function() {
        ...
        $buttonContainer = $('<span>', {
          class:
            ...
            partial.getEditShortcutClassName(),
        });
        $button = $('<button>', {
      ...
      showControl: function() {
        ...
        if (partial.getType() === 'nav_menu') {
          if (partial.params.navMenuArgs.theme_location) {
            ...
            settingId =
              'nav_menu[' + String(partial.params.navMenuArgs.menu) + ']';
          }
        }
      ...
      renderContent: function(placement) {
        ...
        try {
          ...
          if (partial.params.containerInclusive) {
            ...
            newContainerElement.data(
              'customize-partial-placement-context',
              placement.context,
            );
            ...
            while (placement.container[0].firstChild) {
              placement.removedNodes.appendChild(
                placement.container[0].firstChild,
              );
            }
      ...
      request.done(function(data) {
        ...
        _.each(self._pendingPartialRequests, function(pending, partialId) {
          ...
          if (!_.isArray(data.contents[partialId])) {
            ...
            placementsContents = _.map(data.contents[partialId], function(
              content,
              i,
            ) {
  ...
  self.addPartials = function(rootElement, options) {
    ...
    containerElements.each(function() {
      ...
      if (!partial) {
        partialOptions =
          containerElement.data('customize-partial-options') || {};
        partialOptions.constructingContainerContext =
          containerElement.data('customize-partial-placement-context') || {};
        Constructor =
          self.partialConstructor[
            containerElement.data('customize-partial-type')
          ] || self.Partial;
