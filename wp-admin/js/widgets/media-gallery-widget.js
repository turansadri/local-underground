  ...
  GalleryWidgetControl = component.MediaWidgetControl.extend(
    /** @lends wp.mediaWidgets.controlConstructors.media_gallery.prototype */ {
      ...
      initialize: function initialize(options) {
        ...
        component.MediaWidgetControl.prototype.initialize.call(
          control,
          options,
        );
      ...
      updateSelectedAttachments: function updateSelectedAttachments() {
        ...
        _.each(removedIds, function(removedId) {
          control.selectedAttachments.remove(
            control.selectedAttachments.get(removedId),
          );
        });
      ...
      editMedia: function editMedia() {
        ...
        mediaFrame.on('update', function onUpdate(newSelection) {
          ...
          if (resultSelection.gallery) {
            control.model.set(
              control.mapMediaToModelProps(resultSelection.gallery.toJSON()),
            );
          }
