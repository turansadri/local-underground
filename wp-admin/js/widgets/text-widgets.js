    ...
    /** @lends wp.textWidgets.TextWidgetControl.prototype */ {
      ...
      initialize: function initialize(options) {
        ...
        if (control.customHtmlWidgetPointer.length) {
          control.customHtmlWidgetPointer
            .find('.close')
        ...
        control.pasteHtmlPointer = control.$el.find(
        ...
        _.each(control.fields, function(fieldInput, fieldName) {
          ...
          fieldInput.val(
            control.syncContainer.find('.sync-input.' + fieldName).val(),
          );
        });
      },
      ...
      openAvailableWidgetsPanel: function openAvailableWidgetsPanel() {
        ...
        wp.customize.section.each(function(section) {
          if (
            section.extended(wp.customize.Widgets.SidebarSection) &&
            section.expanded()
          ) {
        ...
        setTimeout(function() {
          ...
          wp.customize.Widgets.availableWidgetsPanel.$search
            .val('HTML')
            .trigger('keyup');
        });
      },
      ...
      initializeEditor: function initializeEditor() {
        ...
        function buildEditor() {
          ...
          $(document).one('wp-before-tinymce-init.text-widget-init', function(
            event,
            init,
          ) {
          ...
          onInit = function() {
            ...
            $('#' + id + '-html').on('click', function() {
              ...
              if (
                -1 !==
                component.dismissedPointers.indexOf('text_widget_custom_html')
              ) {
                return;
              }
            ...
            editor.on('pastepreprocess', function(event) {
              ...
              if (
                -1 !==
                  component.dismissedPointers.indexOf(
                    'text_widget_paste_html',
                  ) ||
                !content ||
                !/&lt;\w+.*?&gt;/.test(content)
          ...
          editor.on(
            'NodeChange',
            _.debounce(triggerChangeIfDirty, changeDebounceDelay),
          );
