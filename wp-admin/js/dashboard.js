...
jQuery(document).ready(function($) {
  ...
  $('.welcome-panel-close, .welcome-panel-dismiss a', welcomePanel).click(
    function(e) {
      e.preventDefault();
  ...
  app = window.wp.communityEvents = /** @lends wp.communityEvents */ {
    ...
    toggleLocationForm: function(action) {
      ...
      if ('object' === typeof action) {
         ...
         */
        action =
          'true' == $toggleButton.attr('aria-expanded') ? 'hide' : 'show';
      }
    ...
    renderEventsTemplate: function(templateParams, initiatedBy) {
      ...
      if (templateParams.location.ip) {
        ...
        $locationMessage.text(
          communityEventsData.l10n.attend_event_near_generic,
        );
        ...
        if ('user' === initiatedBy) {
          wp.a11y.speak(
            communityEventsData.l10n.city_updated.replace(
              l10nPlaceholder,
        ...
        wp.a11y.speak(
          communityEventsData.l10n.could_not_locate_city.replace(
            l10nPlaceholder,
