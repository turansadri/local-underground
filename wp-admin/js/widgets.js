...
(function($) {
  ...
  window.wpWidgets = {
    ...
    init: function() {
      ...
      $('#available-widgets .widget .widget-top').on(
        ...
        function() {
          ...
          if (
            $widget.hasClass('widget-in-question') ||
            $('#widgets-left').hasClass('chooser')
          ) {
    ...
    addWidget: function(chooser) {
      ...
      if (
        viewportTop > sidebarBounds.bottom ||
        viewportBottom < sidebarBounds.top
      ) {
        $('html, body').animate(
          {
