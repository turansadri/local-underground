...
(function($, wp) {
  window.inlineEditPost = {
    ...
    init: function() {
       ...
       */
      $('#inline-edit .inline-edit-private input[value="private"]').click(
        function() {
    ...
    setBulk: function() {
      ...
      $('tbody th.check-column input[type="checkbox"]').each(function() {
        ...
        if ($(this).prop('checked')) {
          ...
          var id = $(this).val(),
            theTitle;
          theTitle =
            $('#inline_' + id + ' .post_title').html() ||
            inlineEditL10n.notitle;
          te +=
            '<div id="ttle' +
            id +
            '"><a id="_' +
      ...
      if ('post' === type) {
        $('tr.inline-editor textarea[data-wp-taxonomy]').each(function(
          i,
          element,
        ) {
          /*
    ...
    edit: function(id) {
      ...
      $('.post_category', rowData).each(function() {
        ...
        if (term_ids) {
          taxname = $(this)
            .attr('id')
            .replace('_' + id, '');
          $('ul.' + taxname + '-checklist :checkbox', editRow).val(
            term_ids.split(','),
          );
        }
      });
      ...
      pageOpt = $(
        'select[name="post_parent"] option[value="' + id + '"]',
        editRow,
      );
      if (pageOpt.length > 0) {
