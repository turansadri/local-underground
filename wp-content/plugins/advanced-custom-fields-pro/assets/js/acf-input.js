...
*/
  ...
  acf.isGutenberg = function() {
    return (
      window.wp && wp.data && wp.data.select && wp.data.select('core/editor')
    );
  };
...
(function($, undefined) {
  ...
  var accordionManager = new acf.Model({
    ...
    iconHtml: function(props) {
      ...
      // Return HTML.
      return (
        '<i class="acf-accordion-icon dashicons dashicons-' + icon + '"></i>'
      );
    },
        ...
        addExpand: function() {
          ...
          var $a = $(
            [
              ...
              '<span class="is-closed"><span class="acf-icon -left small grey"></span>' +
                acf.__('Expand Details') +
                '</span>',
              '<span class="is-open"><span class="acf-icon -right small grey"></span>' +
...
(function($, undefined) {
    ...
    renderPostScreen: function(data) {
      ...
      data.results.map(function(result, i) {
        ...
        if (!postbox) {
          ...
          if ($('#submitdiv').length) {
            copyEvents(
              $submitdiv.children('.handlediv'),
              $postbox.children('.handlediv'),
            );
            copyEvents(
              $submitdiv.children('.hndle'),
  ...
  acf.screen.refreshAvailableMetaBoxesPerLocation = function() {
    ...
    acf.getPostboxes().map(function(postbox) {
      ...
      var location = postbox.$el
        .closest('form')
        .attr('class')
        .replace('metabox-location-', '');
