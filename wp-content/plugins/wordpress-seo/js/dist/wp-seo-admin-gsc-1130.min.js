(window.yoastWebpackJsonp = window.yoastWebpackJsonp || []).push([
  [12],
  {
    ...
    247: function(e, t, n) {
      ...
      function d(e, t, n, o) {
        ...
        if (
          ...
          return n(o, e, '' === t ? s + f(e, 0) : t), 1;
        var h = 0,
          y = '' === t ? s : t + l;
        if (Array.isArray(e))
          for (var m = 0; m < e.length; m++)
            h += d((a = e[m]), y + f(a, m), n, o);
        else {
          var w = (function(e) {
            var t = e && ((c && e[c]) || e[p]);
          ...
          if (w) {
            0;
            for (var b, v = w.call(e), g = 0; !(b = v.next()).done; )
              h += d((a = b.value), y + f(a, g++), n, o);
          } else if ('object' === u) {
            0;
            var _ = '' + e;
            i(
      ...
      e.exports = function(e) {
        ...
        var t = [];
        for (var n in e) _(e[n], t, n, a.thatReturnsArgument);
        return t;
      };
    },
    248: function(e, t, n) {
      'use strict';
      var o = function(e) {};
      e.exports = function(e, t, n, r, a, i, u, s) {
        if ((o(t), !e)) {
          var l;
          if (void 0 === t)
            l = new Error(
    ...
    258: function(e, t, n) {
      ...
      (d.propTypes = {
        benefits: i.default.array,
        infoParagraphs: i.default.array,
        upsellButton: i.default.object,
        upsellButtonText: i.default.string.isRequired,
        upsellButtonLabel: i.default.string,
        upsellButtonHasCaret: i.default.bool,
      }),
        (d.defaultProps = {
          infoParagraphs: [],
          benefits: [],
    ...
    345: function(e, t, n) {
      ...
      var o = (function(e) {
        ...
        r = n(21),
        a = n(22);
      (t.ModalContainer = o.default.div.withConfig({
        ...
        (t.ModalIcon = (0, o.default)(r.Icon).withConfig({
          ...
          (0, a.getDirectionalStyle)('right', 'left'),
          (0, a.getDirectionalStyle)('0 0 16px 16px', '0 16px 16px 0'),
        ));
    },
    47: function(e, t) {
      e.exports = ReactDOM;
    ...
    866: function(e, t, n) {
      ...
      function i(e) {
        var t = jQuery('#gsc_count_' + e),
          n = parseInt(t.text(), 10) - 1;
        n < 0 && (n = 0), t.text(n);
      }
      function u(e, t, n, o) {
        jQuery.post(
          ...
          function(e) {
            'true' === e &&
              (i(jQuery('#field_category').val()),
              jQuery('span:contains("' + o + '")')
                .closest('tr')
                .remove());
          },
        );
      ...
      jQuery(function() {
        jQuery('.subsubsub .yoast_help').on('click active', function() {
          ...
          jQuery('.yoast-help-panel')
            .not(e)
            .hide();
        }),
          jQuery('#gsc_auth_code').click(function() {
            var e = jQuery('#gsc_auth_url').val(),
        ...
        var e = document.getElementById('yoast-google-search-console-modal');
        e &&
          o.default.render(
            wp.element.createElement(r.default, {
              buyLink:
                wpseoAdminL10n['shortlinks.upsell.gsc.create_redirect_button'],
            }),
            e,
          );
      }),
        (window.wpseoUpdateCategoryCount = i),
        (window.wpseoMarkAsFixed = s),
        (window.wpseoSendMarkAsFixed = u),
        (window.wpseo_update_category_count = i),
        (window.wpseo_mark_as_fixed = s),
        (window.wpseo_send_mark_as_fixed = u);
    },
    867: function(e, t, n) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: !0 });
          ...
          o(t, [
            {
              ...
              value: function() {
                var e = this;
                jQuery('.wpseo-open-gsc-redirect-modal').click(function(t) {
                  t.preventDefault(), e.openModal();
                });
              },
            },
            {
            ...
            },
            {
              key: 'render',
              value: function() {
                if (!1 === this.state.isModalOpen) return null;
                var e = (0, i.sprintf)(
                  ...
                  t = (0, i.sprintf)(
                    (0, i.__)(
                      'Creating redirects is a %s feature',
                      'wordpress-seo',
                    ),
                    'Yoast SEO Premium',
                  ),
                ...
                return wp.element.createElement(
                  ...
                  wp.element.createElement(
                    l.ModalContainer,
                    null,
                    wp.element.createElement(l.ModalIcon, {
                      icon: u.YoastSeoIcon,
                    }),
                    wp.element.createElement('h2', null, t),
      ...
      (p.propTypes = { buyLink: a.default.string.isRequired }), (t.default = p);
    },
    91: function(e, t, n) {
      'use strict';
      var o = n(92),
