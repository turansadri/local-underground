  ...
  (this.wp.i18n = (function(e) {
      ...
      e.exports = function(e, t) {
        ...
        function u() {
          ...
          return (
            ...
            n ? ((n.prev = a), (a.next = n)) : (i = a),
            o === r ? ((i = i.prev).next = null) : o++,
            (n = a),
            a.val
          );
        }
    ...
    582: function(e, t, r) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t._n = function(e, t, r, n) {
          return p(n, void 0, e, t, r);
        }),
        (t._nx = function(e, t, r, n, i) {
          return p(i, n, e, t, r);
        }),
        (t.sprintf = function(e) {
          try {
            for (
              ...
              r[n - 1] = arguments[n];
            return u.default.sprintf.apply(u.default, [e].concat(r));
          } catch (t) {
            return c('sprintf error: \n\n' + t.toString()), e;
          }
        });
      var n = a(r(627)),
        i = a(r(623)),
      ...
      var s = { '': { plural_forms: 'plural=(n!=1)' } },
        c = (0, o.default)(console.error),
        l = new i.default({});
      function f(e) {
        var t =
          arguments.length > 1 && void 0 !== arguments[1]
            ? arguments[1]
            : 'default';
        (l.data[t] = (0, n.default)({}, s, l.data[t], e)),
          (l.data[t][''] = (0, n.default)({}, s[''], l.data[t]['']));
      }
      function p() {
        var e =
        ...
        return l.data[e] || f(void 0, e), l.dcnpgettext(e, t, r, n, i);
      }
    },
    583: function(e, t, r) {
      var n;
        ...
        function o(e) {
          return (function(e, t) {
            var r,
              ...
              g = '';
            for (n = 0; n < h; n++)
              if ('string' == typeof e[n]) g += e[n];
              else if ('object' == typeof e[n]) {
                if ((a = e[n]).keys)
                  for (r = t[d], u = 0; u < a.keys.length; u++) {
                    if (void 0 == r)
                      throw new Error(
                        o(
                ...
                switch ((i.number.test(a.type) && (f = r >= 0), a.type)) {
                  case 'b':
                  ...
                  : (!i.number.test(a.type) || (f && !a.sign)
                    ...
                    (c = a.pad_char
                      ? '0' === a.pad_char
                        ...
                        : a.pad_char.charAt(1)
                      : ' '),
                    (l = a.width - (p + r).length),
                    (s = a.width && l > 0 ? c.repeat(l) : ''),
                    (g += a.align
                      ? p + r + s
                      : '0' === c
                      ? p + s + r
    ...
    623: function(e, t, r) {
      ...
      function s(e) {
        var t = (function(e) {
          for (var t, r, a, s, c = [], l = []; (t = e.match(u)); ) {
            for (
              r = t[0], (a = e.substr(0, t.index).trim()) && c.push(a);
              (s = l.pop());
              ...
              } else if (i.indexOf(s) >= 0 || n[s] < n[r]) {
                l.push(s);
                break;
              }
              c.push(s);
            }
            o[r] || l.push(r), (e = e.substr(t.index + r.length));
          }
          return (e = e.trim()) && c.push(e), c.concat(l.reverse());
        })(e);
        return function(e) {
          return (function(e, t) {
            var r,
            ...
            for (r = 0; r < e.length; r++) {
              ...
              } else s = t.hasOwnProperty(u) ? t[u] : +u;
              c.push(s);
            }
            return c[0];
          })(t, e);
      ...
      function l(e, t) {
        ...
        (this.options = {}),
        c))
          this.options[r] = t[r] || c[r];
      }
      (l.prototype.getPluralForm = function(e, t) {
        var r,
          n,
        ...
        return (
          i ||
            ...
            (i = this.pluralForms[e] = n)),
          i(t)
        );
      }),
        (l.prototype.dcnpgettext = function(e, t, r, n, i) {
          var o, u, a;
          return (
            (o = void 0 === i ? 0 : this.getPluralForm(e, i)),
            (u = r),
            t && (u = t + this.options.contextDelimiter + r),
            (a = this.data[e][u]) && a[o]
              ? a[o]
