...
(function() {
  ...
  var Un,
    ...
    Pn =
      Nn && typeof module == 'object' && module && !module.nodeType && module,
    Zn = Pn && Pn.exports === Nn,
    qn = Zn && Tn.process;
  n: {
    try {
    ...
    rt = (function x(mn) {
      ...
      function $r(n) {
        return fr(function(t, r) {
          ...
          for (
            o && Oe(r[0], r[1], o) && ((i = 3 > u ? T : i), (u = 1)), t = Yu(t);
            ++e < u;
      ...
      function Pr(n, t, r) {
        function e() {
          return (this && this !== Fn && this instanceof e ? i : n).apply(
            u ? r : this,
            arguments,
          );
        }
        ...
        function u() {
          ...
          return (
            ...
            o < e
              ...
              : n(this && this !== Fn && this instanceof u ? i : t, this, f)
          );
        }
        var i = Vr(t);
        return u;
      ...
      function Ne(n, t, r) {
        ...
        var u = e - 1;
        return (
          r !== T && ((u = Au(r)), (u = 0 > r ? Li(e + u, 0) : Ui(u, e - 1))),
          _(n, ye(t, 3), u, true)
        );
      }
      function Pe(n) {
      ...
      function wu(n) {
        ...
        return (
          (t = _o(n)),
          ('[object Map]' == t ? W : '[object Set]' == t ? U : Lu)(n)
        );
      }
      function mu(n) {
        return n
      ...
      (($i && '[object DataView]' != _o(new $i(new ArrayBuffer(1)))) ||
        ...
        (_o = function(n) {
          var t = Ot(n);
          if (
            (n = (n = '[object Object]' == t ? n.constructor : T) ? Me(n) : '')
          )
            switch (n) {
              case Gi:
      ...
      var Qo = fr(function(t, r) {
          r =
            1 == r.length && of(r[0]) ? c(r[0], E(ye())) : c(wt(r, 1), E(ye()));
          var e = r.length;
        ...
        mf = Yr(function(n, t, r) {
          null != t && typeof t.toString != 'function' && (t = ci.call(t)),
            (n[t] = r);
        }, Mu(Tu)),
      ...
      return (
        ...
        (An.clamp = function(n, t, r) {
          return (
            r === T && ((r = t), (t = T)),
            r !== T && ((r = Eu(r)), (r = r === r ? r : 0)),
            t !== T && ((t = Eu(t)), (t = t === t ? t : 0)),
            pt(Eu(n), t, r)
          );
        }),
        (An.clone = function(n) {
        ...
        (An.isBoolean = function(n) {
          return (
            true === n || false === n || (du(n) && '[object Boolean]' == Ot(n))
          );
        }),
        (An.isBuffer = cf),
        (An.isDate = af),
        ...
        (An.lastIndexOf = function(n, t, r) {
          ...
          if (
            (r !== T &&
              ((u = Au(r)), (u = 0 > u ? Li(e + u, 0) : Ui(u, e - 1))),
            t === t)
          ) {
            for (r = u + 1; r-- && n[r] !== t; );
            n = r;
        ...
        (Un.prototype.slice = function(n, t) {
          ...
          return r.__filtered__ && (0 < n || 0 > t)
            ...
            : (0 > n ? (r = r.takeRight(-n)) : n && (r = r.drop(n)),
              t !== T &&
                ((t = Au(t)), (r = 0 > t ? r.dropRight(-t) : r.take(t - n))),
              r);
        }),
